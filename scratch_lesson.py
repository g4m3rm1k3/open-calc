...
content = """# Lesson 14: `set?`, `makeset`, `subset?` — Lists as Sets
...
with open(r"C:\Users\g4m3r\Documents\testing tutorials\open-calc\scratch_lesson.py", "w", encoding="utf-8") as f:
    f.write("import os\n")
    f.write("os.makedirs(r'C:\\Users\\g4m3r\\Documents\\testing tutorials\\open-calc\\src\\docs\\tutorials\\scheme-lisp-clojure-sicp', exist_ok=True)\n")
    f.write("with open(r'C:\\Users\\g4m3r\\Documents\\testing tutorials\\open-calc\\src\\docs\\tutorials\\scheme-lisp-clojure-sicp\\lesson-14.md', 'w', encoding='utf-8') as md_file:\n")
    f.write("    md_file.write(content)\n")
