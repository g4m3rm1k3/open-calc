# Lesson 18a: Two-Phase Construction
...
a real object already exists to receive them. The next lesson shows a
real Android component built on exactly this same split.
