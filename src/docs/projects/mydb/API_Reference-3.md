...
**Status:** 🟢 Frozen for Level 1. Lesson 6 adds tests against this
exact API, not new methods. Level 3 is expected to change *how* these
are implemented internally (pages, indexes) without changing this
signature list at all.
