  ...
  return (
    <>
      <button
        ...
        className={
          iconOnly
            ? `flex items-center justify-center w-9 h-9 rounded-xl text-slate-500 dark:text-slate-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 hover:text-amber-600 dark:hover:text-amber-400 transition-colors focus:outline-none ${className}`
            : `flex items-center gap-1.5 px-3 py-1 rounded-lg text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors ${className}`
        }
      >
        <Lightbulb className="w-4 h-4" />
        {!iconOnly && <span>Suggestion Box</span>}
      </button>
