...
const THEME = {
  ...
  light: {
    bg: '#f8fafc',
    vignette: '248,250,252',
    vR: 0.05, vL1: 0.0, vL2: 0.8,
    ambient: '#ffffff',
    ambientIntensity: 1.5,
    lights: [
      { pos: [  0,  0,  3], intensity: 1.8,  color: '#3b82f6', distance: 32 },
      { pos: [ 10,  6, -8], intensity: 1.5,  color: '#ec4899', distance: 38 },
      { pos: [ -8, -4, -6], intensity: 1.2,  color: '#06b6d4', distance: 28 },
      { pos: [  0,  9,-16], intensity: 1.2,  color: '#f59e0b', distance: 45 },
      { pos: [ -6, -6, -4], intensity: 1.0,  color: '#8b5cf6', distance: 25 },
    ],
    orbEmissiveIntensity: 0.7,
    starSize: 0.045,
    starOpacity: 0.5,
  },
}
