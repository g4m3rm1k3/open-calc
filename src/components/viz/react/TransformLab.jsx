...
const THEMES = {
  light: {
    ...
    accent: "#c8820a", accentBg: "#fdf3e3", accentText: "#7a4d04",
    green: "#1a7a3a", greenBg: "#edf7f0",
    red: "#c0321a", redBg: "#fdf0ee",
    purple: "#6a3ab0", purpleBg: "#f3eeff",
    canvasBg: "#ffffff", canvasGrid: "rgba(0,0,0,0.07)", canvasGridBold: "rgba(0,0,0,0.18)",
    canvasAxis: "rgba(0,0,0,0.35)", shapeOrig: "#bbb8ae", shapeMain: "#c8820a",
    shapeSolved: "#1a7a3a", code: "#1a1916", codeBg: "#f4f3ef",
  },
  dark: {
    bg: "#131210", bg2: "#1c1b18", bg3: "#252420",
    border: "#2e2c27", border2: "#3a3830",
    text: "#e8e5dc", text2: "#9a9788", text3: "#5a5750",
    accent: "#e8960e", accentBg: "#211a08", accentText: "#f0b43c",
    green: "#3aaa5a", greenBg: "#0e1f14",
    red: "#e05030", redBg: "#200e0a",
    purple: "#9a6aee", purpleBg: "#180f2a",
    canvasBg: "#131210", canvasGrid: "rgba(255,255,255,0.06)", canvasGridBold: "rgba(255,255,255,0.15)",
    canvasAxis: "rgba(255,255,255,0.3)", shapeOrig: "#3a3830", shapeMain: "#e8960e",
    shapeSolved: "#3aaa5a", code: "#e8e5dc", codeBg: "#1c1b18",
  },
};
