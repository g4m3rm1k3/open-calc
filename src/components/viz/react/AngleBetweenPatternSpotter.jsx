// AngleBetweenPatternSpotter.jsx
import { useState } from "react";
const ROUNDS=[
  {q:"A⃗=(1,0), B⃗=(0,1). What is φ?",opts:["0°","45°","90°","180°"],correct:"90°",why:"î·ĵ=0. cosφ=0 → φ=90°. Basis vectors are perpendicular."},
  {q:"A⃗=(3,0), B⃗=(−3,0). What is φ?",opts:["0°","90°","180°","60°"],correct:"180°",why:"Anti-parallel vectors. dot=−9, |A||B|=9, cosφ=−1 → φ=180°."},
  {q:"A⃗=(1,1), B⃗=(1,1). What is φ?",opts:["0°","45°","90°","180°"],correct:"0°",why:"Identical vectors. cosφ=|A||B|/|A||B|=1 → φ=0°."},
  {q:"A⃗=(2,2), B⃗=(−1,1). What is φ?",opts:["30°","45°","60°","90°"],correct:"90°",why:"dot=2×(−1)+2×1=0. Perpendicular, even though neither is along an axis."},
  {q:"If A⃗·B⃗ < 0, what can you say about φ?",opts:["φ < 90°","φ = 90°","φ > 90°","φ = 180°"],correct:"φ > 90°",why:"cosφ < 0 when 90° < φ ≤ 180°. Negative dot product = obtuse angle between the vectors."},
  {q:"A⃗=(1,2,2), B⃗=(3,−1,0). What is A⃗·B⃗?",opts:["1","3","0","−1"],correct:"1",why:"1×3+2×(−1)+2×0=3−2+0=1."},
];
export default function AngleBetweenPatternSpotter({params={}}){
