    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-lg">
        ...
        <div className="space-y-4 text-red-700 dark:text-red-400">
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded border-l-4 border-red-500">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded border-l-4 border-blue-500">
            <h4 className="font-semibold mb-3 dark:text-blue-200">
          ...
          <div className="bg-yellow-100 dark:bg-yellow-900/30 p-4 rounded">
            <p className="font-semibold text-yellow-800 dark:text-yellow-300">Key Insight:</p>
      ...
      <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg">
        ...
        <div className="space-y-4 text-green-700 dark:text-green-400">
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded">
            <h4 className="font-semibold mb-2 dark:text-green-200">Car Analogy:</h4>
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded">
            <h4 className="font-semibold mb-2 dark:text-green-200">Visual Analogy:</h4>
      ...
      <div className="bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg">
        ...
        <div className="space-y-4 text-purple-700 dark:text-purple-400">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-slate-800 p-4 rounded">
              <h4 className="font-semibold dark:text-purple-200">F(x)</h4>
              <p className="dark:text-slate-300">One specific antiderivative (the "particular" solution)</p>
            </div>
            <div className="bg-white dark:bg-slate-800 p-4 rounded">
              <h4 className="font-semibold dark:text-purple-200">+ C</h4>
              <p className="dark:text-slate-300">The constant representing all possible vertical shifts</p>
            </div>
          </div>
      ...
      <div className="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-lg">
        ...
        <div className="space-y-4 text-indigo-700 dark:text-indigo-400">
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded text-slate-800 dark:text-slate-200">
            <h4 className="font-semibold mb-2 dark:text-indigo-200">Example:</h4>
