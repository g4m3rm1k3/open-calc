...
export default function PinsNotesPopup({ initialTab = 'pins', onClose }) {
  ...
  return (
    <div
      ref={ref}
      className="fixed bottom-11 right-2 z-[1900] w-[340px] max-h-[72vh] flex flex-col rounded-2xl overflow-hidden shadow-2xl border border-black/10 dark:border-white/[0.1] bg-white/95 dark:bg-[#1c1c1e]/95 backdrop-blur-xl"
    >
      {/* Header */}
