...
```quiz
{"q": "Which concepts are needed to formally define a function?", "options": ["Sets and ordered pairs only", "Sets, ordered pairs, and relations", "Only the Cartesian product", "Logic and induction"], "correct": 1, "explanation": "A function is a special relation (a subset of A \u00d7 B). Relations are subsets of Cartesian products."}
```
...
```quiz
{"q": "Which operation finds parts passing EVERY inspection?", "options": ["Union", "Intersection", "Complement", "Set difference"], "correct": 1, "explanation": "Intersection (\u2229) gives elements in ALL sets simultaneously."}
```
...
```quiz
{"q": "Stage 0 introduced:", "options": ["Numbers only", "Sets, relations, functions, and logic", "Integrals and derivatives", "Matrices and vectors"], "correct": 1, "explanation": "Stage 0 builds the language of mathematics: sets, relations, functions, and logic."}
```
