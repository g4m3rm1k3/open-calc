...
```quiz
{"q": "Proof by contradiction begins by:", "options": ["Proving the statement directly", "Assuming the statement is FALSE and deriving a contradiction", "Finding a counterexample", "Proving the contrapositive"], "correct": 1, "explanation": "Contradiction: assume the opposite of what you want to prove, then show this leads to a logical impossibility."}
```
...
```quiz
{"q": "To prove 'no largest integer' by contradiction, we assume:", "options": ["All integers are positive", "There IS a largest integer N", "N + 1 is not an integer", "Integers are bounded"], "correct": 1, "explanation": "Assume the opposite: a largest integer N exists. Then N+1 is also an integer and N+1 > N \u2014 contradiction."}
```
...
```quiz
{"q": "The starting assumption in the sqrt(2) irrationality proof is:", "options": ["sqrt(2) > 1", "sqrt(2) = p/q in lowest terms", "p and q are both odd", "q divides p"], "correct": 1, "explanation": "Assume sqrt(2) = p/q in lowest terms (gcd(p,q)=1), then show both p and q must be even \u2014 contradicting lowest terms."}
```
...
```quiz
{"q": "Euclid's proof that there are infinitely many primes assumes:", "options": ["There are exactly 2 primes", "There are finitely many primes p1,...,pn", "Every number is prime", "The product of primes is prime"], "correct": 1, "explanation": "Assume finitely many primes. Form N = p1\u00b7p2\u00b7...\u00b7pn + 1. N has a prime factor not in the list \u2014 contradiction."}
```
