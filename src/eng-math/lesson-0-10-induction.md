...
```quiz
{"q": "Mathematical induction has which two steps?", "options": ["Assume and conclude", "Base case and inductive step", "Hypothesis and contrapositive", "Definition and theorem"], "correct": 1, "explanation": "Induction: (1) Base case \u2014 verify P(1). (2) Inductive step \u2014 assume P(k) and prove P(k+1)."}
```
...
```quiz
{"q": "1 + 2 + ... + n equals:", "options": ["n\u00b2", "n(n+1)/2", "n(n-1)/2", "2\u207f"], "correct": 1, "explanation": "The sum of the first n natural numbers is n(n+1)/2."}
```
...
```quiz
{"q": "The sum 1 + 2 + 4 + ... + 2^(n-1) equals:", "options": ["n\u00b2", "2n - 1", "2\u207f - 1", "n\u00b72\u207f"], "correct": 2, "explanation": "Geometric series: 2\u2070 + 2\u00b9 + ... + 2^(n-1) = 2\u207f - 1."}
```
...
```quiz
{"q": "The inductive hypothesis P(k) is:", "options": ["What we want to prove for all n", "The assumption that P(k) is true, used to prove P(k+1)", "The base case P(1)", "The conclusion"], "correct": 1, "explanation": "In the inductive step we ASSUME P(k) (the inductive hypothesis) and use it to PROVE P(k+1)."}
```
