...
heap.forEach((v,i)=>{html+='<div style="text-align:center"><div style="background:#1e3a5f;border:1px solid #60a5fa;border-radius:4px;padding:8px 12px;color:#e2e8f0;font-weight:bold">'+v+'</div><div style="color:var(--color-text-secondary, #475569);font-size:11px;margin-top:4px">i='+i+'</div></div>';});
