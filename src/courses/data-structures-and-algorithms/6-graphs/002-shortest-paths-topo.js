...
steps.forEach((s,i)=>{html+='<div style="margin-bottom:5px;padding:6px 10px;background:#1e293b;border-radius:4px;font-size:13px">Step '+(i+1)+': <b style="color:#f59e0b">'+s.processing+'</b>'+(s.queue.length?' <span style="color:var(--color-text-secondary, #475569)">→ queue: ['+s.queue.join(', ')+']</span>':'')+'</div>';});
