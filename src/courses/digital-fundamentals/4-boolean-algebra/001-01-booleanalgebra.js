...
export default {
  ...
  order: 1,
  title: 'Boolean Algebra: Laws and Identities',
  subtitle: 'The mathematical rules that let you simplify any logic expression.',
  tags: ['digital', 'boolean', 'algebra', 'simplification', 'De Morgan', 'SOP', 'POS'],
  hook: {
    question: 'How do you reduce a messy logic diagram into its simplest possible form?',
    realWorldContext: 'Logic synthesis tools use these rules to squeeze more performance out of fewer transistors.',
  },
  intuition: {
    prose: [
      'Boolean algebra is the mathematics of digital circuits. Unlike regular algebra, variables can only be 1 or 0.',
      'Simplification saves space, power, and time by reducing gate count.',
      'Standard forms (SOP and POS) provide a starting point for logic realization and hardware mapping.',
    ],
    callouts: [
      {
        type: 'tip',
        title: 'Mastering the Distributive Law',
        body: 'The OR form of the distributive law ($A + BC = (A+B)(A+C)$) is often overlooked but is extremely powerful for simplifying Product of Sums expressions.',
      },
    ],
  },
  ...
  examples: [], challenges: [],
  mentalModel: [
    'Laws are rules for legal circuit rewrites.',
    'SOP = OR of ANDs (good for high outputs).',
    'POS = AND of ORs (good for low outputs).',
  ],
