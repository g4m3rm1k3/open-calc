...
const STEPS=[
  {title:'Vertical velocity equation',body:'In the vertical direction, the projectile decelerates due to gravity:\n  vᵧ(t) = v₀sinθ − g·t\nAt maximum height, the vertical velocity = 0 (momentarily stationary).', formula:'vᵧ = v₀sinθ − gt = 0  →  t_peak = v₀sinθ/g'},
  {title:'Time to peak',body:'Solve vᵧ = 0:\n  v₀sinθ − g·t = 0\n  t_peak = v₀sinθ/g\nThis is exactly half the total flight time T = 2v₀sinθ/g.', formula:'t_peak = v₀sinθ/g = T/2'},
  {title:'Height at peak',body:'Substitute t_peak into y(t):\n  H = v₀sinθ·(v₀sinθ/g) − ½g·(v₀sinθ/g)²\n  H = v₀²sin²θ/g − v₀²sin²θ/(2g)\n  H = v₀²sin²θ/(2g)', formula:'H = v₀²sin²θ / (2g)'},
  {title:'Alternative: kinematics',body:'Using vᵧ² = v₀ᵧ² − 2gH:\nAt peak, vᵧ = 0:\n  0 = v₀ᵧ² − 2gH\n  H = v₀ᵧ²/(2g)\nThis is often faster than the time-substitution method.', formula:'H = v₀ᵧ²/(2g) = (v₀sinθ)²/(2g)'},
];
export default function MaxHeightDerivation(){
  const[step,setStep]=useState(0);const s=STEPS[step];
  return(
    <div className="p-4 sm:p-6 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
      <h3 className="text-lg font-semibold mb-1">Deriving Maximum Height</h3>
