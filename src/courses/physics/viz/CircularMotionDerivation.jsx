...
const STEPS=[
  {title:'Position in circular motion',body:'A particle moving in a circle of radius r:\n  x(t) = r·cos(ωt)\n  y(t) = r·sin(ωt)\nwhere ω = angular velocity (rad/s).', formula:'r⃗(t) = r·cos(ωt) x̂ + r·sin(ωt) ŷ'},
  {title:'Velocity by differentiation',body:'Differentiate position:\n  vₓ = −rω·sin(ωt)\n  vᵧ = rω·cos(ωt)\nThe speed = |v| = rω = v (constant!)', formula:'v⃗(t) = rω[−sin(ωt) x̂ + cos(ωt) ŷ]   |v|=rω'},
  {title:'Acceleration by differentiation',body:'Differentiate velocity:\n  aₓ = −rω²·cos(ωt)\n  aᵧ = −rω²·sin(ωt)\nNotice: a⃗ = −ω²·r⃗ (inward!)', formula:'a⃗(t) = −ω²·r⃗(t)   →   |a| = ω²r = v²/r'},
  {title:'The negative sign means centripetal',body:'a⃗ = −ω²r⃗ means acceleration is always opposite to the position vector — i.e., pointing toward the center. This is why it is called centripetal ("center-seeking").', formula:'a⃗ = −ω²r⃗  (toward center, magnitude v²/r)'},
];
export default function CircularMotionDerivation(){
  const[step,setStep]=useState(0);const s=STEPS[step];
  return(
    <div className="p-4 sm:p-6 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
      <h3 className="text-lg font-semibold mb-1">Circular Motion: Position → Velocity → Acceleration</h3>
