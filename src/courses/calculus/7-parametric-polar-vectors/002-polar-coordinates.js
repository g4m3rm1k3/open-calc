...
import polarToRectUrl from '../diagrams/calc-polar-to-rect.svg?url';
import polarCurvesUrl from '../diagrams/calc-polar-curves.svg?url';
...
export default {
  ...
  intuition: {
    blocks: [
      ...
      { type: 'image', src: polarToRectUrl, alt: 'Right triangle showing x=r cosθ, y=r sinθ, r=√(x²+y²) conversions', caption: 'Convert between polar and rectangular: x = r cosθ, y = r sinθ; r = √(x²+y²), θ = arctan(y/x).' },
      {
        type: 'prose',
        paragraphs: [
      ...
      { type: 'image', src: polarCurvesUrl, alt: 'Gallery of polar curves: cardioid, lemniscate, rose curve, Archimedean spiral', caption: 'Cardioid (1+cosθ), lemniscate (r²=cos2θ), rose (cos nθ), spiral (r=θ) — each has a characteristic algebraic form.' },
    ],
    callouts: [
      {
