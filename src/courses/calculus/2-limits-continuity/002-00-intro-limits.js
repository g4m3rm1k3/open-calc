  ...
  quiz: [
    {
      id: 'lim-intro-q1',
      type: 'choice',
      text: 'What does $\\lim_{x \\to 3} f(x) = 7$ mean?',
      options: [
        'f(3) = 7',
        'As x gets close to 3, f(x) gets close to 7',
        'f(x) = 7 for all x near 3',
        'The function is defined at x = 3',
      ],
      answer: 'As x gets close to 3, f(x) gets close to 7',
      reviewSection: 'Intuition tab — the limit is about the journey, not the destination',
    },
    {
      id: 'lim-intro-q2',
      type: 'input',
      text: 'Evaluate: $\\lim_{x \\to 2} (3x + 1)$',
      answer: '7',
      hints: ['Substitute x = 2 directly — the function is continuous there.'],
      reviewSection: 'Math tab — direct substitution',
    },
    {
      id: 'lim-intro-q3',
      type: 'choice',
      text: 'A two-sided limit $\\lim_{x \\to c} f(x)$ exists if and only if:',
      options: [
        'f(c) is defined',
      ...
      reviewSection: 'Math tab — one-sided vs two-sided limits',
    },
    {
      id: 'lim-intro-q4',
      type: 'input',
      text: 'What form does $\\dfrac{x^2 - 4}{x - 2}$ take when you substitute $x = 2$?',
      answer: '0/0',
      hints: ['Plug x = 2 into numerator and denominator separately.'],
      reviewSection: 'Intuition tab — indeterminate forms signal "more algebra needed"',
    },
    {
      id: 'lim-intro-q5',
      type: 'input',
      text: 'Simplify and evaluate: $\\lim_{x \\to 2} \\dfrac{x^2 - 4}{x - 2}$',
      answer: '4',
      hints: [
        'Factor the numerator: $x^2 - 4 = (x-2)(x+2)$.',
        'Cancel the $(x-2)$ factor, then substitute $x = 2$.',
      ],
      reviewSection: 'Math tab — algebraic manipulation of 0/0 forms',
    },
    {
      id: 'lim-intro-q6',
      type: 'choice',
      text: 'For $f(x) = \\begin{cases} x+1 & x < 2 \\\\ 5 & x = 2 \\\\ x^2 & x > 2 \\end{cases}$, what is $\\lim_{x \\to 2} f(x)$?',
      options: ['3', '4', '5', 'Does not exist'],
      answer: 'Does not exist',
      reviewSection: 'Math tab — left-hand limit is 3, right-hand limit is 4, they disagree',
    },
    {
      id: 'lim-intro-q7',
      type: 'input',
      text: 'Evaluate: $\\lim_{x \\to 0} \\dfrac{x^3 + 5x}{x}$',
      answer: '5',
      hints: [
        'Factor x from the numerator first.',
        '$\\frac{x(x^2 + 5)}{x} = x^2 + 5$ for $x \\ne 0$. Now take the limit.',
      ],
      reviewSection: 'Math tab — cancellation before substitution',
    },
    {
      id: 'lim-intro-q8',
      type: 'choice',
      text: 'Which statement correctly distinguishes a limit from a function value?',
      options: [
        'A limit requires f(c) to exist',
        'A limit describes behavior near c, regardless of what f(c) is',
        'If f(c) exists, the limit must equal f(c)',
        'Limits only apply to continuous functions',
      ],
      answer: 'A limit describes behavior near c, regardless of what f(c) is',
      reviewSection: 'Intuition tab — the limit ignores the destination',
    },
    {
      id: 'lim-intro-q9',
      type: 'input',
      text: 'Evaluate: $\\lim_{x \\to -1} (x^2 - 2x + 3)$',
      answer: '6',
      hints: ['Substitute $x = -1$ — polynomial functions are continuous everywhere.'],
      reviewSection: 'Math tab — direct substitution for polynomials',
    },
    {
      id: 'lim-intro-q10',
      type: 'choice',
      text: 'What is the indeterminate form $0/0$ telling you?',
      options: [
        'The limit does not exist',
        'The limit is zero',
        'More algebraic work is needed before evaluating',
        'The function is undefined at that point',
      ],
      answer: 'More algebraic work is needed before evaluating',
      reviewSection: 'Intuition tab — indeterminate forms',
    },
  ],
}
