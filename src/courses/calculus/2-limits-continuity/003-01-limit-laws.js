  ...
  quiz: [
    {
      id: 'lim-laws-q1',
      type: 'choice',
      text: 'If $\\lim_{x\\to c} f(x) = 3$ and $\\lim_{x\\to c} g(x) = 5$, what is $\\lim_{x\\to c}[f(x) + g(x)]$?',
      options: ['8', '15', '2', 'Cannot be determined'],
      answer: '8',
      reviewSection: 'Intuition tab — Sum Law',
    },
    {
      id: 'lim-laws-q2',
      type: 'input',
      text: 'Using limit laws, evaluate: $\\lim_{x\\to 4}(x^2 - 3x)$',
      answer: '4',
      hints: [
        'For polynomials, direct substitution is valid — substitute x = 4.',
        '$4^2 - 3(4) = 16 - 12 = ?$',
      ],
      reviewSection: 'Math tab — direct substitution property',
    },
    {
      id: 'lim-laws-q3',
      type: 'choice',
      text: 'Which law justifies: $\\lim_{x\\to c}[k \\cdot f(x)] = k \\cdot \\lim_{x\\to c} f(x)$?',
      options: ['Sum Law', 'Product Law', 'Constant Multiple Law', 'Quotient Law'],
      answer: 'Constant Multiple Law',
      reviewSection: 'Math tab — limit laws list',
    },
    {
      id: 'lim-laws-q4',
      type: 'input',
      text: 'If $\\lim_{x\\to 2} f(x) = 6$ and $\\lim_{x\\to 2} g(x) = 3$, find $\\lim_{x\\to 2}\\dfrac{f(x)}{g(x)}$.',
      answer: '2',
      hints: ['Quotient Law: divide the two limits (denominator limit ≠ 0).'],
      reviewSection: 'Math tab — Quotient Law',
    },
    {
      id: 'lim-laws-q5',
      type: 'input',
      text: 'Evaluate: $\\lim_{x\\to 3}\\sqrt{x^2 - 5}$',
      answer: '2',
      hints: [
        'Power/Root Law: $\\lim \\sqrt{f(x)} = \\sqrt{\\lim f(x)}$ provided the limit is non-negative.',
        'Compute $\\lim_{x\\to 3}(x^2 - 5) = 9 - 5 = 4$, then take the square root.',
      ],
      reviewSection: 'Math tab — Root Law',
    },
    {
      id: 'lim-laws-q6',
      type: 'choice',
      text: 'The Quotient Law $\\lim[f/g] = (\\lim f)/(\\lim g)$ has one restriction. What is it?',
      options: [
        'f must be continuous',
        'The limit of g must not be zero',
        'Both limits must be positive',
        'f and g must be polynomials',
      ],
      answer: 'The limit of g must not be zero',
      reviewSection: 'Math tab — Quotient Law restriction',
    },
    {
      id: 'lim-laws-q7',
      type: 'input',
      text: 'Evaluate: $\\lim_{x\\to -2}(x^3 + 4x^2 - x + 1)$',
      answer: '11',
      hints: ['Substitute $x = -2$: $(-2)^3 + 4(-2)^2 - (-2) + 1$.'],
      reviewSection: 'Math tab — direct substitution for polynomials',
    },
    {
      id: 'lim-laws-q8',
      type: 'choice',
      text: 'Which limit law allows you to write $\\lim_{x\\to c}[f(x)]^n = [\\lim_{x\\to c} f(x)]^n$?',
      options: ['Product Law applied n times', 'Power Law', 'Composition Rule', 'Root Law'],
      answer: 'Power Law',
      reviewSection: 'Math tab — Power Law',
    },
    {
      id: 'lim-laws-q9',
      type: 'input',
      text: 'If $\\lim_{x\\to 5} f(x) = 4$, evaluate $\\lim_{x\\to 5}[f(x)]^3$.',
      answer: '64',
      hints: ['Power Law: raise the limit value to the power 3.'],
      reviewSection: 'Math tab — Power Law',
    },
    {
      id: 'lim-laws-q10',
      type: 'choice',
      text: 'Why can\'t you directly apply the Quotient Law to $\\lim_{x\\to 0}\\dfrac{\\sin x}{x}$?',
      options: [
      ...
      answer: 'The limit of the denominator is 0',
      reviewSection: 'Rigor tab — when Quotient Law fails and the Squeeze Theorem saves you',
    },
  ],
};
