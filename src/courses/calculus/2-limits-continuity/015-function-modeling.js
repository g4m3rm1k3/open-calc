...
export default {
  ...
  intuition: {
    blocks: [
      ...
      { type: 'image', src: piecewiseFunctionUrl, alt: 'Piecewise function with left/right limit checks at transition points', caption: 'Real-world models are often piecewise; limits tell you whether transitions are smooth or abrupt.' },
      {
        type: 'prose',
        paragraphs: [
