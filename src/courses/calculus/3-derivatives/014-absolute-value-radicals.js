...
export default {
  ...
  intuition: {
    blocks: [
      ...
      { type: 'image', src: continuityUrl, alt: 'Function with a corner showing non-differentiability', caption: 'Absolute value and radicals create corners and cusps where the derivative does not exist.' },
    ],
    callouts: [
      {
        type: 'definition',
