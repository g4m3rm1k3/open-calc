...
export default {
  ...
  intuition: {
    blocks: [
      ...
      { type: 'image', src: cornerCuspUrl, alt: 'Corner at origin for |x| and vertical tangent for x^(1/3)', caption: '|x| is not differentiable at 0 (corner); x^(1/3) is not differentiable at 0 (vertical tangent).' },
      {
        type: 'prose',
        paragraphs: [
