export default {
  ...
  subtitle:
    "The four ways a function can fail to be continuous — and why each is different",
  tags: [
    "discontinuity",
  ...
  hook: {
    question:
      "A GPS plots your position every second. Between updates, it interpolates smoothly. But if it loses signal and jumps to a new location — that's a discontinuity. Can you tell, just by looking at a graph, exactly what went wrong?",
    realWorldContext:
  ...
  intuition: {
    ...
    visualizations: [
        ...
        caption:
          "Compare three scenarios: the function has a hole (undefined), the hole is filled at the wrong height (still discontinuous), and the hole is filled correctly (continuous). Only the last is continuous.",
      },
      {
        id: "TwoSidedLimit",
        title: "Jump Discontinuity",
        caption:
          "Left and right particles approach from opposite sides but land at different heights — the two-sided limit does not exist.",
      },
      {
        id: "OscillationViz",
        title: "Oscillating Discontinuity: sin(1/x)",
        caption:
          "As x → 0, sin(1/x) oscillates infinitely rapidly. No limit exists.",
      },
      {
        id: "Ch3_5_BrokenFunction",
        title: "Story Viz — Broken Function",
        caption:
          "Book 3 Chapter 5 story visualization on indeterminate forms and removable holes.",
      },
    ],
  },
  ...
  examples: [
    {
      ...
      steps: [
        {
          expression: "f(2) = \\frac{0}{0} \\text{ (undefined)}.",
          annotation: "The function is undefined at x = 2.",
        },
        {
          expression:
            "\\frac{x^2 - 4}{x - 2} = \\frac{(x-2)(x+2)}{x-2} = x+2 \\quad (x \\neq 2)",
          annotation: "Factor and cancel for x ≠ 2.",
        },
        {
        ...
        {
          expression:
            "\\text{Type: Removable discontinuity (hole at } (2, 4)\\text{)}.",
          annotation:
            "Limit exists but function undefined there. Fix: define f(2) = 4.",
        },
      ],
      conclusion:
        "Removable discontinuity at x = 2. The graph of f is the line y = x+2 with a hole at (2, 4).",
    },
    {
      id: "ch1-disc-ex2",
      title: "Classify Discontinuity in a Piecewise Function",
      problem:
        "Classify discontinuities of $f(x) = \\begin{cases} x + 1 & x < 1 \\\\ 3 & x = 1 \\\\ x^2 & x > 1 \\end{cases}$",
      steps: [
        {
          expression: "\\lim_{x \\to 1^-} f(x) = \\lim_{x \\to 1^-} (x+1) = 2",
          annotation: "Left-hand limit: approach from x < 1.",
        },
        {
          expression: "\\lim_{x \\to 1^+} f(x) = \\lim_{x \\to 1^+} x^2 = 1",
          annotation: "Right-hand limit: approach from x > 1.",
        },
        { expression: "f(1) = 3", annotation: "Function value at x = 1." },
        {
          expression: "L^- = 2 \\neq 1 = L^+",
          annotation: "Both one-sided limits exist but are unequal.",
        },
        {
          expression:
            "\\text{Type: Jump discontinuity with jump size } |2 - 1| = 1.",
          annotation:
            "The function value 3 is irrelevant to the classification — what matters is the one-sided limits.",
        },
      ],
      conclusion:
        "Jump discontinuity at x = 1. The left limit (2) and right limit (1) are both finite but different. Neither equals f(1) = 3.",
    },
    {
      id: "ch1-disc-ex3",
      ...
      steps: [
        {
          expression: "\\lim_{x \\to 3^-} \\frac{1}{(x-3)^2}",
          annotation:
            "As x → 3 from the left, (x−3)² → 0⁺, so the fraction → +∞.",
        },
        {
          expression: "\\lim_{x \\to 3^+} \\frac{1}{(x-3)^2} = +\\infty",
          annotation:
            "As x → 3 from the right, same: (x−3)² → 0⁺, fraction → +∞.",
        },
        {
          expression: "\\text{Type: Infinite discontinuity.}",
          annotation:
            "Both one-sided limits are +∞. This is a vertical asymptote.",
        },
        {
          expression:
            "\\text{Note: Both sides go to } +\\infty \\text{ (not opposite signs).}",
          annotation:
            "Unlike 1/x, the square in the denominator makes both sides positive.",
        },
      ],
      conclusion:
        "Infinite discontinuity (vertical asymptote) at x = 3. Both sides approach +∞, so the graph shoots upward on both sides of x = 3.",
    },
    {
      id: "ch1-disc-ex4",
      title: "Identify and Remove a Discontinuity",
      problem:
        "Find all discontinuities of $g(x) = \\dfrac{\\sin(x)}{x}$ for $x \\in \\mathbb{R}$, classify them, and extend $g$ to a continuous function.",
      steps: [
        {
          expression: "g(0) \\text{ is undefined (division by zero)}.",
          annotation: "Potential discontinuity only at x = 0.",
        },
        {
          expression: "\\lim_{x \\to 0} \\frac{\\sin x}{x} = 1",
          annotation:
            "The fundamental trig limit (proven geometrically via Squeeze Theorem).",
        },
        {
          expression: "\\text{Type: Removable discontinuity at } x = 0.",
          annotation: "Limit exists (= 1) but g(0) is undefined.",
        },
        {
          expression:
            "\\tilde{g}(x) = \\begin{cases} \\sin(x)/x & x \\neq 0 \\\\ 1 & x = 0 \\end{cases}",
          annotation: "Define ĝ(0) = 1 to fill the hole.",
        },
        {
          expression: "\\tilde{g} \\text{ is continuous everywhere.}",
          annotation:
            "This extended function is called the sinc function (unnormalized) and is fundamental in signal processing.",
        },
      ],
      conclusion:
        "One removable discontinuity at x = 0. The sinc function is the continuous extension. It appears everywhere in Fourier analysis and signal processing.",
    },
  ],
  ...
  challenges: [
    {
      ...
      difficulty: "medium",
      problem:
        "For what value(s) of $a$ is $f(x) = \\begin{cases} x^2 - 3 & x < 2 \\\\ ax + 1 & x \\geq 2 \\end{cases}$ continuous everywhere?",
      hint: "For continuity at x = 2, you need the left-hand limit = right-hand limit = f(2). Compute both and solve for a.",
      walkthrough: [
        {
          expression: "\\lim_{x \\to 2^-} f(x) = (2)^2 - 3 = 4 - 3 = 1",
          annotation: "Left-hand limit: use the formula for x < 2.",
        },
        {
          expression: "\\lim_{x \\to 2^+} f(x) = a(2) + 1 = 2a + 1",
          annotation: "Right-hand limit: use the formula for x ≥ 2.",
        },
        {
          expression: "f(2) = a(2) + 1 = 2a + 1",
          annotation:
            "Function value at x = 2 (since 2 ≥ 2, use the second piece).",
        },
        {
          expression: "1 = 2a + 1 \\Rightarrow a = 0",
          annotation: "Set left-hand limit = right-hand limit and solve for a.",
        },
      ],
      answer:
        "a = 0. Then f(x) = x² − 3 for x < 2 and f(x) = 1 for x ≥ 2, with both pieces agreeing at x = 2 (value = 1).",
    },
    {
      id: "ch1-disc-c2",
      difficulty: "hard",
      problem:
        "Prove that $f(x) = \\sin(1/x)$ cannot be extended to a continuous function at $x = 0$ by any definition of $f(0)$.",
      ...
      walkthrough: [
        {
          expression:
            "\\text{Suppose } f(0) = L \\text{ for some } L \\in [-1, 1].",
          annotation: "Assume for contradiction that some extension works.",
        },
        {
          expression:
            "x_k = \\frac{2}{\\pi + 4k\\pi} \\to 0 \\text{ as } k \\to \\infty, \\quad \\sin(1/x_k) = 1",
          annotation: "These x-values approach 0 but f(x_k) = 1 always.",
        },
        {
          expression:
            "y_k = \\frac{2}{3\\pi + 4k\\pi} \\to 0 \\text{ as } k \\to \\infty, \\quad \\sin(1/y_k) = -1",
          annotation: "These x-values approach 0 but f(y_k) = -1 always.",
        },
        {
          expression: "\\text{If } L = 1: |f(y_k) - L| = 2 \\not\\to 0.",
          annotation: "f stays at -1 along the y_k sequence, not at L = 1.",
        },
        {
          expression: "\\text{If } L = -1: |f(x_k) - L| = 2 \\not\\to 0.",
          annotation: "f stays at 1 along the x_k sequence, not at L = -1.",
        },
        {
          expression:
            "\\text{Any other } L: \\text{ both sequences give } |f - L| \\geq 1 > 0.",
          annotation:
            "For any L, at least one of the sequences is distance ≥ 1 from L.",
        },
        {
          expression:
            "\\therefore \\nexists \\lim_{x \\to 0} \\sin(1/x) \\Rightarrow \\text{no continuous extension.}",
          annotation:
            "QED. The oscillating discontinuity cannot be removed by any choice of f(0).",
        },
      ],
      answer:
        "No value of f(0) makes sin(1/x) continuous at 0. The oscillating discontinuity is essential.",
    },
  ],
  ...
  crossRefs: [
    {
      ...
      label: "Continuity",
      context: "This lesson builds directly on the definition of continuity.",
    },
    {
      lessonSlug: "intermediate-value-theorem",
      label: "Intermediate Value Theorem",
      context:
        "IVT applies only to continuous functions — discontinuities break it.",
    },
    {
      lessonSlug: "limits-at-infinity",
      label: "Limits at Infinity",
      context:
        "Infinite discontinuities and vertical asymptotes connect to horizontal asymptotes.",
    },
    {
      lessonSlug: "improper-integrals",
      label: "Improper Integrals",
      context:
        "Infinite discontinuities in the integrand create improper integrals.",
    },
  ],
  ...
  quiz: [
    {
      id: 'disc-q1',
      type: 'choice',
      text: 'For a removable discontinuity at $x = c$, which statement is true?',
      options: [
        '$\\lim_{x \\to c} f(x)$ does not exist',
        '$\\lim_{x \\to c} f(x)$ exists but does not equal $f(c)$ (or $f(c)$ is undefined)',
        'Both one-sided limits are $\\pm\\infty$',
        'The left-hand limit and right-hand limit are finite but unequal',
      ],
      answer: '$\\lim_{x \\to c} f(x)$ exists but does not equal $f(c)$ (or $f(c)$ is undefined)',
      hints: ['A removable discontinuity is one you can "fill in" with a single point.'],
      reviewSection: 'Intuition tab — Type 1: Removable Discontinuity',
    },
    {
      id: 'disc-q2',
      type: 'input',
      text: 'Compute $\\lim_{x \\to 2} \\dfrac{x^2 - 4}{x - 2}$.',
      answer: '4',
      hints: ['Factor the numerator: $x^2 - 4 = (x-2)(x+2)$. Cancel $(x-2)$.'],
      reviewSection: 'Examples tab — Example 1: classify removable discontinuity',
    },
    {
      id: 'disc-q3',
      type: 'choice',
      text: 'The function $f(x) = \\dfrac{x^2 - 4}{x - 2}$ has what type of discontinuity at $x = 2$?',
      options: ['Jump', 'Infinite', 'Oscillating', 'Removable'],
      answer: 'Removable',
      hints: ['The limit exists and equals 4, but the function is undefined at $x = 2$.'],
      reviewSection: 'Examples tab — Example 1: removable discontinuity',
    },
    {
      id: 'disc-q4',
      type: 'input',
      text: 'For the piecewise function $f(x) = x+1$ for $x < 1$ and $f(x) = x^2$ for $x > 1$, compute $\\lim_{x \\to 1^-} f(x)$.',
      answer: '2',
      hints: ['Use the left branch: $\\lim_{x \\to 1^-}(x+1) = 1 + 1$.'],
      reviewSection: 'Examples tab — Example 2: jump discontinuity',
    },
    {
      id: 'disc-q5',
      type: 'input',
      text: 'For the same function ($f(x) = x+1$ for $x < 1$ and $f(x) = x^2$ for $x > 1$), compute $\\lim_{x \\to 1^+} f(x)$.',
      answer: '1',
      hints: ['Use the right branch: $\\lim_{x \\to 1^+} x^2 = 1^2$.'],
      reviewSection: 'Examples tab — Example 2: jump discontinuity',
    },
    {
      id: 'disc-q6',
      type: 'choice',
      text: 'For a jump discontinuity at $x = c$, which is true?',
      options: [
        'Both one-sided limits are $\\pm\\infty$',
        'The two-sided limit exists but $f(c)$ is wrong',
        'Both one-sided limits are finite but unequal',
        'No limit of any kind exists',
      ],
      answer: 'Both one-sided limits are finite but unequal',
      hints: ['The function "jumps" from one finite value to another.'],
      reviewSection: 'Intuition tab — Type 2: Jump Discontinuity',
    },
    {
      id: 'disc-q7',
      type: 'choice',
      text: 'The function $f(x) = 1/(x-3)^2$ has what type of discontinuity at $x = 3$?',
      options: ['Removable', 'Jump', 'Infinite', 'Oscillating'],
      answer: 'Infinite',
      hints: ['As $x \\to 3$, the denominator goes to 0 so the function blows up.'],
      reviewSection: 'Examples tab — Example 3: infinite discontinuity',
    },
    {
      id: 'disc-q8',
      type: 'choice',
      text: 'The function $f(x) = \\sin(1/x)$ at $x = 0$ has what type of discontinuity?',
      options: ['Removable', 'Jump', 'Infinite', 'Oscillating'],
      answer: 'Oscillating',
      hints: ['As $x \\to 0$, $\\sin(1/x)$ oscillates between $-1$ and $1$ infinitely many times.'],
      reviewSection: 'Intuition tab — Type 4: Oscillating Discontinuity',
    },
    {
      id: 'disc-q9',
      type: 'input',
      text: 'For the piecewise $f(x) = \\begin{cases} x^2 - 3 & x < 2 \\\\ ax + 1 & x \\geq 2 \\end{cases}$ to be continuous at $x = 2$, what value of $a$ is needed?',
      answer: '0',
      hints: [
        'Compute $\\lim_{x\\to 2^-} f(x) = 4 - 3 = 1$. Then $f(2) = 2a + 1$. Set equal and solve.',
        '$1 = 2a + 1 \\Rightarrow a = 0$.',
      ],
      reviewSection: 'Challenges tab — Challenge 1: making a piecewise continuous',
    },
    {
      id: 'disc-q10',
      type: 'choice',
      text: 'Which type of discontinuity can ALWAYS be removed by redefining $f$ at a single point?',
      options: ['Jump', 'Infinite', 'Oscillating', 'Removable'],
      answer: 'Removable',
      hints: ['The name tells you — the discontinuity is removable by patching one point.'],
      reviewSection: 'Intuition tab — classification of discontinuities',
    },
  ],
};
