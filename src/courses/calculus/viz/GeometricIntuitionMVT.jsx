...
export default function GeometricIntuitionMVT() {
  ...
  return (
    <div style={{ fontFamily: 'var(--font-sans)', padding: '4px 0', maxWidth: 800, margin: '0 auto', color: C.textMain, background: C.bg }}>
      <h2 style={{ fontSize: 26, fontWeight: 700, textAlign: 'center', marginBottom: 8, color: C.textMain }}>Geometric Intuition: Mean Value Theorem for Integrals</h2>
      <div style={{ textAlign: 'center', color: C.textMuted, fontSize: 16, marginBottom: 12 }}>
        The area under <M t={'f'} /> on <M t={'[a, b]'} /> is equal to the area of a rectangle with height equal to the average value of <M t={'f'} />.
      </div>
      ...
      <div style={{ background: C.greenBg, borderLeft: `3px solid ${C.greenMain}`, borderRadius: 8, padding: 18, marginTop: 24, color: C.textMain, marginBottom: 16 }}>
        <b style={{ color: C.greenMain }}>Geometric meaning:</b> The theorem guarantees that the area under the curve is exactly equal to the area of a rectangle with height equal to the average value of the function. No matter how the function wiggles, there is always some c where f(c) equals this average height.
      </div>
    </div>
  );
}
