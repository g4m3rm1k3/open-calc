...
export default {
  ...
  intuition: {
    blocks: [
      ...
      { type: 'image', src: relatedRatesUrl, alt: 'Sliding ladder: x²+y²=L² links positions; differentiating links their rates', caption: 'The geometric constraint is the equation; differentiating both sides w.r.t. t links the rates.' },
      {
        type: 'prose',
        paragraphs: [
