...
import completeSquareUrl from '../diagrams/calc-complete-square.svg?url';
import vertexFormUrl from '../diagrams/calc-vertex-form.svg?url';
export default {
  ...
  intuition: {
    blocks: [
      ...
      { type: 'image', src: completeSquareUrl, alt: 'Geometric square-and-rectangle diagram alongside the four algebraic steps of completing the square', caption: 'The geometric picture explains the name: you literally complete a square by adding the missing corner piece (b/2)².' },
      {
        type: 'prose',
        paragraphs: [
      ...
      { type: 'image', src: vertexFormUrl, alt: 'Three panels showing how to read the vertex, convert between forms, and the calculus derivative connection', caption: 'Vertex form reveals the minimum or maximum directly; in calculus, completing the square transforms integrals like ∫dx/(x²+a²) into the arctan form.' },
    ],
    callouts: [
      {
        type: 'intuition',
