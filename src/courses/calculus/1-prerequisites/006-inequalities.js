...
import compoundInequalityUrl from '../diagrams/calc-compound-inequality.svg?url';
import quadraticInequalityUrl from '../diagrams/calc-quadratic-inequality.svg?url';
export default {
  id: 'ch0-inequalities',
  slug: 'inequalities',
  chapter: 0,
  ...
  intuition: {
    blocks: [
      ...
      { type: 'image', src: quadraticInequalityUrl, alt: 'Sign chart for a quadratic inequality showing positive and negative regions', caption: 'The sign chart method: factor, mark critical points, test each region — wherever the sign is positive is the solution when solving > 0.' },
      ...
      { type: 'image', src: compoundInequalityUrl, alt: 'Two number line panels showing AND inequality (connected interval) vs OR inequality (two rays)', caption: 'AND inequalities produce a single connected interval; OR inequalities produce a union of two separate rays.' },
