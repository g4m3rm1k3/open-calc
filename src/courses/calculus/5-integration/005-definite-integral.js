...
import definiteIntegralAreaUrl from '../diagrams/calc-definite-integral-area.svg?url';
import integralPropertiesUrl from '../diagrams/calc-integral-properties.svg?url';
...
export default {
  ...
  intuition: {
    blocks: [
      ...
      { type: 'image', src: definiteIntegralAreaUrl, alt: 'Labeled anatomy of ∫ₐᵇ f(x) dx: integral sign, integrand, limits, differential', caption: '∫ₐᵇ f(x) dx — every piece of the notation has meaning: a and b are bounds, f(x) is the height, dx is the infinitesimal width.' },
      {
        type: 'prose',
        paragraphs: [
      ...
      { type: 'image', src: integralPropertiesUrl, alt: 'Table of definite integral properties: linearity, interval splitting, flip bounds', caption: 'Properties like ∫ₐᵇ+∫ᵦ꜀=∫ₐ꜀ and reversing limits let you compute complex integrals by breaking them apart.' },
    ],
    callouts: [
      {
        type: "geometric",
