...
import areaAccumulationUrl from '../diagrams/calc-area-accumulation.svg?url';
import signedAreaUrl from '../diagrams/calc-signed-area.svg?url';
...
export default {
  ...
  intuition: {
    blocks: [
      ...
      { type: 'image', src: areaAccumulationUrl, alt: 'Area function A(x) growing as the right boundary x moves rightward', caption: 'The accumulation function A(x) = ∫ₐˣ f(t) dt is itself a function — its derivative is f(x).' },
      {
        type: 'prose',
        paragraphs: [
      ...
      { type: 'image', src: signedAreaUrl, alt: 'Region above x-axis labeled positive, below labeled negative', caption: 'Definite integrals measure signed area: regions below the x-axis contribute negatively to the total.' },
    ],
    callouts: [
      {
