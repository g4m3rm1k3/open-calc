  ...
  quiz: [
    {
      id: 'shell-q1',
      type: 'choice',
      text: 'The Shell Method for rotation about the \\(y\\)-axis gives volume as:',
      options: [
      ...
      hints: ['Each shell has radius \\(x\\), height \\(f(x)\\), and thickness \\(dx\\). Unrolled area = \\(2\\pi x \\cdot f(x)\\,dx\\).'],
      reviewSection: 'Math — Shell method formula',
    },
    {
      id: 'shell-q2',
      type: 'input',
      text: 'Use the Shell Method to find the volume of the solid obtained by rotating \\(y = x^2\\) about the \\(y\\)-axis from \\(x=0\\) to \\(x=2\\).',
      answer: '8*pi',
      hints: ['\\(V = 2\\pi\\int_0^2 x \\cdot x^2\\,dx = 2\\pi\\int_0^2 x^3\\,dx = 2\\pi[x^4/4]_0^2 = 2\\pi \\cdot 4 = 8\\pi\\).'],
      reviewSection: 'Math — Shell method',
    },
    {
      id: 'shell-q3',
      type: 'input',
      text: 'Use the Shell Method to find the volume obtained by rotating the region under \\(y = x\\) (from \\(x=0\\) to \\(x=3\\)) about the \\(y\\)-axis.',
      answer: '18*pi',
      hints: ['\\(V = 2\\pi\\int_0^3 x \\cdot x\\,dx = 2\\pi\\int_0^3 x^2\\,dx = 2\\pi[x^3/3]_0^3 = 2\\pi \\cdot 9 = 18\\pi\\).'],
      reviewSection: 'Math — Shell method',
    },
    {
      id: 'shell-q4',
      type: 'choice',
      text: 'When is the Shell Method particularly advantageous over the Disk/Washer Method?',
      options: [
        'When the region is bounded by two curves with the same sign',
        'When converting to \\(y\\) as a function of \\(x\\) (to apply Disk/Washer) would be algebraically difficult',
        'When the function is linear',
        'When integrating over an infinite interval',
      ],
      answer: 'When converting to \\(y\\) as a function of \\(x\\) (to apply Disk/Washer) would be algebraically difficult',
      hints: ['Shell stays in the original variable, avoiding the need to invert the function.'],
      reviewSection: 'Math — When to use shell vs disk',
    },
    {
      id: 'shell-q5',
      type: 'input',
      text: 'Use the Shell Method to find the volume generated by rotating the region bounded by \\(y = \\sqrt{x}\\) and \\(y = 0\\) on \\([0, 4]\\) about the \\(y\\)-axis.',
      answer: '128*pi/5',
      hints: ['\\(V = 2\\pi\\int_0^4 x\\sqrt{x}\\,dx = 2\\pi\\int_0^4 x^{3/2}\\,dx = 2\\pi[\\frac{2}{5}x^{5/2}]_0^4 = 2\\pi \\cdot \\frac{2}{5} \\cdot 32 = \\frac{128\\pi}{5}\\).'],
      reviewSection: 'Math — Shell method',
    },
    {
      id: 'shell-q6',
      type: 'input',
      text: 'Use the Shell Method to find the volume of the solid formed by rotating the area between \\(y = x\\) and \\(y = x^2\\) on \\([0,1]\\) about the \\(y\\)-axis.',
      answer: 'pi/6',
      hints: ['\\(V = 2\\pi\\int_0^1 x(x - x^2)\\,dx = 2\\pi\\int_0^1(x^2 - x^3)\\,dx = 2\\pi[x^3/3 - x^4/4]_0^1 = 2\\pi(1/3 - 1/4) = 2\\pi/12 = \\pi/6\\).'],
      reviewSection: 'Math — Shell method between two curves',
    },
    {
      id: 'shell-q7',
      type: 'input',
      text: 'Verify using the Disk Method: the volume of the solid formed by rotating \\(y=x\\) from \\(x=0\\) to \\(x=2\\) about the \\(x\\)-axis is \\(\\pi\\int_0^2 x^2\\,dx\\). Evaluate this.',
      answer: '8*pi/3',
      hints: ['\\(\\pi[x^3/3]_0^2 = \\pi(8/3) = 8\\pi/3\\).'],
      reviewSection: 'Math — Disk method revisited',
    },
    {
      id: 'shell-q8',
      type: 'choice',
      text: 'In the Shell Method, each shell has three dimensions: radius, height, and thickness. Which dimension corresponds to the integration variable \\(dx\\)?',
      options: ['Radius', 'Height', 'Thickness', 'Circumference'],
      answer: 'Thickness',
      hints: ['\\(dx\\) is the infinitesimal thickness of each cylindrical shell.'],
      reviewSection: 'Math — Geometry of shells',
    },
    {
      id: 'shell-q9',
      type: 'input',
      text: 'Use the Shell Method to find the volume generated by rotating the region under \\(y = e^x\\) on \\([0, 1]\\) about the \\(y\\)-axis. Set up the integral \\(2\\pi\\int_0^1 x\\,e^x\\,dx\\) and evaluate using integration by parts.',
      answer: '2*pi',
      hints: ['\\(\\int x e^x dx = xe^x - e^x\\). So \\(V = 2\\pi[xe^x - e^x]_0^1 = 2\\pi[(e-e)-(0-1)] = 2\\pi\\).'],
      reviewSection: 'Math — Shell method with integration by parts',
    },
    {
      id: 'shell-q10',
      type: 'input',
      text: 'Use the Shell Method to find the volume generated by rotating the region under \\(y = x^3\\) on \\([0, 2]\\) about the \\(y\\)-axis.',
      answer: '64*pi/5',
      hints: ['\\(V = 2\\pi\\int_0^2 x\\cdot x^3\\,dx = 2\\pi\\int_0^2 x^4\\,dx = 2\\pi[x^5/5]_0^2 = 2\\pi(32/5) = 64\\pi/5\\).'],
      reviewSection: 'Math — Shell method',
    },
  ],
}
