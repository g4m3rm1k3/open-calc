  ...
  quiz: [
    {
      id: 'num-int-q1',
      type: 'input',
      text: 'For the Trapezoidal Rule with \\(n=4\\) on \\([0,4]\\), what is \\(\\Delta x\\)?',
      answer: '1',
      hints: ['\\(\\Delta x = (b-a)/n = (4-0)/4 = 1\\).'],
      reviewSection: 'Math — Setting up numerical integration',
    },
    {
      id: 'num-int-q2',
      type: 'input',
      text: 'Apply the Trapezoidal Rule with \\(n=4\\) to approximate \\(\\int_0^4 x\\,dx\\). Use \\(\\Delta x=1\\) and nodes \\(x_0=0, x_1=1, x_2=2, x_3=3, x_4=4\\).',
      answer: '8',
      hints: ['\\(T_4 = \\frac{1}{2}[f(0)+2f(1)+2f(2)+2f(3)+f(4)] = \\frac{1}{2}[0+2+4+6+4] = \\frac{16}{2} = 8\\).', 'The Trapezoid rule is exact for linear functions.'],
      reviewSection: 'Math — Trapezoid rule',
    },
    {
      id: 'num-int-q3',
      type: 'input',
      text: 'Apply the Trapezoidal Rule with \\(n=4\\) to approximate \\(\\int_0^2 x^2\\,dx\\). \\(\\Delta x = 0.5\\). Nodes: 0, 0.5, 1, 1.5, 2. \\(f\\)-values: 0, 0.25, 1, 2.25, 4.',
      answer: '2.75',
      hints: ['\\(T_4 = \\frac{0.5}{2}[0 + 2(0.25) + 2(1) + 2(2.25) + 4] = 0.25[0+0.5+2+4.5+4] = 0.25 \\times 11 = 2.75\\).'],
      reviewSection: 'Math — Trapezoid rule application',
    },
    {
      id: 'num-int-q4',
      type: 'choice',
      text: 'Simpson\'s Rule requires that \\(n\\) is:',
      options: ['Any positive integer', 'An even positive integer', 'A multiple of 4', 'A prime number'],
      answer: 'An even positive integer',
      hints: ['Simpson\'s Rule pairs up subintervals, so \\(n\\) must be even.'],
      reviewSection: 'Math — Simpson\'s rule requirement',
    },
    {
      id: 'num-int-q5',
      type: 'input',
      text: 'Apply Simpson\'s Rule with \\(n=4\\) to approximate \\(\\int_0^2 x^2\\,dx\\). \\(\\Delta x=0.5\\). Coefficients: 1, 4, 2, 4, 1. \\(f\\)-values at nodes 0, 0.5, 1, 1.5, 2 are 0, 0.25, 1, 2.25, 4.',
      answer: '8/3',
      hints: ['\\(S_4 = \\frac{0.5}{3}[1(0)+4(0.25)+2(1)+4(2.25)+1(4)] = \\frac{1}{6}[0+1+2+9+4] = \\frac{16}{6} = \\frac{8}{3}\\).', 'This equals the exact value!'],
      reviewSection: 'Math — Simpson\'s rule',
    },
    {
      id: 'num-int-q6',
      type: 'choice',
      text: 'For a concave-up function, the Trapezoidal Rule:',
      options: [
        'Underestimates the integral',
        'Overestimates the integral',
        'Gives the exact value',
        'Gives the same result as the Midpoint Rule',
      ],
      answer: 'Overestimates the integral',
      hints: ['Trapezoids lie above a concave-up curve, so they overcount the area.'],
      reviewSection: 'Math — Error behavior of Trapezoid rule',
    },
    {
      id: 'num-int-q7',
      type: 'input',
      text: 'The Trapezoidal Rule formula is \\(T_n = \\frac{\\Delta x}{2}[f(x_0)+2f(x_1)+\\cdots+2f(x_{n-1})+f(x_n)]\\). Apply with \\(n=2\\) to approximate \\(\\int_0^2 e^x\\,dx\\). \\(\\Delta x=1\\). \\(f(0)=1, f(1)=e, f(2)=e^2\\).',
      answer: '(1 + 2*e + e^2) / 2',
      hints: ['\\(T_2 = \\frac{1}{2}[1 + 2e + e^2]\\).'],
      reviewSection: 'Math — Trapezoid rule',
    },
    {
      id: 'num-int-q8',
      type: 'input',
      text: 'For \\(n=4\\) Simpson\'s Rule on \\([a,b]\\), the sum of all coefficients in \\([1, 4, 2, 4, 1]\\) is:',
      answer: '12',
      hints: ['1 + 4 + 2 + 4 + 1 = 12.'],
      reviewSection: 'Math — Simpson\'s rule coefficients',
    },
    {
      id: 'num-int-q9',
      type: 'choice',
      text: 'Simpson\'s Rule is exact for polynomials of degree up to:',
      options: ['1', '2', '3', '4'],
      answer: '3',
      hints: ['Simpson\'s Rule uses parabolic approximation and is exact for degree ≤ 3 polynomials.'],
      reviewSection: 'Math — Accuracy of Simpson\'s rule',
    },
    {
      id: 'num-int-q10',
      type: 'input',
      text: 'Using the Midpoint Rule with \\(n=4\\) on \\([0,4]\\), \\(\\Delta x=1\\). Midpoints: 0.5, 1.5, 2.5, 3.5. Approximate \\(\\int_0^4 x\\,dx\\).',
      answer: '8',
      hints: ['\\(M_4 = 1\\cdot[0.5+1.5+2.5+3.5] = 8\\). Exact for linear functions.'],
