  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden hover:shadow-md transition-shadow">
      <div className="px-4 pt-4 pb-2 flex items-start justify-between gap-2">
        ...
        <span className={`shrink-0 text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${c.badge}`}>
          {entry.categoryLabel}
        </span>
      </div>
      <div
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mt-10 text-center text-xs text-slate-300 dark:text-slate-600">
        {ALL_ENTRIES.length} formulas across {REFERENCE_CATEGORIES.length} categories
      </div>
    </div>
  )
}
