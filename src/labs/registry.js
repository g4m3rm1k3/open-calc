export const LABS = [
  ...
  },
  {
    ...
    kind: 'lab',
    subject: 'Math',
    desc: 'A MATLAB-like image workspace for seeing what matrix operations do to real pixels: inspect RGB values, split channels, tune histograms, design kernels, compare errors, and run image-derived matrices in an OpenMAT notebook.',
    path: '/lab/image-lab',
