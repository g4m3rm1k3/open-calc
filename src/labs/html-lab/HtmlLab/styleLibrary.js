...
// Note: Layouts should NEVER conflict with colors, and vice versa.
export const COMPONENT_PRESETS = [
  ...
  // ── Visual Presets (Strictly thematic, minimal structural impact) ──
  {
    key: "card-clean",
    label: "Card (Clean)",
    category: "Styles",
...
export const PROP_PRESETS = {
  border: [
    "none",
    "1px solid #e2e8f0", // Clean light border
    "1px solid #334155", // Dark mode border
    "2px solid #3b82f6", // Blue outline
    "2px solid #10b981", // Green outline
    "2px solid #ef4444", // Red outline
    "1px dashed #cbd5e1", // Dashed light
    "1px solid rgba(255,255,255,0.2)", // Glass border
  ],
  ...
  boxShadow: [
    ...
    "0 10px 15px -3px rgba(0,0,0,0.1)", // Elevated
    "0 20px 25px -5px rgba(0,0,0,0.1)", // Floating
    "0 8px 32px 0 rgba(0,0,0,0.1)", // Glass shadow
    "0 0 15px rgba(59,130,246,0.5)", // Neon blue glow
    "0 0 15px rgba(16,185,129,0.5)", // Neon green glow
  ],
  backgroundColor: [
    "transparent",
    "#ffffff", // Clean White
    ...
    "rgba(0,0,0,0.2)", // Glass Dark
  ],
  backgroundImage: [
    "none",
    "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", // Purple Bliss
    "linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)", // Blue Ocean
    "linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)", // Mint
    "linear-gradient(135deg, #fa709a 0%, #fee140 100%)", // Sunset
    "linear-gradient(180deg, #0f172a 0%, #1e293b 100%)", // Dark Fade
    "linear-gradient(180deg, #f8fafc 0%, #e2e8f0 100%)", // Light Fade
    "linear-gradient(90deg, #3b82f6 0%, #8b5cf6 100%)", // Brand Primary
  ],
  color: [
