...
export const SERIES: SeriesMeta[] = [
  {
    ...
    levels: [
      ...
      { level: 12, title: 'Input',                        file: 'python-fundamentals/level-12.md' },
      { level: 13, title: 'Expressions & Operators',      file: 'python-fundamentals/level-13.md' },
      { level: 14, title: 'Comparisons & Booleans',       file: 'python-fundamentals/level-14.md' },
      { level: 15, title: 'if / elif / else',             file: 'python-fundamentals/level-15.md' },
      { level: 16, title: 'while Loops',                  file: 'python-fundamentals/level-16.md' },
      { level: 17, title: 'for Loops',                    file: 'python-fundamentals/level-17.md' },
      { level: 18, title: 'range()',                      file: 'python-fundamentals/level-18.md' },
      { level: 19, title: 'Functions',                    file: 'python-fundamentals/level-19.md' },
      { level: 20, title: 'Scope',                        file: 'python-fundamentals/level-20.md' },
      { level: 21, title: 'Lists',                        file: 'python-fundamentals/level-21.md' },
      { level: 22, title: 'List Methods',                 file: 'python-fundamentals/level-22.md' },
      { level: 23, title: 'Tuples',                       file: 'python-fundamentals/level-23.md' },
      { level: 24, title: 'Dictionaries',                 file: 'python-fundamentals/level-24.md' },
      { level: 25, title: 'Sets',                         file: 'python-fundamentals/level-25.md' },
      { level: 26, title: 'Files',                        file: 'python-fundamentals/level-26.md' },
      // Phase 2 — Writing Programs
      { level: 27, title: 'Modules & Imports',            file: 'python-fundamentals/level-27.md' },
      { level: 28, title: 'Exceptions',                   file: 'python-fundamentals/level-28.md' },
