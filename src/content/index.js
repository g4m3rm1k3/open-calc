...
const CHEMISTRY_CURRICULUM = [...chemistry1, ...chemistry2, ...chemistry3, ...chemistry4].map(ch => ({ ...ch, course: 'chemistry-1' }))
...
const GCODE_PARSER_CURRICULUM = gcodeParser1.map(ch => ({ ...ch, course: 'gcode-parser-1' }))
