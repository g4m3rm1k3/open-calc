export default {
  ...
  hook: {
    question:
      'A figure skater spins with arms outstretched at 1 revolution per second. ' +
      'She pulls her arms in close. Without any external torque, she suddenly spins at about 3 rev/s. ' +
      'Where did the extra rotational speed come from? No force was applied. No torque. Yet she sped up.',
    realWorldContext:
      'Angular momentum conservation (the rotational version of momentum conservation) ' +
      'explains the skater, a collapsing star becoming a pulsar, a diver tucking into a somersault, ' +
      'and the spiral dive of a hawk. ' +
      'All are consequences of \\(L = I\\omega = \\text{const}\\): ' +
      'when you reduce I by pulling mass inward, \\(\\omega\\) must increase to keep L constant.',
    previewVisualizationId: 'OscillationViz',
  },

  intuition: {
    prose: [
      '**The answer:** Angular momentum \\(L = I\\omega\\) is conserved when no external torque acts. ' +
        'Pulling arms in decreases I (mass moves closer to the axis → smaller \\(\\sum mr^2\\)). ' +
        'To keep \\(L = I\\omega\\) constant, \\(\\omega\\) must increase. ' +
        'The skater converts potential energy (muscle work) into rotational kinetic energy.',

      '**Moment of inertia depends on shape AND axis:** The same object has different I depending on where and how it rotates. ' +
        'A rod spun about its center (I = ML²/12) is easier to spin than the same rod spun about its end (I = ML²/3) — ' +
        'one-third of the end-axis value. Same rod, same mass, 3× different rotational resistance.',

      '**The \\(r^2\\) effect:** A kilogram at 1 m contributes 1 kg·m² to I. ' +
        'The same kilogram at 2 m contributes 4 kg·m². At 3 m: 9 kg·m². ' +
        'Mass far from the axis dominates I. This is why hollow cylinders are harder to spin than solid ones of equal mass — ' +
        'the hollow one concentrates mass at the rim.',

      '**Angular momentum conservation:** In the absence of external torque, \\(L = I\\omega = \\text{const}\\). ' +
        'This is the rotational analogue of linear momentum conservation. ' +
        'Divers tuck (reduce I) to spin faster mid-air. Astronomers watch pulsars (collapsed stars) spin at 700 rev/s — ' +
        'the star\'s I collapsed by a factor of \\(10^{10}\\), so \\(\\omega\\) increased by the same factor.',
    ],
    callouts: [
      {
        type: 'sequencing',
      ...
      },
      {
        ...
        body:
          ...
          'Continuous: \\(I = \\int r^2\\,dm\\) \\qquad [\\text{SI: kg·m}^2]',
      },
      {
        type: 'theorem',
        title: 'Common moments of inertia',
        body:
          '\\text{Solid cylinder: } \\tfrac{1}{2}MR^2\\\\' +
          '\\text{Hollow cylinder: } MR^2\\\\' +
          '\\text{Solid sphere: } \\tfrac{2}{5}MR^2\\\\' +
          '\\text{Hollow sphere: } \\tfrac{2}{3}MR^2\\\\' +
          '\\text{Rod (center): } \\tfrac{1}{12}ML^2\\\\' +
          '\\text{Rod (end): } \\tfrac{1}{3}ML^2',
      },
      {
        type: 'theorem',
      ...
      },
      {
        ...
        body:
          'For a uniform rod of length L, mass M per length λ = M/L: ' +
          '\\(I = \\int_0^L \\lambda x^2\\,dx = \\frac{\\lambda L^3}{3} = \\frac{ML^2}{3}\\) (about the end). ' +
          'The \\(r^2\\) in the integrand weights far-away mass more heavily — the result is not ML²/2 (uniform weight) but ML²/3 (quadratic weight).',
      },
    ],
    visualizations: [
      {
        ...
        mathBridge:
          'Drag the "arm position" slider. As arms move in, I decreases, ω increases to conserve L. ' +
          'The total angular momentum L = Iω stays constant throughout.',
      ...
      },
      {
        ...
        caption:
          'All have the same mass M and "size" R. ' +
          'The hollow cylinder (I = MR²) is hardest to spin; the solid sphere (I = 2MR²/5) is easiest. ' +
          'Mass distribution, not just mass, determines rotational resistance.',
      },
    ],
  },
    ...
    callouts: [
      {
        ...
        body:
          'When you shift the axis by distance d, every mass element gains an extra term d² in its r². ' +
          'Summing \\(\\sum m_i(r_i^{\\prime 2}) = \\sum m_i r_i^2 + 2d\\sum m_i x_i + d^2 \\sum m_i\\). ' +
          'The middle term vanishes (cm at origin), leaving I_cm + Md².',
      },
      {
        type: 'mnemonic',
        title: 'Building intuition for the table of shapes',
        body:
          'More mass farther from axis → larger I.\\\\' +
          'Hollow always > solid (for same M, R).\\\\' +
          'Sphere < cylinder (sphere has more mass near center).\\\\' +
          'Rod (end) = 4× rod (center) — the end axis is twice as far.',
      },
    ],
    visualizations: [
      {
        ...
        mathBridge:
          'For a solid disk of radius R: shells at radius r have dm = (2πr)(M/πR²) dr. ' +
          'So I = ∫₀ᴿ r² · (2M/R²) r dr = (2M/R²) · R⁴/4 = MR²/2. ' +
          'The ½ comes from the integral — not from guessing.',
  ...
  examples: [
    {
      ...
      problem:
        '\\text{A skater (I₁ = 4.0 kg·m²) spins at 2 rev/s with arms out. ' +
        'She pulls in to I₂ = 1.5 kg·m². Find her new angular velocity.}',
      steps: [
        {
    ...
    },
    {
      ...
      problem:
        '\\text{A uniform rod (M = 3 kg, L = 1.2 m) rotates about one end. ' +
        'Find I using: (a) direct integration formula, (b) parallel axis theorem.}',
      steps: [
  ...
  challenges: [
    {
      ...
      difficulty: 'easy',
      problem:
        '\\text{Two 2 kg masses are attached to the ends of a massless rod 1.4 m long. ' +
        'Find I about the center and about one end.}',
    ...
    },
    {
      ...
      difficulty: 'medium',
      problem:
        '\\text{A solid cylinder (M = 4 kg, R = 0.2 m) spins at 20 rad/s. ' +
        'A torque of −0.8 N·m brakes it. How long until it stops?}',
    ...
    },
    {
      ...
      difficulty: 'hard',
      problem:
        '\\text{Derive I for a solid disk (radius R, mass M) using integration. ' +
        'Use shell elements dm = ρ(2πr)dr where ρ = M/(πR²).}',
