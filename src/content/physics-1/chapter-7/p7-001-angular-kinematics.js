export default {
  ...
  hook: {
    question:
      'A spinning wheel completes 10 revolutions in 4 seconds and is speeding up at a constant rate. ' +
      'How would you find its angular velocity at t = 4 s? ' +
      'Before reading further: does this problem feel like one you\'ve already solved?',
    realWorldContext:
      'Every rotating object — a car engine, a wind turbine, a gyroscope, a washing machine drum — ' +
      'is described by angular kinematics. ' +
      'Engineers specify motors in RPM (revolutions per minute) and angular acceleration in rad/s². ' +
      'The beautiful surprise: the mathematics is identical to linear kinematics, with angle replacing position and angular velocity replacing linear velocity.',
    previewVisualizationId: 'OscillationViz',
  },

  intuition: {
    prose: [
      '**The answer:** Yes — it is the exact same problem structure as linear kinematics. ' +
        'Replace \\(x \\to \\theta\\), \\(v \\to \\omega\\), \\(a \\to \\alpha\\), and every SUVAT equation still works. ' +
        'This is the rotational-linear analogy — one of the most elegant structural parallels in classical mechanics.',

      '**Angle in radians:** We measure rotation in radians (not degrees) because radians make the math clean. ' +
        'One radian is the angle that subtends an arc length equal to the radius: \\(s = r\\theta\\). ' +
        'A full circle is \\(2\\pi\\) radians (not 360°). ' +
        'The factor \\(r\\) connects every rotational quantity to its linear equivalent.',
      ...
      '**The analogy table:** ' +
        ...
        'And linking them to linear motion: \\(s = r\\theta\\), \\(v_t = r\\omega\\), \\(a_t = r\\alpha\\).',

      '**What changes at the rim:** A wheel spinning at \\(\\omega\\) rad/s has every point on the rim moving at linear speed \\(v = r\\omega\\). ' +
        'A point at radius \\(r = 0.5\\) m and \\(\\omega = 10\\) rad/s has \\(v = 5\\) m/s tangential speed. ' +
        'The outer edge moves faster than the inner edge — same \\(\\omega\\), different \\(v\\).',
    ],
    callouts: [
      {
        type: 'sequencing',
      ...
      },
      {
        ...
        body:
          '\\theta: \\text{angular displacement (rad)}\\\\' +
          '\\omega = d\\theta/dt: \\text{angular velocity (rad/s)}\\\\' +
          '\\alpha = d\\omega/dt: \\text{angular acceleration (rad/s}^2\\text{)}',
      },
      {
        type: 'theorem',
      ...
      },
      {
        ...
        body:
          'A point on a rotating wheel has two acceleration components: ' +
          'tangential \\(a_t = r\\alpha\\) (changes speed) and centripetal \\(a_c = r\\omega^2 = v^2/r\\) (changes direction). ' +
          '\\(\\alpha = 0\\) (constant rotation) means no tangential acceleration but always centripetal acceleration.',
      },
    ],
    visualizations: [
      {
        ...
        mathBridge:
          'Set ω and α. Watch the wheel spin. The angle θ accumulates; the arc length s = rθ grows on the rim. ' +
          'Angular velocity ω is constant rotation speed; α makes it accelerate.',
    ...
    callouts: [
      ...
      },
      {
        ...
        body:
          ...
          'Tangential: \\(a_t = r\\alpha\\) (changes speed — along rim)\\\\' +
          'Centripetal: \\(a_c = r\\omega^2\\) (changes direction — toward center)\\\\' +
    ...
    visualizations: [
      {
        ...
        caption:
          'Mirror of the linear chain x → v → a. Differentiate to go right; integrate to go left. ' +
          'The analogy is exact: replace every linear symbol with its rotational counterpart.',
      },
    ],
  },
  ...
  examples: [
    {
      ...
      problem:
        '\\text{A motor starts from rest and reaches 3000 RPM in 5 seconds at constant acceleration. ' +
        'Find α and the number of revolutions made.}',
      steps: [
        {
  ...
  challenges: [
    ...
    },
    {
      ...
      difficulty: 'medium',
      problem:
        '\\text{A disc (r = 0.3 m) decelerates from 50 rad/s to 10 rad/s in 8 s. ' +
        'Find α and the angle turned.}',
    ...
    },
    {
      ...
      difficulty: 'hard',
      problem:
        '\\text{A grinding wheel (r = 0.15 m) has ω₀ = 100 rad/s and decelerates at α = −2 rad/s². ' +
        'A point on the rim at t = 5 s: find (a) tangential speed, (b) centripetal acceleration, ' +
        '(c) total acceleration magnitude and angle.}',
