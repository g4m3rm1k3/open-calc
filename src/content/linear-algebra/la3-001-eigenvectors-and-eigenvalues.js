    ...
    if mod(iter, 2) == 0
        fprintf('  iter %2d: x=[%.6f; %.6f], λâ‰ˆ%.6f\\n', iter, x(1), x(2), lambda_est)
            ...
            },
            {
              ...
              prose: 'The natural vibration frequencies of a CNC machine frame are ω_i = sqrt(λ_i), where λ_i are eigenvalues of the mass-normalized stiffness matrix Mâ»¹K. Spindle speeds that match these frequencies cause resonance (chatter). Engineers plot these as "danger zones" and choose spindle RPM to stay between them.',
  ...
  challenges: [
    {
      ...
      answer: 'λ₁ = 5, v₁ = [1,0]áµ€; λ₁ = -3, v₁ = [0,1]áµ€',
    },
    {
      id: 'la3-001-ch2',
      difficulty: 'medium',
      ...
      answer: 'λ₁=5, v₁=[2,1]áµ€; λ₁=2, v₁=[1,-1]áµ€',
    },
    {
      id: 'la3-001-ch3',
      difficulty: 'hard',
      ...
      answer: 'Only one eigenvector: v = [1,0]áµ€. The matrix is defective — it cannot be diagonalized.',
    },
  ],
