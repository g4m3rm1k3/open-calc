  ...
  challenges: [
    {
      ...
      walkthrough: [
        ...
        '**Verify:** $\\begin{bmatrix}2&1\\\\1&2\\end{bmatrix}^2 = \\begin{bmatrix}5&4\\\\4&5\\end{bmatrix} = A$ âœ“. The matrix square root is symmetric (because $A$ is symmetric) and positive definite (eigenvalues $1, 3 > 0$).',
      ],
    },
    {
      id: 'ch-la4-006-2',
