...
print("Match:", np.allclose(inv_formula, np.linalg.inv(A)))`,
  ...
  examples: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          strategyTitle: 'Apply Cramer\'s Rule for x₂ and x₃',
          checkpoint: 'Verify: does $A[2,3,-1]^\\top$ equal $[8,-11,-3]^\\top$?',
          hints: ['Row 1: $2(2)+1(3)+(-1)(-1) = 4+3+1 = 8$ ✓. Row 2: $(-3)(2)+(-1)(3)+2(-1) = -6-3-2 = -11$ ✓. Row 3: $(-2)(2)+1(3)+2(-1) = -4+3-2 = -3$ ✓.'],
        },
      ],
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          hints: ['$\\begin{bmatrix}3&1\\\\2&4\\end{bmatrix} \\cdot \\frac{1}{10}\\begin{bmatrix}4&-1\\\\-2&3\\end{bmatrix} = \\frac{1}{10}\\begin{bmatrix}12-2&-3+3\\\\8-8&-2+12\\end{bmatrix} = \\frac{1}{10}\\begin{bmatrix}10&0\\\\0&10\\end{bmatrix} = I$ ✓'],
        },
      ],
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          hints: ['A(2) = [[2,1],[1,2]], b = [3,2]. Check: 2(4/3)+1(1/3) = 8/3+1/3 = 3 ✓. 1(4/3)+2(1/3) = 4/3+2/3 = 6/3 = 2 ✓.'],
        },
      ],
  ...
  challenges: [
    ...
    },
    {
      ...
      answer: '$\\text{adj}(A) = \\begin{bmatrix}4&1\\\\-3&2\\end{bmatrix}$; $A \\cdot \\text{adj}(A) = 11I$ ✓',
    },
    {
      id: 'la2-008-ch3',
      difficulty: 'hard',
