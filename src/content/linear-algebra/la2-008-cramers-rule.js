  ...
  intuition: {
    ...
    callouts: [
      ...
      },
      {
        ...
        body: "For an $n \\times n$ system, Cramer's Rule requires computing $n+1$ determinants of size $n \\times n$. Each $n \\times n$ determinant via cofactor expansion costs $O(n \\cdot n!)$ operations — combinatorially explosive. Gaussian elimination costs $O(n^3)$. For $n = 20$: Cramer â‰ˆ $10^{20}$ ops; Gaussian â‰ˆ $10^4$ ops. This is not a small difference.",
      },
      {
        type: 'definition',
...
plt.show()`,
            ...
            {
              id: 2,
              cellTitle: "Adjugate inverse formula — Aâ»¹ = adj(A) / det(A)",
              prose: [
