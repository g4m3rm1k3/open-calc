export default {
  ...
  intuition: {
    ...
    callouts: [
      {
        type: 'sequencing',
        title: 'Lesson 4 of 6 — Vectors & Spaces',
        body: '**Previous:** Dot and Cross Products — angles and projections between vectors.\n**This lesson:** Systems of Linear Equations — Gaussian elimination, pivot variables, solution structure.\n**Next:** Lines and Planes — the geometric picture behind every linear constraint.',
      },
      {
        type: 'insight',
