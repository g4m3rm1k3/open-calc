...
`,
  ...
  quiz: [
    ...
    { id: 'q-la9-002-7', type: 'choice', text: 'For $\\kappa = 100$, CG requires roughly how many iterations to reduce error by $10^{-6}$?', options: ['About 5', 'About 35', 'About 100', 'About 1000'], answer: 'About 73', hints: ['Use $k \\approx \\frac{1}{2}\\sqrt{\\kappa}\\ln(2/\\varepsilon) = \\frac{1}{2}\\cdot 10 \\cdot 14.5 \\approx 73$.'], reviewSection: 'intuition' },
