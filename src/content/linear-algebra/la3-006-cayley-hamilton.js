...
plt.show()`,
            ...
            {
              id: 2,
              cellTitle: 'Computing Aâ»¹ via Cayley-Hamilton — no row reduction needed',
              prose: 'For 2×2: p(A) = 0 gives A² - t·A + d·I = 0. Multiply by Aâ»¹: A - t·I + d·Aâ»¹ = 0. So Aâ»¹ = (t·I - A)/d. This works whenever d = det(A) ≠ 0. Much simpler than Gauss-Jordan for analytic work.',
              code: `import numpy as np
import matplotlib.pyplot as plt
...
print((K@K@K + K).round(10))`,
  ...
  examples: [
    ...
    {
      id: 'ex-la3-006-2',
      title: 'Finding Aâ»¹ via Cayley-Hamilton',
      ...
      steps: [
        ...
        },
        {
          ...
          strategyTitle: 'Solve for Aâ»¹',
          checkpoint: 'Verify: A @ Aâ»¹ = I',
  ...
  checkpoints: [
    ...
    { id: 'cp-la3-006-5', label: 'Lab: Compute Aâ»¹ via Cayley-Hamilton formula', type: 'lab' },
