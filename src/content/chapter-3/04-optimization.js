  ...
  examples: [
    {
      ...
      problem: '\\text{You have 100 m of fence. Maximize the enclosed rectangular area.}',
      visualizationId: 'OptimizationViz',
      steps: [
        { expression: '\\text{Let } x, y \\text{ be the sides. Constraint: } 2x + 2y = 100 \\Rightarrow x + y = 50.', annotation: 'Draw a rectangle with sides x and y. Write the constraint from the fixed perimeter.' },
        { expression: 'A = xy \\text{ (objective)}', annotation: 'The area is the objective function.' },
        { expression: 'y = 50 - x \\Rightarrow A(x) = x(50-x) = 50x - x^2', annotation: 'Substitute the constraint to eliminate y.' },
        { expression: 'A\'(x) = 50 - 2x = 0 \\Rightarrow x = 25', annotation: 'Differentiate and set equal to zero.' },
        { expression: 'A\'\'(x) = -2 < 0 \\Rightarrow \\text{local (global) maximum at } x = 25', annotation: 'Second derivative confirms maximum.' },
        { expression: 'y = 50 - 25 = 25, \\quad A = 25 \\times 25 = 625 \\text{ m}^2', annotation: 'Both sides are 25 m — a square. Maximum area is 625 m².' },
      ],
      conclusion: 'A 25m × 25m square encloses the maximum area of 625 m². The calculus confirms the geometric/algebraic insight: the square is uniquely optimal. Any deviation from equal sides (e.g., 20 × 30) gives A = 600 < 625.',
    },
    {
      id: 'ch3-004-ex2',
      title: 'Open Box from a Sheet of Cardboard',
      problem: '\\text{A 12×8 inch cardboard. Cut square corners of size } x \\text{ and fold. Maximize volume.}',
      steps: [
        { expression: 'V(x) = (12-2x)(8-2x)x', annotation: 'After cutting corners x × x, the box has dimensions (12-2x) × (8-2x) × x. Domain: x ∈ (0, 4) (need 8-2x > 0).' },
        { expression: 'V(x) = x(96 - 24x - 16x + 4x^2) = x(96 - 40x + 4x^2) = 4x^3 - 40x^2 + 96x', annotation: 'Expand the product.' },
        { expression: "V'(x) = 12x^2 - 80x + 96 = 4(3x^2 - 20x + 24)", annotation: 'Differentiate.' },
        { expression: "3x^2 - 20x + 24 = 0 \\Rightarrow x = \\frac{20 \\pm \\sqrt{400 - 288}}{6} = \\frac{20 \\pm \\sqrt{112}}{6} = \\frac{20 \\pm 4\\sqrt{7}}{6} = \\frac{10 \\pm 2\\sqrt{7}}{3}", annotation: 'Quadratic formula.' },
        { expression: 'x = \\frac{10 - 2\\sqrt{7}}{3} \\approx \\frac{10 - 5.292}{3} \\approx \\frac{4.708}{3} \\approx 1.570', annotation: 'The physically valid solution: x ≈ 1.570 in (the other root ≈ 5.097 is outside the domain (0,4)).' },
        { expression: 'V(1.570) = (12 - 3.140)(8 - 3.140)(1.570) \\approx (8.860)(4.860)(1.570) \\approx 67.6 \\text{ in}^3', annotation: 'Maximum volume is approximately 67.6 cubic inches.' },
        { expression: "V''(x) = 24x - 80 < 0 \\text{ at } x \\approx 1.570", annotation: 'V\'\'(1.570) ≈ 24(1.570) - 80 = 37.68 - 80 = -42.32 < 0. Maximum confirmed.' },
      ],
      conclusion: 'Cutting squares of approximately 1.57 inches from each corner maximizes the box volume at about 67.6 in³. The exact optimal cut is x = (10 - 2√7)/3 inches. Cutting too little wastes height; cutting too much shrinks the base.',
    },
    {
      id: 'ch3-004-ex3',
      title: 'Minimum Surface Area Tin Can',
      problem: '\\text{Find the cylinder of volume } 500 \\text{ cm}^3 \\text{ that uses the minimum surface area.}',
      steps: [
        { expression: 'V = \\pi r^2 h = 500 \\Rightarrow h = \\frac{500}{\\pi r^2}', annotation: 'Volume constraint: solve for h.' },
        { expression: 'SA = 2\\pi r^2 + 2\\pi r h = 2\\pi r^2 + 2\\pi r \\cdot \\frac{500}{\\pi r^2} = 2\\pi r^2 + \\frac{1000}{r}', annotation: 'Surface area = two circles (top/bottom) + lateral area. Substitute h = 500/(πr²).' },
        { expression: "SA'(r) = 4\\pi r - \\frac{1000}{r^2} = 0", annotation: 'Differentiate and set equal to zero.' },
        { expression: '4\\pi r = \\frac{1000}{r^2} \\Rightarrow r^3 = \\frac{1000}{4\\pi} = \\frac{250}{\\pi}', annotation: 'Solve for r³.' },
        { expression: 'r = \\left(\\frac{250}{\\pi}\\right)^{1/3} \\approx 4.30 \\text{ cm}', annotation: 'Optimal radius.' },
        { expression: 'h = \\frac{500}{\\pi r^2} = \\frac{500}{\\pi(250/\\pi)^{2/3}} = 2\\left(\\frac{250}{\\pi}\\right)^{1/3} = 2r', annotation: 'The optimal height equals the diameter (h = 2r). This is a remarkable result — the optimal can is as tall as it is wide.' },
        { expression: 'SA_{\\min} = 2\\pi r^2 + \\frac{1000}{r} \\approx 2\\pi(18.5) + \\frac{1000}{4.30} \\approx 116.2 + 232.6 \\approx 348.7 \\text{ cm}^2', annotation: 'Minimum surface area: ≈349 cm².' },
      ],
      conclusion: 'The optimal 500 cm³ can has height = diameter ≈ 8.6 cm, using ≈349 cm² of material. Real soup cans are often taller than their diameter because of manufacturing constraints (top/bottom lids cost more per unit area than the side). The mathematical optimum is a cube-like short cylinder.',
    },
    {
      id: 'ch3-004-ex4',
      title: 'Nearest Point on a Parabola',
      problem: '\\text{Find the point on } y = x^2 \\text{ nearest to } (0, 3).',
      steps: [
        { expression: 'D^2 = x^2 + (x^2 - 3)^2', annotation: 'Distance squared from (x, x²) to (0,3). We minimize D² (equivalent to minimizing D, and easier).' },
        { expression: 'D^2 = x^2 + x^4 - 6x^2 + 9 = x^4 - 5x^2 + 9', annotation: 'Expand (x² - 3)² = x⁴ - 6x² + 9, then combine x² terms.' },
        { expression: '\\frac{d(D^2)}{dx} = 4x^3 - 10x = 2x(2x^2 - 5) = 0', annotation: 'Differentiate and factor.' },
        { expression: 'x = 0 \\quad \\text{or} \\quad x = \\pm\\sqrt{5/2} = \\pm\\frac{\\sqrt{10}}{2}', annotation: 'Three critical points. The solutions ±√(5/2) are the meaningful candidates.' },
        { expression: 'D^2(0) = 9, \\quad D^2(\\pm\\sqrt{5/2}) = (5/2)^2 - 5(5/2) + 9 = 25/4 - 25/2 + 9 = 25/4 - 50/4 + 36/4 = 11/4', annotation: 'Evaluate D² at each critical point. D²(0) = 9 (point (0,0), distance 3). D²(±√(5/2)) = 11/4 (smaller!).' },
        { expression: 'D_{\\min} = \\sqrt{11/4} = \\frac{\\sqrt{11}}{2} \\approx 1.658', annotation: 'Minimum distance.' },
        { expression: 'x = \\pm\\sqrt{5/2}, \\quad y = x^2 = 5/2', annotation: 'Nearest points: (±√(5/2), 5/2) ≈ (±1.581, 2.5).' },
      ],
      conclusion: 'The nearest points to (0,3) on y = x² are (±√(10)/2, 5/2), at distance √11/2 ≈ 1.66. The point (0,0) on the parabola is actually farther from (0,3) than the two optimal points — the parabola curves away from the y-axis faster than the straight-line distance decreases.',
    },
    {
      id: 'ch3-004-ex5',
      title: "Snell's Law from Fermat's Principle",
      problem: "\\text{A lifeguard at } (0, 3) \\text{ runs at 8 m/s and swims at 2 m/s. Swimmer is at } (4, -2). \\text{ Find the optimal crossing point on the beach (x-axis).}",
      steps: [
        { expression: 'T(x) = \\frac{\\sqrt{x^2 + 9}}{8} + \\frac{\\sqrt{(4-x)^2 + 4}}{2}', annotation: 'Total time = (running distance)/8 + (swimming distance)/2. Running along the beach to point (x,0), then swimming to (4,-2).' },
        { expression: "T'(x) = \\frac{x}{8\\sqrt{x^2+9}} - \\frac{4-x}{2\\sqrt{(4-x)^2+4}} = 0", annotation: 'Differentiate and set equal to zero.' },
        { expression: '\\frac{x}{8\\sqrt{x^2+9}} = \\frac{4-x}{2\\sqrt{(4-x)^2+4}}', annotation: 'Rearrange.' },
        { expression: '\\frac{\\sin(\\theta_1)}{v_1} = \\frac{\\sin(\\theta_2)}{v_2}', annotation: 'If θ₁ is the angle the running path makes with the normal to the beach and θ₂ is the angle the swimming path makes: sin(θ₁) = x/√(x²+9) and sin(θ₂) = (4-x)/√((4-x)²+4). The condition T\'= 0 becomes sin(θ₁)/8 = sin(θ₂)/2. This is Snell\'s Law of refraction: sin(θ₁)/v₁ = sin(θ₂)/v₂.' },
        { expression: '\\text{Solve numerically: } x \\approx 0.5 \\text{ m}', annotation: 'The optimal crossing point is about 0.5 m along the beach. The lifeguard runs mostly to the water\'s edge quickly, then swims at an angle to the swimmer.' },
      ],
      conclusion: "Fermat's Principle (light takes the path of minimum time) and Snell's Law of optics are the same calculation: minimizing total travel time across two media. The lifeguard problem is physically identical to a light ray crossing from air to water. Calculus unifies optics, swimming, and running under the same optimization principle.",
    },
    {
      id: 'ch3-004-ex6',
      title: 'Economic Order Quantity',
      problem: '\\text{A store sells 1200 units/year. Each order costs \\$50. Storage costs \\$2/unit/year. Find optimal order quantity.}',
      steps: [
        { expression: '\\text{Number of orders per year} = 1200/Q', annotation: 'If Q units are ordered each time, the number of orders per year is 1200/Q.' },
        { expression: '\\text{Average inventory} = Q/2', annotation: 'Inventory decreases linearly from Q to 0 between orders, so average is Q/2.' },
        { expression: 'C(Q) = 50 \\cdot \\frac{1200}{Q} + 2 \\cdot \\frac{Q}{2} = \\frac{60000}{Q} + Q', annotation: 'Total annual cost = order costs + storage costs.' },
        { expression: "C'(Q) = -\\frac{60000}{Q^2} + 1 = 0 \\Rightarrow Q^2 = 60000 \\Rightarrow Q = \\sqrt{60000} \\approx 245 \\text{ units}", annotation: 'Set C\'= 0 and solve.' },
        { expression: "C''(Q) = \\frac{120000}{Q^3} > 0 \\Rightarrow \\text{minimum}", annotation: 'C\'\' > 0 confirms this is a minimum.' },
        { expression: 'C(245) = \\frac{60000}{245} + 245 \\approx 244.9 + 244.9 \\approx \\$489.9/\\text{year}', annotation: 'Minimum cost. Note: at the optimum, ordering cost = storage cost (both ≈ $245). This is always true for the EOQ model: C is minimized when the two costs are equal.' },
      ],
      conclusion: 'The optimal order quantity is Q* = √(60000) ≈ 245 units, ordered about 5 times per year. The minimum annual cost is about $490. The general formula Q* = √(2DS/H) (where D = annual demand, S = setup cost, H = holding cost per unit per year) is the famous Economic Order Quantity formula, used in supply chain management worldwide.',
    },
    {
      id: 'ch3-004-ex7',
      title: 'Maximize the Area of a Norman Window',
      problem: '\\text{A Norman window (rectangle with semicircle on top) has perimeter 10 m. Maximize the area.}',
      steps: [
        { expression: '\\text{Let } r = \\text{radius of semicircle}, h = \\text{height of rectangle.}', annotation: 'The window width = 2r. The rectangle has width 2r and height h. The semicircle has radius r.' },
        { expression: '\\text{Perimeter} = 2h + 2r + \\pi r = 10', annotation: 'Perimeter consists of: two vertical sides (height h each), the bottom edge (2r), and the semicircle (πr). Note: no top side — the semicircle replaces it.' },
        { expression: 'h = \\frac{10 - 2r - \\pi r}{2} = 5 - r - \\frac{\\pi r}{2}', annotation: 'Solve for h.' },
        { expression: 'A = 2rh + \\frac{\\pi r^2}{2}', annotation: 'Area = rectangle (2r × h) + semicircle (πr²/2).' },
        { expression: 'A(r) = 2r\\left(5 - r - \\frac{\\pi r}{2}\\right) + \\frac{\\pi r^2}{2} = 10r - 2r^2 - \\pi r^2 + \\frac{\\pi r^2}{2}', annotation: 'Substitute h.' },
        { expression: 'A(r) = 10r - 2r^2 - \\frac{\\pi r^2}{2}', annotation: 'Simplify: -πr² + πr²/2 = -πr²/2.' },
        { expression: "A'(r) = 10 - 4r - \\pi r = 10 - r(4 + \\pi) = 0", annotation: 'Differentiate and set equal to zero.' },
        { expression: 'r = \\frac{10}{4 + \\pi} \\approx \\frac{10}{7.14} \\approx 1.40 \\text{ m}', annotation: 'Optimal radius.' },
        { expression: 'h = 5 - r - \\pi r/2 = 5 - r(1 + \\pi/2) \\approx 5 - 1.40(2.571) \\approx 5 - 3.60 \\approx 1.40 \\text{ m}', annotation: 'Optimal height ≈ 1.40 m. Notice h ≈ r at the optimum.' },
      ],
  ...
  challenges: [
    {
      ...
      walkthrough: [
        ...
        { expression: 'A_{\\max} = (P/4)^2 = P^2/16', annotation: 'Maximum area is P²/16.' },
        { expression: '\\text{Part (2): Fix area } xy = A, \\text{ minimize perimeter } P = 2x + 2y.', annotation: 'New objective: minimize P.' },
        { expression: 'y = A/x, \\; P(x) = 2x + 2A/x, \\; P\'= 2 - 2A/x^2 = 0 \\Rightarrow x^2 = A \\Rightarrow x = \\sqrt{A}', annotation: 'Differentiate P and set to zero.' },
        { expression: 'x = \\sqrt{A}, \\; y = A/x = \\sqrt{A} \\Rightarrow x = y \\text{ (square)}', annotation: 'Optimal shape is again a square.' },
        { expression: 'P\'\'= 4A/x^3 > 0 \\Rightarrow \\text{minimum}', annotation: 'P\'\' > 0 confirms minimum perimeter.' },
        { expression: 'P_{\\min} = 4\\sqrt{A}', annotation: 'Minimum perimeter is 4√A.' },
      ],
      answer: 'In both directions — fixed perimeter maximizes area as a square, fixed area minimizes perimeter as a square. These are dual optimization problems with the same geometric answer. The isoperimetric inequality (circle maximizes area for fixed perimeter among all shapes, not just rectangles) generalizes this result.',
    },
    {
      id: 'ch3-004-ch2',
      difficulty: 'hard',
      ...
      walkthrough: [
        ...
        { expression: "V'(h) = 2\\pi(R^2 - h^2) + 2\\pi h(-2h) = 2\\pi(R^2 - 3h^2) = 0", annotation: 'Differentiate V with respect to h.' },
        { expression: 'R^2 - 3h^2 = 0 \\Rightarrow h = \\frac{R}{\\sqrt{3}}', annotation: 'Solve: optimal half-height.' },
        { expression: 'r^2 = R^2 - h^2 = R^2 - R^2/3 = \\frac{2R^2}{3} \\Rightarrow r = R\\sqrt{\\frac{2}{3}}', annotation: 'Optimal radius.' },
        { expression: 'V_{\\max} = 2\\pi \\cdot \\frac{R}{\\sqrt{3}} \\cdot \\frac{2R^2}{3} = \\frac{4\\pi R^3}{3\\sqrt{3}} = \\frac{4\\pi R^3\\sqrt{3}}{9}', annotation: 'Maximum volume.' },
        { expression: '\\frac{V_{\\max}}{V_{\\text{sphere}}} = \\frac{4\\pi R^3/(3\\sqrt{3})}{(4/3)\\pi R^3} = \\frac{1}{\\sqrt{3}} \\approx 0.577', annotation: 'The optimal cylinder is about 57.7% of the sphere\'s volume.' },
      ],
      answer: 'Optimal inscribed cylinder: r = R√(2/3), full height = 2h = 2R/√3 = 2R√3/3. Maximum volume = 4πR³/(3√3). The cylinder uses about 57.7% of the sphere volume.',
    },
    {
      id: 'ch3-004-ch3',
      difficulty: 'medium',
      ...
      walkthrough: [
        ...
        { expression: 'h = 5 - r^* - \\frac{\\pi r^*}{2} = 5 - r^*\\left(1 + \\frac{\\pi}{2}\\right) = 5 - r^* \\cdot \\frac{2+\\pi}{2}', annotation: 'Substitute r* into the expression for h.' },
        { expression: '5 = r^*(4+\\pi)/2 \\text{ (from } r^* = 10/(4+\\pi)\\text{)}', annotation: 'Note that from A\'= 0: 10 = r*(4+π), so 5 = r*(4+π)/2.' },
        { expression: 'h = r^* \\cdot \\frac{4+\\pi}{2} - r^* \\cdot \\frac{2+\\pi}{2} = r^* \\cdot \\frac{(4+\\pi)-(2+\\pi)}{2} = r^* \\cdot \\frac{2}{2} = r^*', annotation: 'Subtract to find h = r*. The optimal Norman window always has rectangle height equal to semicircle radius, regardless of the total perimeter.' },
      ],
      answer: 'At the optimum, h = r* = 10/(4+π). This result (h = r) is independent of the perimeter length — it is a universal property of the optimal Norman window shape.',
    },
  ],

  crossRefs: [
    { lessonSlug: 'curve-sketching', label: 'Curve Sketching', context: 'Optimization uses exactly the same tools as curve sketching: critical points, first/second derivative tests. The difference is that optimization focuses on the global optimum, not just local behavior.' },
    { lessonSlug: 'related-rates', label: 'Related Rates', context: 'Both optimization and related rates require setting up geometric equations. The modeling skills transfer directly.' },
    { lessonSlug: 'mean-value-theorem', label: 'Mean Value Theorem', context: 'Fermat\'s theorem (critical points) and the EVT are both consequences of the MVT framework. The proof that differentiable optima have f\'= 0 uses the limit definition directly.' },
  ],
