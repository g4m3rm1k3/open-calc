  ...
  examples: [
    {
      ...
      steps: [
        { expression: '\\frac{f(3)-f(1)}{3-1} = \\frac{9-1}{2} = 4', annotation: 'Compute the average rate of change (slope of the secant from (1,1) to (3,9)).', hints: ['Find the slope between the endpoints.'], strategyTitle: "Compute the average rate of change: [f(b)−f(a)]/(b−a) = slope of secant line", checkpoint: "This fraction is the slope of the line through (a, f(a)) and (b, f(b)). Does it match the slope you would compute from a graph?", hints: ["Level 1: Substitute the endpoint values into f(b)−f(a) and divide by b−a. This is the same formula as average rate of change from Chapter 1.", "Level 2: Geometrically, this is the slope of the secant line from (a, f(a)) to (b, f(b)). The MVT says some tangent line in (a,b) has this same slope.", "Level 3: Connect to Chapter 1: average rate of change = (Δy)/(Δx). MVT says instantaneous rate = average rate at some point c. This is why cops say: 'If your average speed exceeded 60 mph, you must have been going 60 mph at some exact moment.'"] },
        { expression: "f'(x) = 2x", annotation: 'Compute the derivative.', hints: ['Power rule for x².'] },
        { expression: "f'(c) = 4 \\Rightarrow 2c = 4 \\Rightarrow c = 2", annotation: 'Set f\'(c) equal to the average rate and solve. c = 2 ∈ (1, 3) ✓.', strategyTitle: "Find c: set f'(x) equal to the average rate and solve", checkpoint: "If f'(x) = k has multiple solutions, which ones count? Only those in the OPEN interval (a,b).", hints: ["Level 1: Set f'(x) = [average rate] and solve the equation. This may give one or more values of x.", "Level 2: Filter: keep only solutions c where a < c < b (strictly inside). The theorem guarantees at least one such c exists.", "Level 3: For a polynomial of degree n on any interval, f'(x) = constant has at most n−1 solutions. At least one must fall in (a,b) — the MVT guarantees this."] },
    ...
    },
    {
      ...
      steps: [
        { expression: '\\frac{f(1)-f(-1)}{1-(-1)} = \\frac{1-(-1)}{2} = \\frac{2}{2} = 1', annotation: 'Compute the average rate of change.', hints: ['f(1) = 1, f(-1) = -1.'], strategyTitle: "Compute the average rate of change: [f(b)−f(a)]/(b−a) = slope of secant line", checkpoint: "This fraction is the slope of the line through (a, f(a)) and (b, f(b)). Does it match the slope you would compute from a graph?", hints: ["Level 1: Substitute the endpoint values into f(b)−f(a) and divide by b−a. This is the same formula as average rate of change from Chapter 1.", "Level 2: Geometrically, this is the slope of the secant line from (a, f(a)) to (b, f(b)). The MVT says some tangent line in (a,b) has this same slope.", "Level 3: Connect to Chapter 1: average rate of change = (Δy)/(Δx). MVT says instantaneous rate = average rate at some point c. This is why cops say: 'If your average speed exceeded 60 mph, you must have been going 60 mph at some exact moment.'"] },
        { expression: "f'(x) = 3x^2", annotation: 'Derivative of x³.', hints: ['Power rule.'] },
        { expression: "f'(c) = 1 \\Rightarrow 3c^2 = 1 \\Rightarrow c^2 = \\frac{1}{3} \\Rightarrow c = \\pm\\frac{1}{\\sqrt{3}} \\approx \\pm 0.577", annotation: 'Solve for c. Two solutions: c = ±1/√3.', strategyTitle: "Find c: set f'(x) equal to the average rate and solve", checkpoint: "If f'(x) = k has multiple solutions, which ones count? Only those in the OPEN interval (a,b).", hints: ["Level 1: Set f'(x) = [average rate] and solve the equation. This may give one or more values of x.", "Level 2: Filter: keep only solutions c where a < c < b (strictly inside). The theorem guarantees at least one such c exists.", "Level 3: For a polynomial of degree n on any interval, f'(x) = constant has at most n−1 solutions. At least one must fall in (a,b) — the MVT guarantees this."] },
    ...
    },
    {
      ...
      steps: [
        { expression: 'f(t) = \\sin(t), \\quad f\'(t) = \\cos(t)', annotation: 'Apply the MVT to f(t) = sin(t) on the interval between x and y (WLOG x < y).', hints: ['Let the endpoints be the two arbitrary numbers x and y.'], strategyTitle: "Compute the average rate of change: [f(b)−f(a)]/(b−a) = slope of secant line", checkpoint: "This fraction is the slope of the line through (a, f(a)) and (b, f(b)). Does it match the slope you would compute from a graph?", hints: ["Level 1: Substitute the endpoint values into f(b)−f(a) and divide by b−a. This is the same formula as average rate of change from Chapter 1.", "Level 2: Geometrically, this is the slope of the secant line from (a, f(a)) to (b, f(b)). The MVT says some tangent line in (a,b) has this same slope.", "Level 3: Connect to Chapter 1: average rate of change = (Δy)/(Δx). MVT says instantaneous rate = average rate at some point c. This is why cops say: 'If your average speed exceeded 60 mph, you must have been going 60 mph at some exact moment.'"] },
        { expression: '\\sin(x) - \\sin(y) = \\cos(c)(x - y) \\text{ for some } c \\in (y, x)', annotation: 'By the MVT: f(x) - f(y) = f\'(c)(x-y).', hints: ['Substitute sin and cos into the MVT formula.'], strategyTitle: "Find c: set f'(x) equal to the average rate and solve", checkpoint: "If f'(x) = k has multiple solutions, which ones count? Only those in the OPEN interval (a,b).", hints: ["Level 1: Set f'(x) = [average rate] and solve the equation. This may give one or more values of x.", "Level 2: Filter: keep only solutions c where a < c < b (strictly inside). The theorem guarantees at least one such c exists.", "Level 3: For a polynomial of degree n on any interval, f'(x) = constant has at most n−1 solutions. At least one must fall in (a,b) — the MVT guarantees this."] },
