const lesson = {
  ...
  aliases: ["git blame", "git bisect", "git log grep", "find bug", "search commits"],
    ...
    questions: [
      {
        ...
        answer: "Shows commits where the string 'calculateTax' was added or removed from file contents",
      },
      {
        id: "git0-018-q2",
        type: "choice",
