const lesson = {
  ...
  tags: ["git", "workflow", "gitflow", "trunk-based", "github-flow", "branching strategy"],
  aliases: ["git workflow", "branching strategy", "gitflow", "trunk based development", "github flow"],
  ...
  assessment: {
    questions: [
      ...
      },
      {
        ...
        answer: "An integration branch where features accumulate before a release",
      },
      {
        id: "git0-020-q3",
        type: "choice",
