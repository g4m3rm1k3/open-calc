...
const LESSON_GEO_1_5 = {
  ...
  subtitle: 'Why every triangle on a flat plane adds up to exactly 180° — and what happens when it doesn\'t.',
  sequential: true,
...
The 180° angle sum is an extraordinarily good approximation for everyday engineering and construction, where surfaces are nearly flat and distances are small. But it is a local approximation, not a universal truth — and knowing that distinction is what separates a mathematician from someone who has merely memorized a formula.`,
...

    {
      ...
      options: [
        { label: 'A', text: 'The parallel line makes the diagram look more symmetric, which makes the proof easier to follow.' },
        { label: 'B', text: 'Without the parallel line there is no straight angle to anchor the three angles to 180°, and no transversal relationships to transport ∠A and ∠B to vertex C. The parallel line simultaneously creates the 180° container and the angle-transfer mechanism.' },
        { label: 'C', text: 'The parallel line is required by Euclid\'s Postulate I, which says a line must pass through every point.' },
        { label: 'D', text: 'The parallel line replaces side AB so the proof can use the straight angle at C.' },
      ],
      check: (label) => label === 'B',
      successMessage: 'Correct. The auxiliary parallel line does two things: (1) it creates a straight angle at C, giving a container of exactly 180°, and (2) it creates transversal relationships with sides AC and BC, allowing the Alternate Interior Angles Theorem to transport ∠A and ∠B to vertex C. Without the line, we have three angles trapped in a triangle with no straight-angle reference and no way to compare them across vertices.',
...

    {
      ...
      options: [
        { label: 'A', text: 'Remote angles: 71° and 63°. Interior angle at the vertex: 46°.' },
        { label: 'B', text: 'Remote angles: 71° and 63°. Interior angle at the vertex: 46°. Verify: 71 + 63 + 46 = 180° ✓' },
        { label: 'C', text: 'Remote angles: 71° and 67°. Interior angle at the vertex: 42°.' },
        { label: 'D', text: 'Remote angles: 71° and 109°. Interior angle at the vertex: 0°.' },
      ],
      check: (label) => label === 'B',
      successMessage: 'Correct. Exterior Angle Theorem: exterior angle = sum of two remote interior angles. So 134° = 71° + x, giving x = 63°. The interior angle at the vertex where the exterior angle is drawn forms a linear pair with it: 180° − 134° = 46°. Verify with the angle sum: 71° + 63° + 46° = 180° ✓.',
      failMessage: 'Two steps. First: Exterior Angle Theorem gives the second remote angle: 134° = 71° + x, so x = 63°. Second: the interior angle at the vertex where the exterior angle is drawn forms a linear pair with it: 180° − 134° = 46°. Verify: 71° + 63° + 46° = 180° ✓.',
      html: '', css: 'body{margin:0;padding:0;font-family:Georgia,serif}', startCode: '', outputHeight: 270,
    },
  ],
};
...
export default {
  ...
  title: 'The Triangle Angle Sum',
  subtitle: 'Why every triangle on a flat plane adds up to exactly 180° — and what happens when it doesn\'t.',
  tags: ['geometry', 'triangle-angle-sum', 'parallel-lines', 'exterior-angle', 'corollaries', 'non-euclidean'],
  hook: {
    question: 'Why does every triangle sum to exactly 180 degrees — and is it always true?',
    realWorldContext: 'The proof uses one auxiliary parallel line and two applications of the Alternate Interior Angles Theorem. The 180° result holds only in flat Euclidean geometry — on a sphere or in curved spacetime, triangle angles sum to different values.',
