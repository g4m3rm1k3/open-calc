...
const LESSON_GEO_1_7 = {
  ...
  subtitle: 'Why the most famous theorem in mathematics has been proved over 370 times — and what each approach reveals.',
  sequential: true,
...
Learning three proofs of one theorem gives you three proof tools for free.`,
...

    {
      ...
      options: [
        { label: 'A', text: 'c = 13. Pythagorean triple: (5, 12, 13) since 25 + 144 = 169 = 13².' },
        { label: 'B', text: 'c = 17. Pythagorean triple: (5, 12, 17) since 5 + 12 = 17.' },
        { label: 'C', text: 'c = √169 = 13. The triple is (5, 12, 13). Note: not all triples are multiples of (3,4,5).' },
        { label: 'D', text: 'c = √119 ≈ 10.9. There is no integer hypotenuse.' },
      ],
      check: (label) => label === 'A',
      successMessage: 'Correct. c² = 5² + 12² = 25 + 144 = 169 = 13². So c = 13 exactly. (5, 12, 13) is a Pythagorean triple — three positive integers satisfying a² + b² = c². The most famous is (3, 4, 5). Others include (8, 15, 17) and (7, 24, 25). Any multiple of a triple is also a triple: (6, 8, 10), (9, 12, 15), etc.',
      failMessage: 'Apply the Pythagorean Theorem: c² = a² + b² = 5² + 12² = 25 + 144 = 169. Then c = √169 = 13 exactly. (5, 12, 13) is a Pythagorean triple — a set of positive integers satisfying a² + b² = c². You can verify: 25 + 144 = 169 ✓.',
...

    {
      ...
      options: [
        { label: 'A', text: 'Both triangles have a right angle at D and C respectively, and they share angle A. Two pairs of equal angles are sufficient to prove similarity (AA).' },
        { label: 'B', text: 'Both triangles have the same perimeter.' },
        { label: 'C', text: 'Both triangles have equal hypotenuses.' },
        { label: 'D', text: 'The altitude bisects the right angle at C, creating equal angles in both triangles.' },
      ],
      check: (label) => label === 'A',
      successMessage: 'Correct. △ACD has: ∠ADC = 90° (altitude is perpendicular to hypotenuse) and ∠A is shared with △ABC. By AA similarity (two pairs of equal angles), △ACD ~ △ABC. This is why similarity can be established without measuring sides — two angles determine the shape of a triangle completely (since the third angle is forced by the 180° sum).',
      failMessage: 'The key is AA similarity: two pairs of equal angles are sufficient to prove triangles similar. △ACD shares ∠A with △ABC, and ∠ADC = 90° = ∠ACB. So two angles match, and by the Triangle Angle Sum, the third must also match. Equal perimeters and equal hypotenuses are not criteria for similarity.',
      html: '', css: 'body{margin:0;padding:0;font-family:Georgia,serif}', startCode: '', outputHeight: 270,
    },
  ],
};
...
export default {
  ...
  title: 'The Pythagorean Theorem: Three Proofs',
  subtitle: 'Why the most famous theorem in mathematics has been proved over 370 times — and what each approach reveals.',
  tags: ['geometry', 'pythagoras', 'pythagorean-theorem', 'similar-triangles', 'area', 'distance-formula', 'proofs'],
  hook: {
    question: 'Why would you prove the same theorem three different ways?',
    realWorldContext: 'Each proof of the Pythagorean Theorem reveals a different mathematical structure: area conservation (Proof 1), self-similar ratios (Proof 2), and the nature of distance in coordinate space (Proof 3). The theorem is the same; the understanding is three times deeper.',
