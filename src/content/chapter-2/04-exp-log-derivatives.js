...
export default {
  ...
  examples: [
    ...
    },
    {
      ...
      conclusion: 'f\'(x) = 2x/(x\u00b2+1). The chain rule result for ln(g(x)) is always g\'(x)/g(x) — this is sometimes called the "logarithmic derivative."',
    },
    {
      id: 'ch2-004-ex4',
    ...
    },
    {
      ...
      steps: [
        {
          expression: "f(x) = 5^{2x} = (5^2)^x? \\quad \\text{No — use chain rule.}",
      ...
      walkthrough: [
        {
          ...
          annotation: 'Set y equal to the expression. This has products and powers — perfect for logarithmic differentiation.',
        },
        {
  ...
  quiz: [
    {
      ...
      options: ['$x \\cdot e^{x-1}$', '$e^x \\cdot \\ln(e)$', '$e^x$', '$1/e^x$'],
      answer: '$e^x$',
    ...
    },
    {
      ...
      answer: '3*e^(3*x)',
      hints: ['Outside: $e^u$; inside: $3x$. Multiply by the inner derivative 3.'],
    ...
    },
    {
      ...
      answer: '1/x',
      hints: ['This is the standard result: $\\dfrac{d}{dx}[\\ln x] = \\dfrac{1}{x}$ for $x > 0$.'],
    ...
    },
    {
      ...
      answer: '2*x / (x^2+1)',
      hints: ['Outside: $\\ln(u)$; inside: $x^2+1$. Derivative: $\\dfrac{1}{x^2+1} \\cdot 2x$.'],
    ...
    },
    {
      ...
      answer: '2^x * log(2)',
      hints: ['General exponential rule: $\\dfrac{d}{dx}[a^x] = a^x \\ln(a)$. Here $a = 2$.'],
    ...
    },
    {
      ...
      answer: 'cos(x)/sin(x)',
      hints: ['Outside: $\\ln(u)$; inside: $\\sin(x)$. Derivative: $\\dfrac{1}{\\sin x} \\cdot \\cos x = \\cot x$.'],
    ...
    },
    {
      ...
      hints: ['Use the change-of-base identity $\\log_a(x) = \\ln(x)/\\ln(a)$, then differentiate.'],
    ...
    },
    {
      ...
      hints: ['Outside: $e^u$; inside: $\\sin(x)$. Derivative: $e^{\\sin x} \\cdot \\cos x$.'],
      reviewSection: 'Math tab — chain rule with exponential and trig composition',
    },
  ],
};
