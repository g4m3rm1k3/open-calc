...
export default {
  ...
  subtitle: 'The function that equals its own derivative G�� and the logarithm that unlocks it',
  ...
  examples: [
    ...
    },
    {
      ...
      conclusion: 'f\'(x) = 2x/(x\u00b2+1). The chain rule result for ln(g(x)) is always g\'(x)/g(x) G�� this is sometimes called the "logarithmic derivative."',
    },
    {
      id: 'ch2-004-ex4',
    ...
    },
    {
      ...
      steps: [
        {
          expression: "f(x) = 5^{2x} = (5^2)^x? \\quad \\text{No G�� use chain rule.}",
      ...
      walkthrough: [
        {
          ...
          annotation: 'Set y equal to the expression. This has products and powers G�� perfect for logarithmic differentiation.',
        },
        {
