  ...
  math: {
    ...
    visualizations: [
      ...
      },
      {
        ...
        props: { url: 'https://www.youtube.com/embed/SYeBT1xjTa8' },
      },
      {
        id: 'VideoEmbed',
        title: 'Sum & Difference Identities Proofs & Equation (3 Examples)',
        props: { url: 'https://www.youtube.com/embed/5IRh9_0pYlQ' },
      },
      {
        id: 'VideoEmbed',
        title: 'Deriving Trig Identities from Sin(A+B) and Cos(A+B)',
        props: { url: 'https://www.youtube.com/embed/Jwk5EAockMI' },
      },
      {
        id: 'VideoEmbed',
      ...
      },
      {
        ...
        props: { url: 'https://www.youtube.com/embed/9gQdkOasPZM' },
      },
      {
        id: 'VideoEmbed',
        title: 'Evaluating Trigonometry Expressions with Half and Double Angles Pt2',
        props: { url: 'https://www.youtube.com/embed/RCl4VGGQS-U' },
      },
      {
        id: 'VideoEmbed',
        title: 'Trigonometry Proofs Involving Half and Double Angles',
        props: { url: 'https://www.youtube.com/embed/aswSc7HZQ7c' },
      },
      {
        id: 'VideoEmbed',
        title: 'Product to Sum and Sum to Product Formulas',
        props: { url: 'https://www.youtube.com/embed/KRYoFdfhNXE' },
      },
      {
        id: 'VideoEmbed',
      ...
      },
      {
        ...
        props: { url: 'https://www.youtube.com/embed/TCdhf9iVkYc' },
      },
      {
        id: 'VideoEmbed',
        title: 'Verifying Trigonometric Identities Pt2',
        props: { url: 'https://www.youtube.com/embed/q8k-sS7qRts' },
      },
      {
        id: 'VideoEmbed',
        title: 'Verifying Trigonometric Identities Pt3',
        props: { url: 'https://www.youtube.com/embed/mAnw4ImaPK0' },
      },
      {
        id: 'VideoEmbed',
        title: 'Verifying Trigonometric Identities Involving Sum & Difference',
        props: { url: 'https://www.youtube.com/embed/OYfeClZiNEU' },
      },
    ],
  },
