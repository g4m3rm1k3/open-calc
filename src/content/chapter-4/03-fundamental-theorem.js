  ...
  quiz: [
    {
      ...
      options: ['\\(f(a)\\)', '\\(f(x)\\)', '\\(\\int_a^x f\'(t)\\,dt\\)', '\\(F(b) - F(a)\\)'],
      answer: '\\(f(x)\\)',
      hints: ['Differentiating an accumulation function recovers the integrand evaluated at the upper limit.'],
    ...
    },
    {
      ...
      answer: 'x^3',
      hints: ['Differentiate the accumulation function: the answer is the integrand with \\(t\\) replaced by \\(x\\).'],
      reviewSection: 'Math — FTC Part 1',
    },
    {
      id: 'ftc-q3',
    ...
    },
    {
      ...
      answer: '2*x*sin(x^2)',
      hints: ['Let \\(u = x^2\\). Then \\(\\frac{d}{dx}\\int_0^u \\sin(t)\\,dt = \\sin(u) \\cdot u\'\\).', '= \\(\\sin(x^2) \\cdot 2x\\).'],
    ...
    },
    {
      ...
      answer: '2/3',
      hints: ['\\(F(1) - F(-1) = \\frac{1}{3} - (-\\frac{1}{3}) = \\frac{2}{3}\\).'],
      reviewSection: 'Math — FTC Part 2',
    },
  ],
}
