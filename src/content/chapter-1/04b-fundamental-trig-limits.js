  ...
  quiz: [
    {
      ...
      answer: '1',
      hints: ['First pillar: this limit equals 1 (with $x$ in radians).'],
      reviewSection: 'Math tab — twin pillars',
    },
    {
      id: 'ftrl-q2',
      type: 'input',
      text: 'What is $\\lim_{x \\to 0} \\dfrac{1 - \\cos x}{x}$?',
      answer: '0',
      hints: ['Second pillar: this limit equals 0.'],
      reviewSection: 'Math tab — twin pillars',
    },
    {
      id: 'ftrl-q3',
      type: 'input',
      text: 'Evaluate $\\lim_{x \\to 0} \\dfrac{\\sin(7x)}{3x}$.',
      answer: '7/3',
      hints: [
        'Write $\\sin(7x)/(3x) = (7/3) \\cdot \\sin(7x)/(7x)$.',
        '$\\lim_{x\\to 0} \\sin(7x)/(7x) = 1$, so the answer is $7/3$.',
      ],
      reviewSection: 'Examples tab — Example 1: direct pattern scaling',
    },
    {
      id: 'ftrl-q4',
      type: 'input',
      text: 'Evaluate $\\lim_{x \\to 0} \\dfrac{1 - \\cos(5x)}{x}$.',
      answer: '0',
      hints: [
        'Write as $5 \\cdot \\dfrac{1-\\cos(5x)}{5x}$.',
        '$\\lim_{u \\to 0}(1-\\cos u)/u = 0$, so the product is $5 \\cdot 0 = 0$.',
      ],
      reviewSection: 'Examples tab — Example 2: second pillar usage',
    },
    {
      id: 'ftrl-q5',
      type: 'input',
      text: 'Evaluate $\\lim_{x \\to 0} \\dfrac{1 - \\cos(5x)}{x^2}$.',
      answer: '25/2',
      hints: [
        'Write as $25 \\cdot \\dfrac{1-\\cos(5x)}{(5x)^2}$.',
        '$\\lim_{u\\to 0}(1-\\cos u)/u^2 = 1/2$, so the answer is $25 \\cdot (1/2) = 25/2$.',
      ],
      reviewSection: 'Examples tab — Example 3: high-frequency standard result',
    },
    {
      id: 'ftrl-q6',
      type: 'choice',
      text: 'The limit $\\lim_{x \\to 0} \\sin(x)/x = 1$ holds only when $x$ is measured in:',
      options: ['Degrees', 'Gradians', 'Radians', 'Any unit — the result is the same'],
      answer: 'Radians',
      hints: ['In degrees, the limit equals $\\pi/180$, not 1.'],
      reviewSection: 'Intuition tab — radians-only warning',
    },
    {
      id: 'ftrl-q7',
      type: 'input',
      text: 'Evaluate $\\lim_{x \\to 0} \\dfrac{\\sin(9x)}{2x}$.',
      answer: '9/2',
      hints: [
        'Write as $(9/2) \\cdot \\sin(9x)/(9x)$.',
        '$\\lim_{x\\to 0} \\sin(9x)/(9x) = 1$.',
      ],
    ...
    },
    {
      id: 'ftrl-q8',
      type: 'input',
      text: 'Evaluate $\\lim_{x \\to 0} \\dfrac{1 - \\cos(3x)}{x^2}$.',
      answer: '9/2',
      hints: [
        'Write as $9 \\cdot \\dfrac{1-\\cos(3x)}{(3x)^2}$.',
        '$\\lim_{u\\to 0}(1-\\cos u)/u^2 = 1/2$, so the answer is $9 \\cdot (1/2)$.',
      ],
    ...
    },
    {
      id: 'ftrl-q9',
      type: 'input',
      text: 'What is $\\lim_{x \\to 0} \\dfrac{\\tan x}{x}$? (Use the fact that $\\tan x = \\sin x / \\cos x$.)',
      answer: '1',
      hints: [
        '$\\tan x / x = (\\sin x / x) \\cdot (1/\\cos x)$.',
        'As $x \\to 0$: $\\sin x / x \\to 1$ and $1/\\cos x \\to 1$.',
      ],
      reviewSection: 'Math tab — automatic third pillar',
    },
    {
      id: 'ftrl-q10',
      type: 'input',
      text: 'Evaluate $\\lim_{x \\to 0} \\dfrac{\\sin x - x}{x}$.',
      answer: '0',
      hints: [
        'Write as $\\dfrac{\\sin x}{x} - 1$.',
        '$\\lim_{x \\to 0}(\\sin x / x) = 1$, so $1 - 1 = 0$.',
      ],
      reviewSection: 'Challenges tab — Challenge 3',
    },
  ],
};
