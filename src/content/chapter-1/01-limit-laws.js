  ...
  examples: [
    {
      ...
      steps: [
        ...
        { expression: '= \\frac{3(2)^2 - (2) + 1}{(2)+5}', annotation: 'Substitute x = 2 in both numerator and denominator.' },
        { expression: '= \\frac{3 \\cdot 4 - 2 + 1}{7} = \\frac{12 - 2 + 1}{7} = \\frac{11}{7}', annotation: '' },
      ],
    ...
    },
    {
      ...
      steps: [
        { expression: '\\lim_{x \\to 0} \\cos\\!\\left(\\frac{\\sin x}{x}\\right)', annotation: 'This is a composition: cos applied to sin(x)/x.' },
        { expression: '\\text{Step 1: find the inner limit.}', annotation: '' },
        { expression: '\\lim_{x \\to 0} \\frac{\\sin x}{x} = 1', annotation: 'The fundamental trig limit.' },
        { expression: '\\text{Step 2: apply cos to the inner limit.}', annotation: 'Since cos is continuous everywhere, we can "pass the limit through" the outer function.' },
        { expression: '= \\cos(1)', annotation: '' },
        { expression: '\\approx 0.5403', annotation: 'Numerical value for reference.' },
      ],
