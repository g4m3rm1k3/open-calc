import oneSidedLimits from './00a-one-sided-limits.js'
...
import infiniteLimitsVerticalAsymptotes from './05a-infinite-limits-vertical-asymptotes.js'
...
export default {
  ...
  lessons: [
    ...
    limitsAtInfinity,
    infiniteLimitsVerticalAsymptotes,
    limitsAndContinuity,
    rateOfChange,
    functionModeling,
  ],
