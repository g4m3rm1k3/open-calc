    ...
    visualizations: [
      {
        ...
        mathBridge: 'Drag the second point toward the first. Watch the secant line rotate toward the tangent. The slope readout shows the average rate of change converging to the instantaneous rate.',
        caption: 'The derivative is what the difference quotient becomes when $h$ reaches zero.',
      },
    ],
  },
    ...
    proofSteps: [
      {
        ...
        annotation: 'Replace every $x$ with $(x+h)$. Do not expand yet — write it out first.',
      },
      {
        expression: '= x^2 + 2xh + h^2 + 3x + 3h',
        annotation: 'Expand $(x+h)^2 = x^2 + 2xh + h^2$ and distribute the $3$.',
      },
      {
        expression: 'f(x+h) - f(x) = (x^2 + 2xh + h^2 + 3x + 3h) - (x^2 + 3x)',
        annotation: 'Subtract the original function. The $x^2$ and $3x$ terms cancel — they must.',
      },
      {
        expression: '= 2xh + h^2 + 3h = h(2x + h + 3)',
        annotation: 'Collect and factor out $h$. Every remaining term has an $h$ — if not, check your expansion.',
      },
      {
        expression: '\\frac{f(x+h)-f(x)}{h} = \\frac{h(2x+h+3)}{h} = 2x + h + 3',
        annotation: 'Cancel $h$. Valid because $h \\neq 0$. This is the difference quotient.',
      },
      {
        expression: '\\lim_{h \\to 0}(2x+h+3) = 2x+3 = f\'(x) \\qquad \\blacksquare',
        annotation: 'Let $h \\to 0$. The derivative is $2x+3$ — which is what the power rule gives directly.',
      },
    ],
  },
  ...
  examples: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          annotation: 'Slope formula: rise over run. Units: $f$-units per $x$-unit.',
        },
      ],
      conclusion: 'The function increased by an average of 11 units per unit of $x$ over $[1,3]$. This is the slope of the secant line through $(1,-1)$ and $(3,21)$.',
    },
    {
      id: 'ch1-006-ex2',
      title: 'The difference quotient for a quadratic',
      problem: '\\text{Find and simplify the difference quotient for } f(x) = 3x^2 - x + 2.',
      steps: [
        {
        ...
        },
        {
          ...
          annotation: 'Subtract $f(x) = 3x^2 - x + 2$. The $3x^2$, $-x$, and $+2$ cancel.',
        },
        {
          expression: '\\frac{f(x+h)-f(x)}{h} = \\frac{h(6x+3h-1)}{h} = 6x + 3h - 1',
          annotation: 'Factor $h$ and cancel. As $h \\to 0$, this gives $f\'(x) = 6x - 1$.',
        },
      ],
      conclusion: 'The difference quotient simplifies to $6x + 3h - 1$. Setting $h=0$ gives the derivative $6x-1$, confirming the power rule result.',
    },
    {
      id: 'ch1-006-ex3',
      title: 'Vertical distance between two curves',
      problem: 'f(x) = x^2 + 2 \\text{ and } g(x) = x. \\text{ Find the vertical distance function and where it is maximised on } [0,2].',
      steps: [
        {
          expression: 'd(x) = f(x) - g(x) = x^2 - x + 2',
          annotation: 'Subtract the lower function. Check: at $x=0$, $f=2$, $g=0$, $d=2$. ✓',
        },
        {
          expression: "d'(x) = 2x - 1 = 0 \\Rightarrow x = \\tfrac{1}{2}",
          annotation: 'Find where the rate of change of distance is zero — the critical point.',
        },
        {
          expression: 'd(0)=2, \\; d(\\tfrac{1}{2})=\\tfrac{7}{4}, \\; d(2)=4 \\Rightarrow \\text{max at } x=2',
          annotation: 'Check endpoints and critical point. The maximum vertical distance on $[0,2]$ is 4, at $x=2$.',
        },
      ],
      conclusion: 'The vertical distance between two curves is a function with its own calculus. Finding its maximum and minimum is a standard optimisation problem.',
    },
  ],
  ...
  challenges: [
    {
      id: 'ch1-006-ch1',
      difficulty: 'medium',
      problem: '\\text{Find the difference quotient for } f(x) = \\frac{1}{x} \\text{ and simplify completely.}',
    ...
    },
    {
      id: 'ch1-006-ch2',
      difficulty: 'hard',
      problem: '\\text{A ball is thrown upward. Its height is } s(t) = -16t^2 + 64t \\text{ feet. Find the average velocity on } [1,3] \\text{, the instantaneous velocity at } t=1, \\text{ and when the ball stops rising.}',
      ...
      walkthrough: [
        {
          ...
          annotation: 'Average velocity is zero — it went up and came back to the same height.',
        },
        {
          expression: "s'(t) = -32t + 64 \\Rightarrow s'(1) = -32+64 = 32 \\text{ ft/s}",
          annotation: 'Instantaneous velocity at $t=1$: rising at 32 ft/s.',
        },
        {
          expression: "s'(t) = 0 \\Rightarrow -32t+64=0 \\Rightarrow t=2 \\text{ s}",
          annotation: 'The ball stops rising at $t=2$ seconds, when velocity equals zero.',
        },
      ],
      answer: 'Avg velocity = 0 ft/s; instantaneous at $t=1$ is 32 ft/s; stops rising at $t=2$ s.',
    },
  ],

  calcBridge: {
    teaser: 'The difference quotient $\\frac{f(x+h)-f(x)}{h}$ is the exact definition of the derivative. Every derivative rule — power rule, product rule, chain rule — is a shortcut derived from this formula. In calculus, the first topic after limits is this limit applied to find derivatives. Understanding the difference quotient deeply means the derivative never feels mysterious.',
