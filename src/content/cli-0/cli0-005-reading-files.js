    ...
    questions: [
      {
        ...
        answer: 2,
        explanation: "Log files grow from the bottom, so the most recent entries are at the end. `tail -n 20` prints the last 20 lines. `head -n 20` would show the oldest 20 entries. `cat` dumps everything. `wc -l` just counts lines.",
      },
      {
        id: "cli0-005-q2",
        type: "choice",
        ...
        answer: 2,
        explanation: "`touch` on an existing file updates its access and modification timestamps without changing its contents. This is useful in build systems where timestamps are used to determine what needs to be rebuilt.",
      },
    ],
  },
};
