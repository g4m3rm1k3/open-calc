...
export const VIDEO_PLACEMENT_MAP = {
  'ch0-inequalities': {
    intuition: ["oct-polynomial-inequalities","oct-rational-inequalities","gv-graph-a-parabola-that-opens-up-and-a-parabola-that-opens"],
  },
  'ch0-conic-sections': {
  ...
  'ch0-functions': {
    intuition: ["oct-even-odd-functions-examples","oct-function-composition","graph-transformations","oct-piecewise-functions-intro","gv-introduction-to-graphing-horizontal-and-vertical-lines","gv-introduction-to-horizontal-and-vertical-stretching","gv-introduction-to-functions-and-the-vertical-line-test","gv-graphing-linear-inequalities-in-two-variables-vertical-an","gv-a-fun-function-to-graph-semi-circle","gv-the-horizontal-line-test"],
  },
  'ch0-absolute-value': {
    intuition: ["oct-absolute-value-equations","oct-absolute-value-inequality-graphs","derivative-of-absolute-value-functions-calculus-1-ab","limits-involving-absolute-value-functions-calculus-1-ab","gv-solving-absolute-value-inequalities-with-greater-than"],
  },
  'ch0-polynomial-division': {
    intuition: ["oct-polynomial-long-division","oct-synthetic-division"],
  },
  'ch0-completing-the-square': {
    intuition: ["oct-completing-the-square-intro","oct-quadratic-formula-derivation","gv-find-the-inverse-of-a-trinomial-quadratic-that-is-not-a-p","gv-find-the-inverse-of-a-trinomial-function-hint-use-complet","gv-graph-a-circle-by-first-completing-the-square-for-standar"],
  },
  ...
  'ch0-trig': {
    intuition: ["tr-00-introduction-to-the-trigonometry-series", "tr-08-similar-and-congruent-triangles", 
      ...
      "right-triangle-trigonometry-part-2-solving-for-acute-angles", "solving-trigonometric-equations-5-examples","gv-try-it-find-the-absolute-maximum-and-minimum-on-a-functio","gv-try-it-find-the-equation-of-a-tangent-line-with-a-tangent","gv-find-all-points-where-the-tangent-line-is-horizontal"],
  },
  'ch0-exponentials': {
  ...
  'ch1-epsilon-delta': {
    intuition: ["ka--ejyeII0i5c","ka-Fdu5-aNJTzU","calculus-i-1-2-3-the-epsilon-delta-limit-definition","definition-of-a-limit-epsilon-delta-proof-3-examples-calculus-1","gv-use-limit-definition-at-a-point-to-find-the-tangent-line","gv-finding-the-slope-of-the-tangent-line-limit-definition","gv-prove-using-the-epsilon-delta-definition-of-the-limit","gv-epsilon-delta-proofs-in-four-words-given-choose-suppose-c","gv-introduction-to-the-epsilon-delta-limit-definition","gv-try-it-yourself-find-the-equation-of-the-line-tangent-to"],
  },
  'ch1-squeeze-theorem': {
    intuition: ["ka-igJdDN-DPgA","ka-Ve99biD1KtA","limits-of-oscillating-functions-and-the-squeeze-theorem","gv-the-squeeze-theorem"],
  },
  'ch1-fundamental-trig-limits': {
    intuition: ["the-most-important-limit-in-calculus-geometric-proof-applications","gv-using-factoring-to-evaluate-trig-limits"],
  },
  'ch1-limits-at-infinity': {
    intuition: ["calculus-i-3-5-2-horizontal-asymptotes-and-computational-techniques","calculus-i-3-5-1-limits-at-infinity","calculus-i-1-5-2-vertical-asymptotes","calculus-i-1-5-1-infinite-limits-and-their-properties","computing-limits-at-infinity-for-rational-functions","infinite-limit-vs-limits-at-infinity-of-a-composite-function","gv-the-conjugate-trick-with-a-square-root-and-limits-at-infi","gv-limits-at-infinity-as-x-goes-to-infinity-of-functions-wit","gv-introduction-to-limits-at-infinity-as-x-approaches-plus-o"],
  },
  'limits-and-continuity': {
    intuition: ["continuity-on-an-interval-open-closed-intervals-1-sided-limits-calculus-1-ab","calculus-speedrun-limits-episode-1","gv-limits-composite-functions-and-continuity"],
  },
  'ch2-000': {
    intuition: ["calculus-i-2-1-2-the-derivative-using-the-definition-of-a-derivative","calculus-i-2-1-1-the-slope-of-the-tangent-line-using-the-definition-of-slope","graphical-comparison-function-to-its-1st-and-2nd-derivative-calculus-1-ab","horizontal-tangent-lines-and-differentiation-calculus-1-ab","tangent-line-of-curve-parallel-to-a-line-calculus-1-ab","tangent-line-through-point-not-on-curve-4k","tangent-line-parallel-to-a-given-line-calculus-derivative-4k","tangent-line-and-normal-line-in-calculus-4k","instantaneous-velocity-and-speed-of-linear-motion-calculus-1-ab","basic-differentiation-rules-calculus-1-ab","graphical-comparison-of-function-vs-derivative-graphs-calculus-1-ab","why-there-is-no-derivative-at-a-sharp-bend-4k","definition-of-derivative-and-vertical-tangent-line-calculus-1-ab","slope-of-tangent-line-derivative-at-a-point-calculus-1-ab","definition-of-a-derivative-alternative-form-at-a-point-4k","definition-of-derivative-tangent-line-problems-calculus-1-ab","definition-of-the-derivative-part-i","applying-the-definition-of-the-derivative-to-1-x","the-derivative-of-a-constant-and-of-x-2-from-the-definition","definition-of-derivative-example-f-x-x-1-x-1","gv-proof-derivative-of-sin-x-is-cos-x","gv-proof-that-the-derivative-of-e-x-is-e-x","gv-try-it-yourself-derivative-of-log-base-2","gv-the-limit-definition-of-the-derivative-to-find-the-equati","gv-try-it-use-the-definition-of-the-derivative-to-find-veloc","gv-using-pascal-s-triangle-to-find-the-derivative-of-a-fourt"],
  },
  'ch2-001': {
    intuition: ["ka-h78GdGiRmpM","ka-E_1gEtiGPNI","ka-dZnc3PtNaN4","calculus-i-2-3-1-the-product-and-quotient-rules-for-derivatives","calculus-i-2-2-2-applying-the-derivative-to-the-position-function","calculus-i-2-2-1-basic-differentiation-rules","essence-of-calculus-chapter-2-derivative-formulas-through-geometry","logarithmic-differentiation-derivative-of-a-fraction","derivative-rules-power-rule-additivity-and-scalar-multiplication","how-to-find-the-equation-of-a-tangent-line","gv-finding-the-derivative-of-x-2x-by-logarithmic-differentia","gv-logarithmic-differentiation-can-be-easier-than-the-quotie","gv-use-a-table-to-find-the-derivative-quotient-and-product-r","gv-find-the-equation-of-the-tangent-line-quotient-rule-e-x"],
  },
  'ch2-002': {
    intuition: ["ka-XIQ-KnsAsbg","ka-6_lmiPDedsY","essence-of-calculus-chapter-3-visualizing-the-chain-rule-and-product-rule","chain-rule-the-derivative-of-a-composition","calculus-i-2-4-1-the-chain-rule-and-general-power-rule","calculus-i-2-4-2-differentiation-strategies-and-practice","chain-rule-with-trig-functions-harder-examples","chain-rule-harder-algebraic-examples","chain-rule-3-algebraic-examples","interpreting-the-chain-rule-graphically","the-chain-rule-using-leibniz-notation","gv-chain-rule-xe-x-inside-a-tangent-function","gv-square-root-inside-a-square-root-chain-rule","gv-the-chain-rule-applied-to-e-u","gv-chain-rule-intermediate-examples","gv-the-chain-rule-for-beginners-seven-examples","gv-introduction-to-the-chain-rule","gv-constant-rule-power-rule-constant-multiple-rule-sum-rule"],
  },
  'ch2-002b': {
    intuition: ["calculus-i-5-3-2-the-derivative-of-the-inverse-of-a-function","derivative-of-inverse-function","derivative-of-inverse-trigonometric-functions-examples-calculus-1-ab","derivative-rules-for-inverse-trigonometric-functions-derived-calculus-1-ab","derivative-of-inverse-trig-functions-via-implicit-differentiation","evaluating-inverse-trigonometric-functions","evaluating-inverse-trigonometric-functions-full-length","gv-inverse-hyperbolic-functions-applied-to-integration","gv-the-derivative-of-an-inverse-function-at-a-point","gv-taking-the-derivative-of-inverse-tangent-two-examples","gv-proof-derivative-of-the-inverse-tan-arctan-function","gv-three-quick-examples-of-differentiating-inverse-trig-func","gv-proof-derivative-of-the-inverse-sin-arcsin-function","gv-trigonometry-basics-for-calculus-part-2-graphs-and-invers","gv-find-the-inverse-of-a-square-root-functions-and-graph-bot","gv-find-the-inverse-for-an-exponential-rational-function","gv-find-the-inverse-of-a-rational-function","gv-how-to-find-the-inverse-function","gv-try-for-yourself-find-the-inverse-of-f-x-1-2-x-2","gv-introduction-to-one-to-one-functions-and-inverse-function","gv-introduction-to-inverse-variation"],
  },
  'ch2-003': {
    intuition: ["calculus-i-5-7-2-inverse-trigonometric-functions-differentiation","calculus-i-2-3-2-trigonometric-and-higher-order-derivatives","derivative-rules-of-trigonometric-functions-calculus-1-ab","deriving-derivative-rules-for-trigonometric-functions-tan-cot-sec-csc-calculus-1-ab","derivative-of-inverse-trigonometric-functions","the-derivative-of-trigonometric-functions","setting-up-the-unit-circle-part-1-and-reference-angle","fundamental-trigonometric-identities-intro-proofs","intro-to-fundamental-trig-identities","understanding-basic-sine-cosine-graphs","evaluating-trig-functions-w-unit-circle-degrees-radians","gv-implicit-differentiation-with-trigonometric-functions","gv-derivatives-of-trigonometric-functions-an-introduction","gv-sketch-a-graph-of-the-derivative-given-the-graph-of-the-o","gv-find-the-slope-from-a-graph"],
  },
  'ch2-004': {
    intuition: ["calculus-i-5-5-1-logarithmic-and-exponential-functions-derivatives-and-integrals-base-not-e","calculus-i-5-4-1-derivatives-and-integrals-of-the-natural-exponential-function","calculus-i-5-1-2-the-natural-logarithmic-function-differentiation","derivative-of-logarithms-base-a-calculus-1-ab","derivative-of-exponential-functions-base-a-calculus-1-ab","derivative-of-natural-logarithm-functions-calculus-1-ab","the-derivative-of-e-x","logarithm-introduction","using-properties-of-logarithms-to-expand-logs","using-properties-of-logarithms-to-condense-logs","change-of-base-formula-logarithms","solving-natural-exponential-functions-3-examples-with-natural-logarithms","the-derivative-of-ln-x-via-implicit-differentiation","logarithmic-differentiation-example-x-sinx","gv-calculus-1-review-of-exponential-and-logarithmic-derivati","gv-limits-at-infinity-for-common-exponential-and-logarithmic","gv-two-examples-of-exponential-decay-valium-and-uranium-238","gv-applying-the-exponential-growth-decay-equation-to-human-p","gv-applying-the-exponential-growth-equation-to-interest","gv-how-to-derive-the-exponential-growth-decay-equation","gv-three-examples-of-finding-derivatives-of-exponential-func","gv-six-quick-proofs-about-differentiating-logs-and-exponenti","gv-graph-two-exponential-and-two-logarithmic-functions-on-th","gv-change-the-base-of-an-exponential-expression-to-base-10","gv-how-to-change-the-base-of-an-exponential-expression","gv-solve-a-logarithmic-expression-for-the-base-and-solve-an","gv-finding-inverses-of-logarithmic-and-exponential-functions","gv-solving-an-exponential-equation-that-is-quadratic-in-form","gv-try-it-solve-logarithmic-equations-by-writing-in-exponent","gv-try-yourself-writing-exponential-and-logarithmic-equation","gv-write-an-exponential-equation-as-a-logarithmic-equation","gv-write-a-logarithmic-equation-as-an-exponential-equation","gv-solving-a-logarithmic-equation-by-first-writing-in-expone","gv-further-solving-exponential-equations","gv-introduction-to-solving-exponential-equations","gv-solving-equations-with-natural-log-by-converting-to-expon","gv-further-examples-exponential-equations-with-same-base-eac","gv-solving-exponential-equations-with-the-same-base-on-each","gv-translations-and-reflections-of-exponential-graphs","gv-introduction-to-exponential-decay","gv-graphing-basic-exponential-functions","gv-introduction-to-exponential-growth-f-x-2-x","gv-displacement-from-a-velocity-graph","gv-find-the-stone-s-velocity-when-it-hits-the-ground","gv-determine-when-an-object-is-speeding-up-analysis-of-posit"],
  },
  'ch2-005': {
    intuition: ["ka-sL6MC-lKOrw","ka-PUsMyhds5S4","calculus-i-2-5-1-implicit-differentiation","implicit-differentiation-product-rule-normal-line","second-derivative-implicitly-calculus-1-ab","implicit-differentiation-3-examples-calculus-1-ab","introduction-to-implicit-differentiation-calculus-1-ab","implicit-differentiation-differentiation-when-you-only-have-an-equation-not-an-explicit-function","gv-implicit-differentiation-with-the-quotient-rule","gv-try-it-three-quick-examples-of-implicit-differentiation","gv-folium-of-descartes-implicit-differentiation","gv-introduction-to-implicit-differentiation","gv-implicit-differentiation-example-with-sin-and-cos","gv-introduction-to-concavity"],
  },
  'ch2-reading-derivatives': {
    intuition: ["concavity-inflection-second-derivative-test-4-examples-calculus-1-ab","sketching-derivatives-from-graphs-of-functions-5-examples-calculus-1-ab","extrema-on-an-interval","gv-introduction-to-maxima-and-minima-for-calculus","gv-sketch-a-graph-given-information-about-increasing-decreas"],
  },
  ...
  'ch3-000': {
    intuition: ["calculus-i-2-6-2-related-rates-modeling-with-triangles","calculus-i-2-6-1-related-rates-modeling-with-circles","calculus-related-rates-example-volume-of-cone-calculus-1-ab","related-rates-similar-triangles-4k","related-rates-right-triangles-2-examples-4k","related-rates-part-2-linear-vs-angular-speed-calculus-1-ab","related-rates-introduction-area-volume-4k","intro-to-related-rates","gv-related-rates-increasing-angle-of-elevation-watching-a-ho","gv-related-rates-draining-a-cone","gv-related-rates-moving-shadow-man-walks-towards-a-building","gv-related-rates-ladder-sliding-down-a-wall","gv-related-rates-draining-a-cylindrical-tank","gv-related-rates-two-cars-traveling-in-different-directions","gv-related-rates-melting-snowball","gv-a-shrinking-right-isosceles-triangle-related-rates","gv-related-rates-an-expanding-cube","gv-a-gentle-introduction-to-related-rates"],
  },
  'ch3-001': {
  ...
  'ch4-004': {
    intuition: ["calculus-i-5-4-1-derivatives-and-integrals-of-the-natural-exponential-function","calculus-i-5-2-1-the-natural-logarithmic-function-integration","calculus-i-4-1-2-initial-conditions-and-the-particular-solution-to-a-differential-equation","calculus-i-4-1-1-antiderivatives-and-the-general-solution-to-a-differential-equation","integration-techniques-reviewed-5-examples","integration-of-natural-exponential-functions-calculus-1-ab","integration-of-natural-exponential-function-e-x-4-examples","indefinite-integration-word-problems-calculus-1-ab","initial-condition-particular-solution-for-antiderivative-calculus-1-ab","solving-for-the-constant-in-the-general-anti-derivative","gv-two-wonderful-integrals-involving-natural-logs-u-substitu","gv-proving-some-integrals-in-the-table-of-integrals-applicat","gv-solving-an-exponential-equation-that-is-quadratic-in-form","gv-try-it-solve-logarithmic-equations-by-writing-in-exponent","gv-solve-logarithmic-equations-by-writing-as-exponential-equ","gv-try-yourself-writing-exponential-and-logarithmic-equation","gv-write-an-exponential-equation-as-a-logarithmic-equation","gv-write-a-logarithmic-equation-as-an-exponential-equation","gv-solving-a-logarithmic-equation-by-first-writing-in-expone","gv-further-solving-exponential-equations","gv-introduction-to-solving-exponential-equations","gv-solving-equations-with-natural-log-by-converting-to-expon","gv-further-examples-exponential-equations-with-same-base-eac","gv-solving-exponential-equations-with-the-same-base-on-each"],
  },
  'ch4-005': {
    intuition: ["calculus-i-final-exam-review","calculus-i-4-4-2-the-mean-value-theorem-for-integrals-and-the-average-value-of-a-function","hyperbolic-functions-derivative-integrals-5-examples-calculus-1","average-value-of-a-continuous-function-on-an-interval","exam-walkthrough-calc-1-test-3-integration-ftc-i-ii-optimization-u-subs-graphing","gv-two-examples-of-exponential-decay-valium-and-uranium-238","gv-applying-the-exponential-growth-decay-equation-to-human-p","gv-applying-the-exponential-growth-equation-to-interest","gv-how-to-derive-the-exponential-growth-decay-equation","gv-introduction-to-exponential-decay","gv-introduction-to-exponential-growth-f-x-2-x"],
  },
  'ch4-006': {
    intuition: ["calculus-i-5-2-2-natural-logarithmic-integration-difficult-examples","calculus-i-5-2-1-the-natural-logarithmic-function-integration","calculus-i-4-5-2-integration-by-substitution-definite-integrals","calculus-i-4-5-1-integration-by-substitution-indefinite-integrals","intro-to-substitution-undoing-the-chain-rule","adjusting-the-constant-in-integration-by-substitution","substitution-method-for-definite-integrals-careful","gv-try-it-pro-level-u-substitution","gv-u-substitution-at-its-finest-natural-log-and-e-x","gv-challenging-variations-on-u-substitution","gv-introduction-to-u-substitution-for-integrals-substitution","gv-substitution-method-with-fractions","gv-try-it-out-substitution-method","gv-substitution-method-with-no-solution","gv-try-it-using-the-substitution-method","gv-using-substitution-to-solve-a-trinomial-with-x-2-3-fracti","gv-using-substitution-to-solve-a-fourth-degree-trinomial","gv-negative-exponents-using-substitution-quadratic-methods-t"],
  },
  'ch4-006b': {
  ...
  'ch4-009': {
    intuition: ["calculus-i-5-8-1-inverse-trigonometric-functions-integration","gv-integrate-using-u-substitution-two-slightly-more-challeng","gv-three-examples-of-u-substitution-to-solve-integrals","gv-using-substitution-to-solve-a-quadratic-in-form-trinomial"],
  },
  'ch4-centroid': {
  ...
  'ch2-alg-003': {
    intuition: ["graphing-parabolas-w-vertex-intercepts","parabola-applications-maximizing-minimizing-reflectors-etc","complex-imaginary-numbers-part-1","complex-solutions-imaginary-part-2-of-parabola-quadratic-equation","gv-graph-a-parabola-quadratic-equation-using-the-vertex-form"],
  },
  'ch2-alg-004': {
    intuition: ["partial-fraction-decomposition-part-1","partial-fractions-decomposition-part-2","gv-sketch-a-graph-with-a-rational-exponent-using-calculus","gv-try-yourself-adding-subtracting-rational-expressions-one"],
  },
  'ch2-alg-005': {
    intuition: ["solving-linear-systems-with-substitution-and-linear-combination-simultaneous-equations","solving-3-variable-linear-systems-substitution-gaussian-elimination","3-variable-systems-parabola-equation-given-3-points-investment-word-problem","non-square-3-variable-linear-systems","2-variable-non-linear-systems-substitution-method","2-variable-non-linear-systems-addition-elimination-method","matrices-and-gaussian-jordan-elimination","determinant-of-square-matrices","gv-infinite-number-of-solutions-solving-a-system-of-equation","gv-substitution-method-solve-a-system-of-two-linear-equation","gv-introduction-to-the-substitution-method-for-solving-syste","gv-introduction-to-linear-systems-of-equations-with-three-va","gv-a-system-of-two-linear-equations-with-an-infinite-number","gv-introduction-to-the-addition-elimination-method-to-solve"],
  },
  'ch2-alg-006': {
    intuition: ["complex-numbers-in-polar-form","product-quotient-of-polar-complex-numbers","gv-dividing-complex-numbers-using-the-complex-conjugate"],
  },
  'ch2-alg-007': {
    intuition: ["solving-polynomial-inequalities-a-graphical-approach","solving-rational-inequalities","solving-polynomial-inequalities","graphing-linear-inequalities-3-examples","graphing-1-variable-inequalities","graphing-non-linear-inequalities","graphing-system-of-linear-inequalities","gv-introduction-to-absolute-value-inequalities","gv-more-examples-solving-absolute-value-inequalities","gv-solving-absolute-value-inequalities-with-greater-than","gv-basic-examples-solving-absolute-value-inequalities"],
  },
  ...
  'ch3-trig-005': {
    intuition: ["tr-18-graphing-sine-and-cosine","tr-21-domain-and-range-of-trig-functions","gv-introduction-to-graphing-horizontal-and-vertical-lines","gv-graphing-a-system-of-inequalities-horizontal-and-vertical","gv-graphing-linear-inequalities-in-two-variables-vertical-an"],
  },
  'ch3-trig-006': {
    intuition: ["tr-26-solving-right-triangles","tr-27-triangle-types-to-solve","tr-30-ssa-triangles-overview","tr-31-solving-ssa-triangles","solving-trigonometric-equations-5-examples"],
  },
  'ch3-trig-002': {
    intuition: ["tr-08-similar-and-congruent-triangles","tr-10-pythagorean-triples","gv-using-pascal-s-triangle-to-find-the-derivative-of-a-fourt","gv-find-the-lengths-of-sides-of-a-triangle-when-perimeter-is"],
  },
  'ch3-trig-003': {
  ...
  'discrete-1-08': {
    intuition: ["graph-theory-intro", "graph-properties", "vertex-degrees", "euler-paths","gv-how-to-graph-the-cube-root-of-x","gv-try-it-use-x-and-y-intercepts-to-graph-a-line","gv-using-intercepts-to-graph-a-line","gv-use-translations-and-reflections-to-graph","gv-try-use-shifts-translations-and-reflections-to-graph-f-x","gv-use-shifts-translations-and-reflections-to-graph-f-x-x-2","gv-use-shifts-translations-to-graph-f-x-sqrt-x-3"],
    math: ["discrete-outro"],
  },
  'graph-theory-intro': {
    intuition: ["graph-theory-intro", "graph-properties", "vertex-degrees", "euler-paths","gv-using-translations-to-shift-the-cube-root-graph","gv-graph-the-inequality-lines-that-pass-through-the-origin"],
  },
  'discrete-1-05': {
  ...
  'p1-ch2-001': { intuition: ['vb-motion-1d-1',"gv-motion-problem-speed-of-current-is-given-find-the-speed-o","gv-try-yourself-motion-rate-time-distance-problem-with-a-boa","gv-motion-problem-find-speed-of-truck-driving-through-flatla","gv-motion-word-problem-one-car-overtakes-another"] },
