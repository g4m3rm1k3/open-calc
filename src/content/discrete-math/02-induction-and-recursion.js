export default {
  ...
  aliases:
    "mathematical induction recurrence relation recursive sequence strong induction",

  hook: {
    question:
      "How can a Software Engineer mathematically guarantee that a loop or algorithm will definitively work for 10 Billion users, without sitting and testing 10 Billion distinct test cases?",
    realWorldContext:
      "Induction is the engine powering all scalable Computer Science logic. It mathematically certifies Loop Invariants, algorithmic correctness (like Divide & Conquer), and recursive data structures like Trees and Graphs. Recursion, on the other hand, is the exact computational mirror of Induction—it executes the logic backwards!",
    ...
    visualizations: [
      {
        ...
        caption:
          'Watch the formula produce primes for 40 consecutive values — then suddenly fail. This is why "it works for many cases" is never a proof.',
      ...
      },
      {
        ...
        caption:
          "Adjust the logic parameters to successfully trigger an infinitely cascading chain of unassailable mathematical truth.",
      },
      {
        id: "RecursionTreeViz",
        title: "Recursion as a Tree: How Functions Call Themselves",
        caption:
          "Visualize recursive functions as trees. See how each call branches into smaller subproblems until reaching base cases.",
        props: { interactive: true },
      },
      {
        id: "RecursionStackViz",
        title: "The Call Stack: How Recursion Really Works in Memory",
        caption:
          "Watch the function call stack grow and shrink as recursion executes. Understand stack overflow and base cases.",
        props: { animated: true },
      },
      {
        id: "SigmaDecoderLab",
        ...
        caption:
          "Deconstruct the terrifying Greek symbol into a simple 3-part programming For-Loop before attempting Mathematical Proofs.",
      },
      {
        id: "InductionAlgebraDecoderLab",
        title: 'The Core "Aha!" Mechanical Substitution',
        caption:
          "Watch the exact moment the Inductive Hypothesis P(k) is mathematically injected to flawlessly close the gap.",
      },
      {
        id: "InductionGrowthExplorer",
        title: "Recursive Growth Explorer",
        caption:
          "A second perspective: visualize induction as layered recursive growth from a base seed.",
        mathBridge:
          "Complements domino induction by showing how each verified step supports a larger recursive structure.",
        props: { guided: true },
      },
      {
        ...
        caption:
          "Geometric proof perspective: duplicate and flip a staircase to see the rectangle argument for sums.",
        mathBridge:
          "Shows why 1 + 2 + ... + n = n(n+1)/2 through geometry and links directly to the inductive step.",
        props: { guided: true },
      },
      {
        ...
        caption:
          "The four-section ritual: Base Case → Inductive Hypothesis → Inductive Step → Conclusion. Walk through a live proof and identify each section.",
    ...
    visualizations: [
      {
        ...
        caption:
          "Watch a single domino (weak) fail to push a heavy target, then see the combined weight of all prior dominoes (strong) succeed. Understand exactly when each is needed.",
        props: { interactive: true },
      },
      {
        id: "StrongInductionPuzzle",
        title: "Strong Induction Challenge: Postage Stamp Problem",
        caption:
          "Can you make any amount of postage ≥ 8¢ with 3¢ and 5¢ stamps? Use strong induction to prove it systematically.",
        props: { interactive: true },
      },
      {
        ...
        caption:
          "Watch a single Domino completely fail to push a heavy target, demanding the massive architectural support of Strong Induction.",
      },
      {
        id: "RecursionVsInductionMirror",
        title: "Recursion and Induction: Two Mirrors",
        caption:
          "Side-by-side animation showing a recursive computation unwinding (downward) next to an inductive proof propagating (upward). The structural identity is striking.",
        props: { animated: true },
      },
      {
        ...
        caption:
          "Execute the Fibonacci(4) logic cycle. Notice how heavily it relies on Strong Induction to perfectly trace the historical logic dependencies.",
      },
      {
        id: "RecurrenceExplorer",
        title: "Recurrence Relations: From Formula to Closed Form",
        caption:
          "Enter a recurrence relation, explore its growth pattern, and watch induction verify a proposed closed form.",
        props: { interactive: true },
      },
    ],
  },
...
**5. Conclusion:** "Therefore, by the Principle of Mathematical Induction, P(n) holds for all n ≥ [first value]. □"`,
    ...
    visualizations: [
      {
        ...
        caption:
          "A complete written proof with each section color-coded and explained. Click any line to see which section it belongs to and why it's necessary.",
      ...
      },
      {
        ...
        caption:
          "Transition from geometric intuition to Formal Invariants. Watch the system verify the truth of the state at every step.",
        mathBridge:
          "Enforces the connection between Algebra (the sum) and Invariants (the row properties) to create an unassailable proof.",
        props: { guided: true },
      },
      {
        ...
        caption:
          "Five deliberately flawed induction proofs. Each has exactly one error. Can you find it? Covers: missing base case, wrong base case, unused hypothesis, circular reasoning, and wrong starting point.",
  ...
  examples: [
    {
      ...
      problem:
        "Test f(n) = n² + n + 41 for n = 0, 1, 2, 3. What pattern do you see? Now test n = 40. What happens?",
      steps: [
        {
          expression: "f(0) = 0 + 0 + 41 = 41 \\text{ (prime)}",
          annotation:
            "f(1) = 43 (prime), f(2) = 47 (prime), f(3) = 53 (prime)...",
        },
        {
          expression: "f(39) = 1521 + 39 + 41 = 1601 \\text{ (prime)}",
          annotation: "40 consecutive prime values. Looks unbreakable.",
        },
        {
          expression: "f(40) = 1600 + 40 + 41 = 1681 = 41 \\times 41",
          annotation: "Composite! The pattern shatters at the 41st test.",
        },
        {
          expression: "\\text{Testing 40 cases proved nothing.}",
          annotation:
            "This is why proof requires something stronger than examples.",
        },
      ],
      conclusion:
        "Finite testing can never establish infinite truth. Mathematical induction closes this gap permanently.",
    },
    {
      id: "discrete-1-03-ex1",
      title: "The Classic Arithmetic Sum — Full Proof",
      problem:
        "Prove: for all positive integers n, 1 + 2 + 3 + ... + n = n(n+1)/2.",
      steps: [
        {
          expression:
            "\\textbf{Define } P(n): \\sum_{i=1}^n i = \\frac{n(n+1)}{2}",
          annotation:
            "State exactly what we're proving. P(n) is this equation.",
        },
        {
          expression:
            "\\textbf{Base Case } (n=1): \\text{ LHS} = 1,\\quad \\text{RHS} = \\frac{1 \\cdot 2}{2} = 1 \\checkmark",
          annotation: "LHS = RHS. Base case holds.",
        },
        {
          expression:
            "\\textbf{Inductive Hypothesis:} \\text{ Assume } \\sum_{i=1}^k i = \\frac{k(k+1)}{2} \\text{ for some } k \\geq 1",
          annotation:
            "We formally assume P(k). This is the kinetic energy of domino k.",
        },
        {
          expression:
            "\\textbf{Inductive Step:} \\text{ Prove } \\sum_{i=1}^{k+1} i = \\frac{(k+1)(k+2)}{2}",
          annotation:
            "This is what P(k+1) says. Write it out before you start.",
        },
        {
          expression:
            "\\sum_{i=1}^{k+1} i = \\underbrace{\\sum_{i=1}^k i}_{\\text{IH applies here}} + (k+1)",
          annotation:
            "Split off the last term. The remaining sum is exactly the IH.",
        },
        {
          expression: "= \\frac{k(k+1)}{2} + (k+1) \\quad [\\text{by IH}]",
          annotation:
            "💥 Substituting the IH. This is the moment that drives the chain.",
        },
        {
          expression:
            "= (k+1)\\left(\\frac{k}{2} + 1\\right) = \\frac{(k+1)(k+2)}{2} \\checkmark",
          annotation: "Factor out (k+1). This matches P(k+1) exactly.",
        },
        {
          expression:
            "\\therefore \\text{ By induction, } P(n) \\text{ holds for all } n \\geq 1. \\quad \\square",
          annotation: "Conclusion. All four sections complete.",
        },
      ],
      conclusion:
        "The sum formula is proven for all positive integers. Note the explicit IH substitution — that's the mechanical heart of every induction proof.",
    },
    {
      id: "discrete-1-03-ex2",
      title: "Strong Induction — Prime Factorization",
      problem:
        "Prove that every integer n ≥ 2 can be written as a product of primes.",
      steps: [
        {
          expression: "\\textbf{Base Case } (n=2): \\text{ 2 is prime.}",
          annotation: "2 is its own prime factorization.",
        },
        {
          expression:
            "\\textbf{Strong IH:} \\text{ Assume every integer from 2 through } k \\text{ has a prime factorization.}",
          annotation:
            "We assume the claim for ALL values 2 ≤ i ≤ k, not just k alone.",
        },
        {
          expression:
            "\\textbf{Inductive Step:} \\text{ Prove } k+1 \\text{ has a prime factorization.}",
          annotation: "Two cases.",
        },
        {
          expression: "\\text{Case 1: } k+1 \\text{ is prime.}",
          annotation: "Done — k+1 is its own factorization.",
        },
        {
          expression:
            "\\text{Case 2: } k+1 = a \\cdot b \\text{ where } 2 \\leq a, b < k+1",
          annotation:
            "k+1 is composite — it factors into two smaller integers.",
        },
        {
          expression:
            "\\text{Since } 2 \\leq a, b \\leq k, \\text{ the Strong IH applies to both } a \\text{ and } b.",
          annotation:
            "This is why we need strong induction — a and b could be any values up to k, not specifically k.",
        },
        {
          expression:
            "k+1 = a \\cdot b = (\\text{primes}) \\cdot (\\text{primes}) = \\text{product of primes}. \\quad \\square",
          annotation:
            "Combining the factorizations of a and b gives a factorization of k+1.",
        },
      ],
      conclusion:
        "Strong induction was necessary because the factors a and b could be any values from 2 to k. Weak induction only gives you k, which might not be either factor.",
    },
    {
      id: "discrete-1-03-ex3",
      title: "Recursion Mirror: Fibonacci",
      problem:
        "The Fibonacci sequence is defined recursively as F(1) = 1, F(2) = 1, F(n) = F(n−1) + F(n−2). Trace F(5) and connect it to strong induction.",
      steps: [
        {
          expression: "F(5) = F(4) + F(3)",
          annotation:
            "To compute F(5), we need F(4) and F(3). This is strong induction in reverse.",
        },
        {
          expression: "F(4) = F(3) + F(2) = F(2) + F(1) + F(2) = 1 + 1 + 1 = 3",
          annotation: "F(4) unwinds all the way to the base cases.",
        },
        {
          expression: "F(3) = F(2) + F(1) = 1 + 1 = 2",
          annotation: "Each sub-computation hits the hardcoded base cases.",
        },
        {
          expression: "F(5) = 3 + 2 = 5",
          annotation: "The full recursion tree collapses to a value.",
        },
        {
          expression:
            "\\text{Inductive equivalent: Assume F(k) and F(k-1) are correct.}",
          annotation:
            "Strong IH gives us both. Then F(k+1) = F(k) + F(k-1) must be correct too.",
        },
      ],
      conclusion:
        "Recursion computes by unwinding to base cases. Induction proves by propagating from base cases. Same structure, opposite directions.",
    },
    {
      id: "discrete-1-03-ex4",
      title: "Proof by Contradiction: √2 Is Irrational",
      problem:
        "Prove √2 cannot be expressed as p/q where p,q are integers with no common factors.",
      steps: [
        {
          expression:
            "\\text{Assume } \\sqrt{2} = \\frac{p}{q} \\text{ in lowest terms}",
          annotation:
            "Suppose for contradiction that √2 IS rational and already fully reduced.",
        },
        {
          expression: "2 = \\frac{p^2}{q^2} \\Rightarrow p^2 = 2q^2",
          annotation:
            "Square both sides. p² is 2 times something — so p² is even.",
        },
        {
          expression:
            "p^2 \\text{ even} \\Rightarrow p \\text{ even} \\Rightarrow p = 2k",
          annotation:
            "An odd number squared is odd (check!). So p² even means p is even.",
        },
        {
          expression:
            "(2k)^2 = 2q^2 \\Rightarrow 4k^2 = 2q^2 \\Rightarrow q^2 = 2k^2",
          annotation: "Substitute p = 2k. Now q² is even, so q is even.",
        },
        {
          expression:
            "\\text{Both } p \\text{ and } q \\text{ even} \\Rightarrow \\gcd(p,q) \\geq 2",
          annotation:
            "They share a factor of 2 — but we assumed they shared NO factors. Contradiction! ∎",
        },
      ],
      conclusion:
        "The assumption that √2 is rational leads to a logical impossibility. Therefore √2 is irrational.",
    },
  ],
  ...
  challenges: [
    {
      ...
      difficulty: "easy",
      problem:
        'Identify the error: "Proof by induction that all horses are the same color." Base case P(1): trivially true (one horse is the same color as itself). Inductive step: given k+1 horses, remove horse 1 — the remaining k are the same color by IH. Now put horse 1 back and remove the last horse — those k are the same color. So all k+1 horses are the same color. Where does this proof break?',
      hint: "Trace the argument carefully when k = 1 (proving P(2) from P(1)). Do the two groups actually overlap?",
      walkthrough: [
        {
          expression: "\\text{Test } P(1) \\to P(2): \\text{ 2 horses}",
          annotation:
            "Remove horse 1: one horse, trivially same color. Remove horse 2: one horse, trivially same color. But there is NO OVERLAP.",
        },
        {
          expression: "\\text{Two groups of size 1 share no horses.}",
          annotation:
            'The argument requires the two overlapping groups to share at least one horse — a "color bridge." With k=1, the overlap is empty.',
        },
        {
          expression: "\\text{The inductive step fails at } k=1 \\to k+1=2.",
          annotation:
            "The chain breaks at the very first link. Strong spacing only works from k=2 onward, but the base case gives you only k=1.",
        },
      ],
      answer:
        "The inductive step requires the two groups to overlap. When k=1, removing the first horse and removing the last horse gives two singleton groups with no shared member — no color bridge. The chain breaks between P(1) and P(2).",
    },
    {
      id: "discrete-1-03-ch1",
      difficulty: "easy",
      problem:
        "Quick Check: If you mathematically prove the Inductive Step P(k) → P(k+1), but entirely forget to prove the Base Case P(1), what happens to the Domino line?",
      hint: "Think about the physical kinetic energy required to start a reaction.",
      walkthrough: [
        {
          expression: "\\text{No Base Case = No initial push energy}",
          annotation:
            "The dominoes are perfectly spaced, but nothing ever initiates the chain reaction!",
        },
      ],
      answer:
        "The chain NEVER STARTS! You just proved the dominoes are perfectly spaced, but they all remain standing perfectly still forever.",
    },
    {
      ...
      walkthrough: [
        {
          expression:
            "\\text{Base } (n=0): 2^0 = 1, \\quad 2^1 - 1 = 1 \\checkmark",
          annotation: "One term, LHS = RHS.",
        },
        {
          expression: "\\text{IH: Assume } \\sum_{i=0}^k 2^i = 2^{k+1} - 1",
          annotation: "This is what P(k) says.",
        },
        {
          expression:
            "\\sum_{i=0}^{k+1} 2^i = \\left(\\sum_{i=0}^k 2^i\\right) + 2^{k+1} = (2^{k+1} - 1) + 2^{k+1}",
          annotation: "💥 Substituting the IH.",
        },
        {
          expression: "= 2 \\cdot 2^{k+1} - 1 = 2^{k+2} - 1",
          annotation: "This matches P(k+1). Chain closed. ∎",
        },
      ],
      answer:
        "By induction: base case n=0 holds, inductive step uses IH to substitute the sum and simplify.",
    },
    {
      id: "discrete-1-03-ch3",
      difficulty: "hard",
      problem:
        "Prove: any postage of n ≥ 8 cents can be formed using only 3-cent and 5-cent stamps.",
      ...
      walkthrough: [
        {
          expression:
            "\\text{Base Cases: } 8 = 3+5, \\quad 9 = 3+3+3, \\quad 10 = 5+5",
          annotation: "Three base cases establish the foundation.",
        },
        {
          expression:
            "\\text{Strong IH: Assume all postages from 8 to } k \\text{ can be formed.}",
          annotation: "k ≥ 10 for the inductive step.",
        },
        {
          expression:
            "\\text{For } k+1: \\text{ since } k+1 \\geq 11, \\text{ we have } k-2 \\geq 8.",
          annotation: "k−2 is within the range of our strong IH.",
        },
        {
          expression:
            "k-2 \\text{ can be formed (by strong IH)}. \\text{ Add one 3-cent stamp: } (k-2)+3 = k+1.",
          annotation:
            "The strong IH handles k−2; one additional stamp completes k+1.",
        },
      ],
      answer:
        "Strong induction with three base cases. For k+1 ≥ 11: k−2 ≥ 8 is coverable by IH; adding a 3-cent stamp gives k+1.",
    },
  ],
  ...
  semantics: {
    core: [
      {
        symbol: "P(n)",
        meaning: "Proposition — a statement depending on an integer n",
      },
      {
        symbol: "Base Case",
        meaning:
          "The smallest value (e.g., P(1)) for which the statement is directly proven",
      },
      {
        symbol: "Inductive Hypothesis (IH)",
        meaning:
          'The assumption that P(k) is true for some arbitrary k — the "kinetic energy" of the chain',
      },
      {
        symbol: "Inductive Step",
        meaning: "Proving that P(k) ⇒ P(k+1) — the spacing between dominoes",
      },
      {
        symbol: "Strong Induction",
        meaning: "Assuming P(i) is true for ALL 1 ≤ i ≤ k, not just k",
      },
      {
        symbol: "Recursion",
        meaning:
          "Defining a function in terms of itself with a base case — induction running backwards",
      },
      {
        symbol: "Recurrence Relation",
        meaning: "A formula defining the nth term using previous terms",
      },
      {
        symbol: "Well-Ordering Principle",
        meaning:
          "Every non-empty set of positive integers has a smallest element — the deep reason induction works",
      },
    ],
    rulesOfThumb: [
  ...
  assessment: {
    questions: [
      ...
      },
      {
        ...
        options: [
          "Valid",
          "Invalid — the IH was not used",
          "Valid if the base case holds",
  ...
  quiz: [
    {
      ...
      options: [
        ...
        "The proof is valid for n > 1",
        "The entire statement is unproven",
        "The statement is only true for prime numbers",
      ],
    ...
    },
    {
      ...
      options: [
        ...
        "When the k+1 step depends on multiple previous steps",
        "When proving geometric theorems",
        "When the base case is n=0",
      ],
      answer: "When the k+1 step depends on multiple previous steps",
      hints: [
        "Strong induction allows you to use the entire history of proven cases.",
      ],
    },
    {
      id: "ind-q3",
      ...
      answer: "3",
      hints: [
        "The base case proves P(n) for the smallest n in the claim. If the claim starts at n=3, start there.",
      ],
    },
    {
      id: "ind-q4",
