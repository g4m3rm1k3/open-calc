const lesson = {
  ...
  quiz: [
    {
      ...
      answer: "The terminal is the window; the shell is the program inside it that runs commands",
      hints: [
    ...
    },
    {
      ...
      answer: "Your home directory (/home/user)",
      hints: [
  ...
  definitions: [
    { term: "terminal", definition: "A text-based interface (window) where you type commands and see output. The terminal is the display layer; the shell is the program running inside it." },
    { term: "shell", definition: "The program running inside the terminal that reads your commands and tells the OS what to do. Common shells: bash (Linux default), zsh (macOS default)." },
    { term: "working directory", definition: "The directory you are currently 'in' in the terminal. Commands without a path argument operate relative to this location. `pwd` shows it." },
    { term: "stdout", definition: "Standard output — the default output stream for terminal programs. Printed to the terminal screen unless redirected with `>` or piped with `|`." },
  ],
};
