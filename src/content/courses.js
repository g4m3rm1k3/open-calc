export const COURSES = [
  ...
  },
  {
    ...
    path: "/course/elec-2",
    desc: "Phasors, Impedance, Resonance, AC Power & Transformers",
    color: "cyan",
  },
  {
    key: "elec-3",
    ...
    path: "/course/elec-3",
    desc: "Diodes, Transistors, MOSFETs & Power Devices",
    color: "violet",
  },
  {
    key: "elec-4",
    label: "Amplifiers & Op-Amps",
    path: "/course/elec-4",
    desc: "BJT Amplifiers, Op-Amp Circuits & Feedback Theory",
    color: "indigo",
  },
  {
    key: "elec-5",
    label: "RF & Communications",
    path: "/course/elec-5",
    desc: "Modulation, Antennas, Propagation & Digital Comms",
    color: "teal",
  },
  {
    key: "elec-6",
    ...
    path: "/course/elec-6",
    desc: "Troubleshooting, EMC, Motor Drives, PLCs & Commissioning",
    color: "slate",
  },
  {
    key: "logic-0",
