export default {
  ...
  subtitle:
    "Factoring, conjugates, and completing the square — the moves that solve indeterminate forms",
  tags: [
    "algebra",
    "factoring",
    "conjugate",
  ...
  hook: {
    question:
      "Why does (x² − 4)/(x − 2) simplify to x + 2, and how does that help us compute the limit as x → 2?",
    realWorldContext:
    ...
    blocks: [
      {
        type: "prose",
        paragraphs: [
          "When you substitute x = 2 into (x² − 4)/(x − 2), you get 0/0, which is undefined. But this does not mean the limit does not exist—it means the limit is hiding behind a common factor that cancels away.",
          "The intuition is always the same: **find and remove the obstacle (the common factor) that makes direct substitution fail.** Once the obstacle is gone, you can substitute and compute the limit.",
        ],
      },
      {
        type: "viz",
        id: "Ch2_RopeBridge",
        title: "Story Mode: The Rope Bridge",
        mathBridge:
          "This story turns proportion solving into a first-principles equation-balance argument. It reinforces why cross-multiplication works and when proportional models are valid before formal limit algebra.",
        caption:
          "Narrative ratio/proportion challenge tied directly to algebraic manipulation habits used in calculus.",
      },
      {
        type: "callout",
        callout: {
      ...
      },
      {
        type: "prose",
        paragraphs: [
          "**Technique 1: Factor and Cancel** — If both numerator and denominator have a common factor (like (x − 2)), factor it out and cancel. Example: (x² − 4)/(x − 2) = (x − 2)(x + 2)/(x − 2) = x + 2 (for x ≠ 2). Now substitute.",
        ],
      },
      {
        type: "callout",
      ...
      },
      {
        ...
        caption:
          "A graph of (x^2-4)/(x-2) shows the hole at x=2 that algebraic cancellation removes for limit evaluation.",
        props: {
          fn: "(x*x - 4)/(x - 2)",
          xMin: -1,
          xMax: 5,
      ...
      },
      {
        type: "prose",
        paragraphs: [
          '**Technique 2: Multiply by a Conjugate** — When you see √A − √B, multiply top and bottom by √A + √B. The product (√A − √B)(√A + √B) = A − B, clearing the radicals and often creating a factorable form. This is pure pattern recognition: √A − √B signals "use the conjugate."',
          "**Technique 2b: Cube-Root Conjugate** — When you see ∛A − ∛B, the matching factor is (∛A² + ∛(AB) + ∛B²) because (u-v)(u²+uv+v²)=u³-v³. This is the cube-root analog and appears in harder limit problems.",
        ],
      },
      {
        type: "callout",
      ...
      },
      {
        type: "prose",
        paragraphs: [
          "**Technique 3: Find a Common Denominator** — Expressions like (1/(x + h) − 1/x) have fractions in the numerator. Combine them over a common denominator, simplify, and the result often factors.",
  ...
  examples: [
      ...
      steps: [
        {
          ...
          annotation: "Direct substitution: 0/0. Not helpful.",
        },
        {
          expression: "\\frac{(x-2)(x+2)}{x - 2}",
          annotation:
            "Factor numerator using {{algebra:difference-of-squares|difference of squares}}.",
        },
        {
          expression: "x + 2 \\quad (x \\neq 2)",
          annotation:
            "Cancel (x − 2). The functions are equal everywhere except at x = 2.",
        },
        {
          expression: "\\lim_{x \\to 2} (x + 2) = 4",
          annotation:
            "The simplified function has no obstacle at x = 2. Direct substitution works.",
        },
      ],
      conclusion:
        "The limit is 4. Geometrically: the original function has a removable hole at x = 2; after canceling, the hole is filled.",
...

    {
      ...
      steps: [
        {
          expression: "\\frac{\\sqrt{x+4} - 2}{x}",
          annotation: "Substitute x = 0: (√4 − 2)/0 = 0/0.",
        },
        {
          expression:
            "\\frac{\\sqrt{x+4} - 2}{x} \\cdot \\frac{\\sqrt{x+4} + 2}{\\sqrt{x+4} + 2}",
          annotation: "Multiply by conjugate.",
        },
        {
          expression: "\\frac{(\\sqrt{x+4})^2 - 2^2}{x(\\sqrt{x+4} + 2)}",
          annotation: "Numerator: (A − B)(A + B) = A² − B².",
        },
        {
          expression: "\\frac{x + 4 - 4}{x(\\sqrt{x+4} + 2)}",
          annotation: "Simplify.",
        },
        {
          expression: "\\frac{x}{x(\\sqrt{x+4} + 2)}",
          annotation: "Cancel x.",
        },
        { expression: "\\frac{1}{\\sqrt{x+4} + 2}", annotation: "For x ≠ 0." },
        {
          ...
          annotation: "Direct substitution now works.",
        },
      ],
      conclusion:
        "The limit is 1/4. The conjugate cleared the radical, revealing x as a common factor to cancel.",
      visualizationId: "FunctionPlotter",
      params: {
...

    {
      ...
      problem:
        "Compute \\lim_{h \\to 0} \\frac{\\frac{1}{2+h} - \\frac{1}{2}}{h}.",
      steps: [
        {
          expression: "\\frac{\\frac{1}{2+h} - \\frac{1}{2}}{h}",
          annotation:
            "Directly substituting h = 0 gives 0/0. Simplify the numerator first.",
        },
        {
          expression:
            "\\frac{1}{2+h} - \\frac{1}{2} = \\frac{2 - (2+h)}{(2+h) \\cdot 2}",
          annotation: "Find common denominator.",
        },
        {
          expression: "= \\frac{-h}{2(2+h)}",
          annotation: "Simplify numerator.",
        },
        {
          expression:
            "\\frac{\\frac{-h}{2(2+h)}}{h} = \\frac{-h}{h \\cdot 2(2+h)}",
          annotation: "Divide by h.",
        },
        {
      ...
      conclusion:
        "The limit is −1/4. This is the pattern for the derivative of 1/x by first principles.",
      visualizationId: "FunctionPlotter",
      params: {
        fn: "((1/(2 + x)) - (1/2))/x",
        xMin: -1.8,
...

    {
      ...
      steps: [
        {
          expression: "x^2 - 6x + 5",
          annotation: "Start here. Identify b = −6.",
        },
        {
          expression: "x^2 - 6x = (x - 3)^2 - 9",
          annotation:
            "Complete the square on the first two terms. (x − 3)² = x² − 6x + 9, so x² − 6x = (x − 3)² − 9.",
        },
        {
          expression: "(x - 3)^2 - 9 + 5",
          annotation: "Add back the constant term.",
        },
        { expression: "(x - 3)^2 - 4", annotation: "Simplify." },
      ],
      conclusion:
        "The vertex form is (x − 3)² − 4. The vertex is at (3, −4). The geometric picture: the parabola is shifted 3 units right and 4 units down.",
      visualizationId: "FunctionPlotter",
      params: {
        fn: "x*x - 6*x + 5",
        xMin: -1,
...

    {
      ...
      problem:
        "Factor x³ − 8, then compute \\lim_{x \\to 2} \\frac{x^3 - 8}{x^2 - 4}.",
      steps: [
        {
          expression: "x^3 - 8 = x^3 - 2^3",
          annotation:
            "Recognize as a {{algebra:difference-of-cubes|difference of cubes}}.",
        },
        {
          expression: "= (x - 2)(x^2 + 2x + 4)",
          annotation: "Apply a³ − b³ = (a − b)(a² + ab + b²).",
        },
        {
          expression: "x^2 - 4 = (x - 2)(x + 2)",
          annotation: "Factor the denominator as difference of squares.",
        },
        {
          expression: "\\frac{(x-2)(x^2+2x+4)}{(x-2)(x+2)}",
          annotation: "Rewrite the original fraction.",
        },
        {
          expression: "= \\frac{x^2 + 2x + 4}{x + 2} \\quad (x \\neq 2)",
          annotation: "Cancel (x − 2).",
        },
        {
          expression:
      ...
      conclusion:
        "The limit is 3. Both numerator and denominator had (x − 2) as a factor; canceling it removed the singularity.",
      visualizationId: "FunctionPlotter",
      params: {
        fn: "(x*x*x - 8)/(x*x - 4)",
        xMin: -1,
    ...
    },
    {
      ...
      steps: [
        {
          expression: "\\frac{\\sqrt[3]{x} - 2}{x - 8}",
          annotation: "Direct substitution gives 0/0.",
        },
        {
          expression:
            "\\frac{\\sqrt[3]{x} - 2}{x - 8} \\cdot \\frac{(\\sqrt[3]{x})^2 + 2\\sqrt[3]{x} + 4}{(\\sqrt[3]{x})^2 + 2\\sqrt[3]{x} + 4}",
          annotation: "Use (u-v)(u²+uv+v²)=u³-v³ with u=∛x, v=2.",
        },
        {
          expression:
            "= \\frac{x - 8}{(x-8)\\left((\\sqrt[3]{x})^2 + 2\\sqrt[3]{x} + 4\\right)}",
          annotation: "Numerator collapses to u³-v³ = x-8.",
        },
        {
          expression: "= \\frac{1}{(\\sqrt[3]{x})^2 + 2\\sqrt[3]{x} + 4}",
          annotation: "Cancel x-8 for x ≠ 8.",
        },
        {
          expression: "\\lim_{x \\to 8} = \\frac{1}{4 + 4 + 4} = \\frac{1}{12}",
          annotation: "Now substitute x=8, so ∛x=2.",
        },
      ],
      conclusion:
        "The limit is 1/12. This is the exact cube-root analog of the square-root conjugate trick.",
    },
  ],
  ...
  challenges: [
    {
      ...
      walkthrough: [
        {
          expression: "\\frac{x^2 - 9}{x^2 - 3x} = \\frac{(x-3)(x+3)}{x(x-3)}",
          annotation:
            "Factor: difference of squares in numerator, factor out x in denominator.",
        },
        {
          expression: "= \\frac{x+3}{x} \\quad (x \\neq 3)",
          annotation: "Cancel (x − 3).",
        },
        {
          expression: "\\lim_{x \\to 3} \\frac{x+3}{x} = \\frac{6}{3} = 2",
          annotation: "Direct substitution.",
        },
      ],
      answer: "2",
...

    {
      ...
      walkthrough: [
        {
          expression:
            "\\frac{\\sqrt{5x-1} - 2}{x - 1} \\cdot \\frac{\\sqrt{5x-1} + 2}{\\sqrt{5x-1} + 2}",
          annotation: "Multiply by conjugate.",
        },
        {
          expression: "= \\frac{(5x-1) - 4}{(x-1)(\\sqrt{5x-1} + 2)}",
          annotation: "Numerator: (A − B)(A + B) = A² − B².",
        },
        {
          expression: "= \\frac{5x - 5}{(x-1)(\\sqrt{5x-1} + 2)}",
          annotation: "Simplify.",
        },
        {
          expression: "= \\frac{5(x-1)}{(x-1)(\\sqrt{5x-1} + 2)}",
          annotation: "Factor out 5 in the numerator.",
        },
        {
          expression: "= \\frac{5}{\\sqrt{5x-1} + 2} \\quad (x \\neq 1)",
          annotation: "Cancel (x − 1).",
        },
        {
          expression:
            "\\lim_{x \\to 1} \\frac{5}{\\sqrt{5 \\cdot 1 - 1} + 2} = \\frac{5}{\\sqrt{4} + 2} = \\frac{5}{4}",
          annotation: "Direct substitution.",
        },
      ],
      answer: "\\frac{5}{4}",
  ...
  crossRefs: [
    {
      ...
      label: "Limits Introduction",
      context:
        "These algebraic moves are essential for resolving 0/0 indeterminate forms.",
    },
    {
      lessonSlug: "differentiation-rules",
      label: "Differentiation Rules",
      context:
        "The product rule, quotient rule, and chain rule proofs use these same algebraic techniques.",
    },
  ],
