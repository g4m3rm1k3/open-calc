export default {
  ...
  intuition: {
    prose: [
      'An **inequality** is a statement that one quantity is less than, greater than, or not equal to another. Where equations give you exact answers (often a single number), inequalities give you **ranges** — entire intervals of numbers that satisfy a condition.',

      'The simplest inequalities are **linear**: $2x + 3 > 7$ solves the same way as an equation, with one critical rule — **if you multiply or divide both sides by a negative number, you must flip the inequality sign**. This is the single most common source of errors in algebra. Why does it flip? Because multiplying by −1 reverses the order of the number line: 3 > 2 but −3 < −2.',

      '**Polynomial inequalities** like $x^2 - 4x + 3 > 0$ require a different strategy. You cannot just "solve for x" because the expression changes sign at different points. The strategy is: (1) factor, (2) find the **critical points** (zeros of each factor), (3) make a **sign chart** showing the sign of each factor in each interval, (4) combine to determine where the product is positive or negative.',
    ...
    callouts: [
      {
        type: 'intuition',
        title: 'Inequalities Describe Regions',
        body: 'An equation like x² = 4 gives discrete points (x = ±2). An inequality like x² < 4 gives a whole region: the interval (−2, 2). Inequalities describe WHERE something is true on the number line.',
      },
      {
        type: 'misconception',
        title: 'Never Multiply by an Unknown-Sign Expression',
        body: 'When solving (x+1)/(x−2) ≤ 0, do NOT multiply both sides by (x−2). You do not know if (x−2) is positive or negative, so you do not know whether to flip the sign. Instead, use a sign chart.',
      },
      {
        type: 'technique',
        title: 'The Sign Chart Method',
        body: '1. Move everything to one side (compare to 0). 2. Factor completely. 3. Find all zeros and undefined points. 4. Mark them on a number line. 5. Test the sign of each factor in each interval. 6. Multiply signs to get the overall sign.',
      },
      {
        type: 'tip',
        title: 'Open vs. Closed at Critical Points',
        body: 'For strict inequalities (< or >), critical points are excluded (open circles). For non-strict (≤ or ≥), zeros of the numerator are included (filled circles), but zeros of the denominator are ALWAYS excluded.',
      },
    ],
    visualizations: [
      { id: 'NumberLine', title: 'Number Line Visualization', caption: 'Visualize solution sets as intervals on the number line.' },
    ],
  },
