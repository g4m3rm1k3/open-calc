export default {
  ...
  subtitle: 'Locating a value within a distribution — ranks, quartiles, and z-scores.',
  tags: ['percentile', 'quartile', 'Q1', 'Q2', 'Q3', 'z-score', 'standardization', 'rank', 'cumulative frequency'],
  aliases: 'percentile quartile Q1 Q2 Q3 z-score standardize rank cumulative frequency interquartile range percentile rank percentile score',
  timeToComplete: 35,
...
`,
  ...
  examples: [
    {
      ...
      difficulty: 'easy',
      problem: 'Dataset: [3, 7, 8, 10, 12, 14, 17, 21, 25, 30] (n=10). Find Q1, Q2, Q3, IQR.',
      steps: [
        { expression: '\\text{Already sorted: } [3, 7, 8, 10, 12, 14, 17, 21, 25, 30]', annotation: 'Data is already in ascending order.', strategyTitle: 'Step 1: Sort' },
        { expression: 'Q2 = \\frac{x_{(5)} + x_{(6)}}{2} = \\frac{12 + 14}{2} = 13', annotation: 'n=10 (even). Q2 = average of 5th and 6th values = (12+14)/2 = 13.', strategyTitle: 'Step 2: Q2 (median)' },
        { expression: '\\text{Lower half: } [3, 7, 8, 10, 12]', annotation: 'First 5 values (below median).', strategyTitle: 'Step 3: Split' },
        { expression: 'Q1 = x_{(3)} = 8 \\text{ (middle of lower half)}', annotation: 'Lower half has 5 values; middle is position 3. Q1 = 8.', strategyTitle: 'Step 4: Q1' },
        { expression: '\\text{Upper half: } [14, 17, 21, 25, 30]; \\quad Q3 = x_{(3)} = 21', annotation: 'Upper half has 5 values; middle is position 3. Q3 = 21.', strategyTitle: 'Step 5: Q3' },
        { expression: 'IQR = Q3 - Q1 = 21 - 8 = 13', annotation: 'The middle 50% of the data spans from 8 to 21, a range of 13 units.', strategyTitle: 'Step 6: IQR' },
      ],
    },
    {
      id: 'stat3-003-ex2',
      ...
      difficulty: 'medium',
      problem: 'Adult heights in a population are normally distributed with mean 68 inches and SD 3 inches. (a) Find the z-score for a person who is 74 inches tall. (b) Find the z-score for a person who is 62 inches tall. (c) What height corresponds to z = +1.5?',
      steps: [
        { expression: 'z_{74} = \\frac{74 - 68}{3} = \\frac{6}{3} = +2.00', annotation: 'A person 74 inches tall is 2 standard deviations above the mean. For a normal distribution, this is about the 97.7th percentile.', strategyTitle: '(a) z for 74 inches' },
        { expression: 'z_{62} = \\frac{62 - 68}{3} = \\frac{-6}{3} = -2.00', annotation: 'A person 62 inches tall is 2 standard deviations below the mean. About the 2.3rd percentile.', strategyTitle: '(b) z for 62 inches' },
        { expression: 'x = \\mu + z \\cdot \\sigma = 68 + 1.5 \\times 3 = 68 + 4.5 = 72.5 \\text{ inches}', annotation: 'Reverse the z-score formula: x = μ + z×σ. A z-score of +1.5 corresponds to 72.5 inches — about the 93rd percentile for a normal distribution.', strategyTitle: '(c) Height for z = +1.5' },
      ],
    },
    {
      id: 'stat3-003-ex3',
      ...
      difficulty: 'easy',
      problem: 'Class exam scores: [55, 62, 68, 72, 75, 78, 80, 82, 85, 88, 90, 94]. A student scored 82. What is their percentile rank?',
      steps: [
        { expression: '\\text{Count values below 82: } 55, 62, 68, 72, 75, 78, 80 \\rightarrow 7 \\text{ values}', annotation: 'Seven scores are strictly less than 82.', strategyTitle: 'Step 1: Count below' },
        { expression: '\\text{Percentile rank} = \\frac{7}{12} \\times 100\\% = 58.3\\%', annotation: 'Approximately the 58th percentile. The student scored higher than about 58% of the class.', strategyTitle: 'Step 2: Compute rank' },
        { expression: '\\text{Interpretation: better than ~58\\% of classmates}', annotation: 'A score of 82 sounds like a "B" grade, but contextually it is a relatively average performance — it is below the class median.', strategyTitle: 'Step 3: Interpret' },
      ],
    },
  ],
  ...
  challenges: [
    {
      ...
      difficulty: 'medium',
      problem: 'Weights of cereal boxes are normally distributed with mean 16.00 oz and SD 0.12 oz. (a) What weight corresponds to the 97.5th percentile? (b) What weight corresponds to the 2.5th percentile? (c) What percentage of boxes have weight within [15.76, 16.24] oz?',
      walkthrough: [
        { expression: 'z_{97.5\\%} \\approx +1.96 \\text{ (from z-table)}', annotation: 'The 97.5th percentile of the standard normal distribution corresponds to z ≈ +1.96. (Exact: 1.959964.)' },
        { expression: '\\text{Weight at 97.5th percentile: } x = 16.00 + 1.96(0.12) = 16.00 + 0.235 = 16.235 \\text{ oz}', annotation: 'Use x = μ + z×σ.' },
        { expression: '\\text{Weight at 2.5th percentile: } x = 16.00 - 1.96(0.12) = 15.765 \\text{ oz}', annotation: 'By symmetry, z = −1.96 corresponds to the 2.5th percentile.' },
        { expression: 'z_{15.76} = (15.76-16.00)/0.12 = -0.24/0.12 = -2.0, \\quad z_{16.24} = (16.24-16.00)/0.12 = +2.0', annotation: '15.76 and 16.24 are exactly ±2 SDs from the mean.' },
        { expression: '\\text{Empirical Rule: 95\\% of values within 2 SDs. So 95\\% of boxes are in [15.76, 16.24] oz.}', annotation: 'The interval [15.76, 16.24] spans mean ± 2×SD. By the Empirical Rule, about 95% of normally distributed values fall within 2 SDs.' },
      ],
      answer: 'Weight at 97.5th percentile ≈ 16.24 oz; at 2.5th percentile ≈ 15.77 oz. About 95% of boxes weigh between 15.76 and 16.24 oz.',
    },
    {
      id: 'stat3-003-ch2',
      title: 'Build the five-number summary and detect outliers',
      difficulty: 'medium',
      problem: 'Delivery times (days): [1, 2, 2, 3, 3, 3, 4, 4, 5, 6, 6, 7, 8, 9, 32]. Find the five-number summary, IQR, outlier fences, and identify outliers.',
      walkthrough: [
        { expression: '\\text{Sorted (n=15): } [1,2,2,3,3,3,4,4,5,6,6,7,8,9,32]', annotation: 'Already sorted. n=15 (odd).' },
        { expression: 'Q2 = x_{(8)} = 4 \\quad \\text{(middle value at position (15+1)/2 = 8)}', annotation: 'Median = 4 days.' },
        { expression: '\\text{Lower half: } [1,2,2,3,3,3,4] \\quad Q1 = x_{(4)} = 3', annotation: 'Lower half is the first 7 values (excluding median). Q1 = middle = 4th value = 3.' },
        { expression: '\\text{Upper half: } [5,6,6,7,8,9,32] \\quad Q3 = x_{(4)} = 7', annotation: 'Upper half is the last 7 values. Q3 = middle = 4th value of upper half = 7.' },
        { expression: 'IQR = 7 - 3 = 4; \\quad \\text{Lower fence} = 3 - 6 = -3; \\quad \\text{Upper fence} = 7 + 6 = 13', annotation: 'Fences: Q1−1.5×IQR = 3−6 = −3 and Q3+1.5×IQR = 7+6 = 13.' },
        { expression: '\\text{Outlier: 32 > 13 (upper fence). Five-number: {1, 3, 4, 7, 32}}', annotation: 'The value 32 is beyond the upper fence → flagged as outlier. The 32-day delivery is anomalous — worth investigating.' },
      ],
      answer: 'Five-number: {1, 3, 4, 7, 32}. IQR=4. Upper fence=13. Outlier: 32 (32 > 13).',
    },
  ],

  semantics: {
    core: [
      { symbol: 'Q1, Q2, Q3', meaning: '25th, 50th, 75th percentiles. Quartiles divide data into four equal groups.' },
      { symbol: 'z = (x - \\mu)/\\sigma', meaning: 'Z-score = number of standard deviations x is from the mean. Dimensionless.' },
      { symbol: 'x = \\mu + z \\cdot \\sigma', meaning: 'Reverse z-score formula: find original value given z, mean, and SD.' },
      { symbol: '\\text{Lower fence} = Q1 - 1.5 \\times IQR', meaning: 'Tukey lower outlier threshold.' },
      { symbol: '\\text{Upper fence} = Q3 + 1.5 \\times IQR', meaning: 'Tukey upper outlier threshold.' },
      { symbol: 'L = (p/100) \\times n', meaning: 'Percentile position formula. Round up if L is not a whole number.' },
    ],
    rulesOfThumb: [
  ...
  spiral: {
    recoveryPoints: [],
    futureLinks: [
      { lessonId: 'stat3-004', label: 'Boxplots', note: 'Boxplots visually display the five-number summary and Tukey outlier fences.' },
      { lessonId: 'stat6-003', label: 'Confidence Intervals', note: 'The z-score formula z = (x̄ - μ)/(σ/√n) and z-table percentiles (z=1.96 for 95%) are the basis of confidence intervals.' },
      { lessonId: 'stat5-002', label: 'Normal Distribution', note: 'stat5 develops z-to-percentile conversion formally using the standard normal CDF.' },
    ],
  },

  checkpoints: [
    { id: 'cp-stat3-003-1', label: 'Read: define the pth percentile in your own words', type: 'read' },
    { id: 'cp-stat3-003-2', label: 'Read: state the procedure for finding Q1, Q2, Q3 by the split-at-median method', type: 'read' },
    { id: 'cp-stat3-003-3', label: 'Apply example 1: find Q1, Q2, Q3 for [3,7,8,10,12,14,17,21,25,30] before reading', type: 'example' },
    { id: 'cp-stat3-003-4', label: 'Lab: run cell 1 and verify the outlier fences — are there any outliers in the exam data?', type: 'lab' },
    { id: 'cp-stat3-003-5', label: 'Apply example 2: compute all three z-scores before reading', type: 'example' },
    { id: 'cp-stat3-003-6', label: 'Lab: run cell 2 and verify z-score mean ≈ 0 and SD ≈ 1 after standardization', type: 'lab' },
    { id: 'cp-stat3-003-7', label: 'Attempt challenge 2: build the five-number summary and find the outlier', type: 'challenge' },
    { id: 'cp-stat3-003-8', label: 'Read: explain why z-scores enable cross-distribution comparison', type: 'read' },
  ],
  ...
  quiz: [
    {
      ...
      options: ['5', '7', '6', '5.5'],
      answer: '6',
      hints: ['n=8: Q2 = (9+11)/2 = 10. Lower half = [2,5,7,9].', 'Q1 = median of lower half [2,5,7,9] = (5+7)/2 = 6.'],
    ...
    },
    {
      ...
      hints: ['The Empirical Rule: 99.7% of normal data is within 3 SDs.', 'Less than 0.3% total outside 3 SDs → less than 0.15% above z=+3.'],
    ...
    },
    {
      ...
      answer: '65',
      hints: ['Reverse z-score formula: x = mean + z × SD.', '70 + (−0.5)(10) = 70 − 5 = 65.'],
    ...
    },
    {
      ...
      hints: ['Percentile rank is about relative position, not absolute score.', 'The 90th percentile: 90% of values are below yours.'],
      reviewSection: 'Intuition → "Percentile: location in a distribution" paragraph',
    },
    {
      id: 'stat3-003-quiz-6',
      type: 'choice',
      text: 'After standardizing a dataset to z-scores, the new mean and SD are:',
      options: ['Mean=1, SD=0', 'Mean=0, SD=1', 'Mean=original mean, SD=1', 'Mean=0, SD=original SD'],
      answer: 'Mean=0, SD=1',
      hints: ['Standardization: z = (x − mean)/SD shifts mean to 0 and scales SD to 1.', 'This is the definition of the standard normal distribution.'],
  ...
  misconceptions: [
    {
      falseBelief: 'The percentile rank equals the percentage of correct answers.',
      whyStudentsThinkIt: 'The word "percentile" sounds like "percent" — students confuse the relative measure (position in distribution) with an absolute measure (percent correct).',
      ...
      contrastCase: 'If someone says their GRE score is "in the 94th percentile," they mean they scored higher than 94% of all test-takers. If they say they got "94% correct," they mean they answered 94 out of 100 questions right. Both involve the number 94 but mean completely different things.',
    },
    {
      falseBelief: 'A z-score of +2 means the same percentile in any distribution.',
      whyStudentsThinkIt: 'Students learn z=+2 ≈ 97.7th percentile from the normal distribution and apply this to any distribution.',
      ...
      contrastCase: 'For a known normal distribution, z=+2 reliably gives the 97.7th percentile. For income data (always right-skewed), use actual percentile ranks from the data rather than the normal approximation.',
    },
    {
      falseBelief: 'Quartiles always divide the data into groups of exactly equal size.',
      whyStudentsThinkIt: 'Students hear "quartiles divide data into four equal groups" and interpret "equal" as "same number of observations."',
      ...
      contrastCase: 'For large n (e.g., 1 million observations), the groups will each contain very close to 25% of observations. The equal-group interpretation becomes approximately true only for large datasets.',
    },
  ],

  transferPrompts: [
    {
      situation: 'A company screens job applicants using a cognitive test. The test has mean 100 and SD 15 in the general population. The company wants to only interview applicants scoring above the 90th percentile.',
      competingTechniques: ['Set a cutoff of score > 115 (mean + 1 SD)', 'Compute z-score for each applicant and flag z > 1.28', 'Rank all applicants and take the top 10%'],
      whyThisTechniqueWins: 'Z-score cutoff at z > 1.28 (the exact 90th percentile of the normal distribution): 1.28 = Φ⁻¹(0.90). This is the principled approach when the distribution is known to be approximately normal. Setting score > 115 (mean + 1 SD) gives the 84th percentile, not the 90th — the wrong threshold. Ranking all applicants and taking the top 10% is equivalent but requires all scores to be collected first. The z-score cutoff can be applied immediately to each incoming score.',
    },
    {
      situation: 'A financial analyst wants to flag unusual daily stock returns for further investigation. Over the past year (252 trading days), returns have mean +0.03% and SD 1.2%.',
      competingTechniques: ['Flag returns outside [−2%, +2%]', 'Flag returns with |z| > 2 (2 SDs from mean)', 'Flag the top and bottom 2.5% of actual returns'],
      whyThisTechniqueWins: 'The three methods give almost the same threshold here (|z| > 2 ↔ outside [0.03 − 2.4%, 0.03 + 2.4%] = [−2.37%, +2.43%]), but z-score-based flagging scales automatically if the distribution changes (new market regime with higher volatility). The flat [−2%, +2%] threshold is arbitrary. Flagging actual top/bottom 2.5% is robust but always flags the same count regardless of whether returns are truly extreme. Z-score flagging balances principled thresholds with distribution-awareness.',
    },
  ],

  debugging: [
    {
      commonError: 'Q3 computed as the upper quartile of the entire dataset instead of the upper half.',
      symptom: 'For [1,3,5,7,9], you report Q3=9 (max) instead of Q3=8 (average of 7 and 9).',
      whyItHappened: 'Q3 is the median of the upper half, not the maximum. The upper half of [1,3,5,7,9] (n=5) is [7,9] (values above the median of 5). Median of [7,9] = (7+9)/2 = 8.',
      repairStrategy: 'Step: (1) Find median (Q2). (2) Split at Q2. (3) Find median of upper half → Q3. Upper half is all values greater than Q2 (for odd n, do not include Q2 itself). For [1,3,5,7,9]: Q2=5, upper half = [7,9], Q3=(7+9)/2=8.',
    },
    {
      commonError: 'Forgetting to sort data before finding percentiles.',
      symptom: 'You find the "middle value" of unsorted data and get a wrong answer.',
      whyItHappened: 'Percentiles are defined on the sorted order of the data. The "5th value" in the original order is meaningless. You need the 5th smallest value.',
      repairStrategy: 'Always sort first: `data_sorted = sorted(data)`. Then apply the percentile position formula to `data_sorted`. If using pandas: `df["col"].quantile(0.25)` handles sorting internally.',
    },
  ],

  mastery: {
    targetLevel: 'Apply (Level 3) — compute Q1/Q2/Q3 by the split-at-median method, compute and interpret z-scores, reverse-compute original values from z-scores, and apply Tukey outlier fences.',
    solveIndependently: 'Given an unsorted dataset of 8–15 values, compute the five-number summary, IQR, Tukey fences, identify outliers, and compute the z-score of any specified value.',
    explainVerbally: 'Explain why z-scores enable comparison across different distributions and why converting z to a percentile requires the distribution to be approximately normal.',
    detectIncorrectApplication: 'Identify errors when: (1) quartiles are found without sorting; (2) z = +2 is claimed to be the 97.7th percentile of a heavily skewed distribution; (3) "80th percentile" is interpreted as "scored 80% correct."',
    transferToUnfamiliar: 'Given a novel context (blood pressure readings, athletic performance times, financial returns), compute z-scores for specified values, build the five-number summary, and flag outliers using Tukey fences.',
  },
};
