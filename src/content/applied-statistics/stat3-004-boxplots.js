export default {
  ...
  title: "Boxplots",
  subtitle:
    "Visualizing the five-number summary — distributions, outliers, and group comparisons.",
  tags: [
    "boxplot",
    "five-number summary",
    "outlier",
  ...
  aliases:
    "boxplot box plot box and whisker five number summary outlier detection Tukey fence whiskers side by side comparison fig.boxplot",
  timeToComplete: 40,
  coreConcept:
...
`,
        instructions:
          "Compare the three methods: which has the highest median? Which is most consistent (smallest IQR)? Which has the most extreme spread? Method B likely has outliers on both ends (high variability). Method C is likely the tightest cluster (smallest IQR, most consistent results).",
      },
    ],
  },
  ...
  examples: [
    {
      ...
      difficulty: "easy",
      problem:
        "Dataset: [4, 7, 8, 10, 11, 12, 14, 17, 19, 24, 56]. Construct the boxplot (find all five-number summary values, fences, and identify any outliers).",
      steps: [
        {
          expression:
            "\\text{Sorted (n=11): } [4, 7, 8, 10, 11, 12, 14, 17, 19, 24, 56]",
          annotation: "n=11 (odd). Already sorted.",
          strategyTitle: "Step 1: Sort",
        },
        {
          expression:
            "Q2 = x_{(6)} = 12 \\quad \\text{(middle value, position (11+1)/2=6)}",
          annotation: "Median = 12 (6th value).",
          strategyTitle: "Step 2: Q2",
        },
        {
          expression:
            "\\text{Lower half: } [4,7,8,10,11]; \\quad Q1 = x_{(3)} = 8",
          annotation: "5 values in lower half; middle is position 3. Q1 = 8.",
          strategyTitle: "Step 3: Q1",
        },
        {
          expression:
            "\\text{Upper half: } [14,17,19,24,56]; \\quad Q3 = x_{(3)} = 19",
          annotation: "5 values in upper half; middle is position 3. Q3 = 19.",
          strategyTitle: "Step 4: Q3",
        },
        {
          expression:
            "IQR = 19-8=11; \\quad L = 8-16.5=-8.5; \\quad U = 19+16.5=35.5",
          annotation:
            "IQR=11. Lower fence = 8−1.5×11 = −8.5. Upper fence = 19+1.5×11 = 35.5.",
          strategyTitle: "Step 5: Fences",
        },
        {
          expression:
            "\\text{Outlier: 56 > 35.5. Whiskers: lower}=4, \\text{upper}=24",
          annotation:
            "56 is beyond the upper fence → outlier. Upper whisker tip = 24 (largest value ≤ 35.5). Lower whisker tip = 4 (smallest value ≥ −8.5). Boxplot: box from 8 to 19, median line at 12, lower whisker at 4, upper whisker at 24, dot at 56.",
          strategyTitle: "Step 6: Boxplot",
        },
      ],
    },
    {
      ...
      difficulty: "medium",
      problem:
        "Two schools: School A has Q1=70, median=78, Q3=85. School B has Q1=65, median=75, Q3=88. School A has no outliers; School B has two outliers at 102 and 108. (a) Which school has higher typical performance? (b) Which is more consistent? (c) How do outliers affect interpretation?",
      steps: [
        {
          expression:
            "\\text{School A median} = 78 > \\text{School B median} = 75",
          annotation:
            "School A has higher typical performance (higher median by 3 points).",
          strategyTitle: "(a) Center comparison",
        },
        {
          expression: "IQR_A = 85-70=15; \\quad IQR_B = 88-65=23",
          annotation:
            "School A has IQR=15; School B has IQR=23. School A is more consistent — the middle 50% spans 15 points vs. 23 points for School B.",
          strategyTitle: "(b) Spread comparison",
        },
        {
          expression:
            "\\text{School B mean} > \\text{School B median due to outliers at 102, 108}",
          annotation:
            "The two high outliers at 102 and 108 pull School B's mean above its median. If decision-makers use the mean, School B may appear comparable to or even better than School A. The boxplot correctly shows School A has a higher median and tighter spread — a more reliably high-performing school. The outliers represent exceptional students, not the typical experience.",
          strategyTitle: "(c) Outlier effect",
        },
      ],
    },
    {
      ...
      difficulty: "medium",
      problem:
        "A boxplot has: Q1=20, median=30, Q3=45, lower whisker=10, upper whisker=65, no outliers. (a) Is the distribution skewed? (b) In which direction?",
      steps: [
        {
          expression:
            "\\text{Median position in box: } \\frac{30-20}{45-20} = \\frac{10}{25} = 40\\% \\text{ from bottom}",
          annotation:
            "The median is 40% of the way up from Q1 to Q3. If centered, it would be 50%. Being below center suggests right skew.",
          strategyTitle: "Signal 1: Median position",
        },
        {
          expression:
            "\\text{Lower whisker length: } 20-10=10; \\quad \\text{Upper whisker length: } 65-45=20",
          annotation:
            "Upper whisker (20) is twice as long as lower whisker (10). Longer upper whisker → right (positive) skew.",
          strategyTitle: "Signal 2: Whisker lengths",
        },
        {
          expression:
            "\\text{Right-skewed: median below center of box AND upper whisker longer}",
          annotation:
            "Both signals point to right skew. The distribution has a longer tail on the right side. Mean > median likely. This is consistent with income data, wait times, or any non-negative variable with rare high values.",
  ...
  challenges: [
    {
      ...
      difficulty: "hard",
      problem:
        "A boxplot shows: lower whisker at 12, Q1=20, median=28, Q3=38, upper whisker at 50, one outlier at 70. What can and cannot be determined from this boxplot alone?",
      walkthrough: [
        {
          expression: "IQR = 38-20=18; \\quad L=20-27=-7; \\quad U=38+27=65",
          annotation:
            "We can compute IQR=18 and Tukey fences (−7, 65). The outlier at 70 > 65 confirms it is beyond the upper fence.",
        },
        {
          expression:
            "\\text{CANNOT determine: exact n, individual data values, whether there are 2 values at 20, etc.}",
          annotation:
            "Boxplots summarize the distribution but lose individual data points. We know quartile positions and outlier locations but not exactly how many data points fall between Q1 and Q3, or the exact shape within the box.",
        },
        {
          expression:
            "\\text{CAN determine: center (median=28), spread (IQR=18), skewness (upper whisker 50−38=12 > lower whisker 20−12=8 → mild right skew), and the presence of one outlier at 70}",
          annotation:
        ...
        {
          expression:
            "\\text{Mean can only be approximated: mean} \\approx 29{-}32 \\text{ (pulled up by outlier)}",
          annotation:
            "The outlier at 70 will pull the mean above the median of 28. Without knowing n and all individual values, we cannot compute the exact mean from a boxplot.",
        },
      ],
      answer:
        "From the boxplot: IQR=18, Tukey fences=(−7, 65), one outlier at 70, mild right skew (upper whisker > lower whisker, median slightly below center of box). Cannot determine: exact n, individual values between quartiles, or exact mean.",
    },
    {
      id: "stat3-004-ch2",
      ...
      difficulty: "medium",
      problem:
        "Drug trial: Group A (placebo): Q1=45, median=52, Q3=58, min=38, max=71. Group B (treatment): Q1=38, median=60, Q3=72, min=30, max=95, one outlier at 95. IQR_A=13, IQR_B=34. Which group shows a more pronounced treatment effect, and what are the tradeoffs?",
      walkthrough: [
        {
          expression:
            "\\text{Group A (placebo): median=52, IQR=13 — tight, symmetric-ish}",
          annotation:
            "Placebo group has a centered median and small IQR. Consistent response with low variability.",
        },
        {
          expression:
            "\\text{Group B (treatment): median=60, IQR=34 — higher center, much more variable}",
          annotation:
            "Treatment group has a higher median (+8 points above placebo), suggesting a positive treatment effect. But IQR is 34 vs. 13 — much more variable. The treatment works for some patients much better than others.",
        },
        {
          expression:
            "\\text{Outlier at 95: far beyond upper fence } (72+51=123) — \\text{wait, 95 < 123, so NOT an outlier by Tukey rule}",
          annotation:
            "Upper fence = Q3+1.5×IQR = 72+51 = 123. Value 95 < 123. So 95 is actually NOT a Tukey outlier — it is just the maximum. The problem statement calling it an outlier may reflect clinical judgment (unusually high response), not a statistical outlier. This illustrates that domain outlier definitions sometimes differ from statistical ones.",
        },
        {
          expression:
            "\\text{Conclusion: treatment raises the median but dramatically increases variability}",
          annotation:
            "Treatment effect: median increases 8 points (52→60). Tradeoff: IQR triples (13→34), indicating the treatment is highly heterogeneous — works remarkably well for some patients but may underperform for others. Further analysis (subgroup analysis) would be warranted.",
        },
      ],
      answer:
        "Treatment raises median from 52 to 60 (+8 points), but triples variability (IQR 13→34). The value 95 is NOT a Tukey outlier. Treatment is effective on average but highly heterogeneous.",
    },
    ,
    {
      id: "stat3-004-ch3",
  ...
  semantics: {
    core: [
      {
        symbol: "\\text{Box: Q1 to Q3}",
        meaning: "The box contains the middle 50% of data. Box height = IQR.",
      },
      {
        symbol:
          "\\text{Whisker endpoint} = \\text{farthest non-outlier within 1.5×IQR}",
        meaning:
          "Whiskers do NOT always reach min/max — only to the outermost non-outlier value.",
      },
      {
        symbol:
          "\\text{Outlier: } x < Q1-1.5 \\times IQR \\text{ or } x > Q3+1.5 \\times IQR",
        meaning:
          "Tukey outlier flag — plotted as individual points beyond the whiskers.",
      },
      {
        symbol: "\\text{Median line position within box → skewness}",
        meaning:
          "Median below center → right skew. Median above center → left skew. Centered → symmetric.",
      },
      {
        symbol: "\\text{Side-by-side boxplots}",
        meaning:
          "Multiple groups on one axis, same scale. Standard tool for group comparison.",
      },
    ],
    rulesOfThumb: [
    ...
    futureLinks: [
      {
        ...
        note: "Frequency tables quantify the same distribution that boxplots display graphically.",
      },
      {
        lessonId: "stat6-004",
        label: "Non-parametric Tests",
        note: "Boxplot comparisons lead naturally to rank-based tests (Mann-Whitney U, Kruskal-Wallis) for comparing medians without assuming normality.",
      },
      {
        lessonId: "stat8-002",
        label: "Regression Diagnostics",
        note: "Boxplots of residuals are standard in regression diagnostics to check for outliers and symmetry.",
      },
    ],
  },
  ...
  checkpoints: [
    {
      id: "cp-stat3-004-1",
      label:
        "Read: identify all six parts of a boxplot (box, median, whiskers, outliers, fences)",
      type: "read",
    },
    {
      id: "cp-stat3-004-2",
      label: "Read: state the Tukey fence formulas and what they determine",
      type: "read",
    },
    {
      id: "cp-stat3-004-3",
      label:
        "Apply example 1: construct the boxplot for [4,7,8,10,11,12,14,17,19,24,56] before reading",
      type: "example",
    },
    {
      id: "cp-stat3-004-4",
      label: "Lab: run cell 1 and identify the outlier in the salary data",
      type: "lab",
    },
    {
      id: "cp-stat3-004-5",
      label:
        "Apply example 3: predict the skewness direction from whisker lengths before reading",
      type: "example",
    },
    {
      id: "cp-stat3-004-6",
      label:
        "Lab: run cell 2 and compare methods A, B, C — which is most consistent?",
      type: "lab",
    },
    {
      id: "cp-stat3-004-7",
      label:
        "Attempt challenge 1: list what can and cannot be determined from a boxplot alone",
      type: "challenge",
    },
    {
      id: "cp-stat3-004-8",
      label: "Read: explain why boxplots can hide bimodality",
      type: "read",
    },
  ],
  ...
  quiz: [
    ...
    },
    {
      ...
      hints: [
        "60 > 55 (upper fence) → outlier.",
        "Outliers are plotted as individual dots; whisker stops at 50.",
      ],
    ...
    },
    {
      ...
      hints: [
        "Long upper whisker → long right tail.",
        "Median near Q1 (bottom of box) → more data bunched at lower values, tail toward high values.",
      ],
    ...
    },
    {
      ...
      answer:
        "They can hide bimodality — two groups with different modes may look identical",
      hints: [
        "A bimodal distribution can have the same quartiles as a unimodal one.",
        "Boxplots summarize position statistics; they do not show the shape within groups.",
      ],
    ...
    },
    {
      ...
      hints: [
        "Side-by-side boxplots show center, spread, outliers, and skewness for multiple groups on one axis.",
        "Bar charts of averages hide the spread; pie charts do not show distribution shape.",
      ],
      reviewSection:
  ...
  misconceptions: [
    {
      ...
      whyStudentsThinkIt:
        'Some textbooks (and older software) draw boxplots with whiskers to min/max (the "non-modified" or "regular" boxplot). Students learn this first and assume it is universal.',
      correctionExample:
        "Dataset [5, 8, 10, 12, 15, 18, 20, 80]: Q1=9, Q3=19, IQR=10, upper fence=34. Maximum=80 > 34, so it is an outlier. The upper whisker tip = 20 (largest value ≤ 34). The whisker stops at 20 and 80 is plotted as a separate point. The whisker does NOT reach 80.",
      contrastCase:
        "If no values exceed the fences (e.g., max=25 ≤ 34), then the upper whisker does reach the maximum (25), and in that case whisker = max. The distinction only matters when outliers exist.",
    },
    {
      falseBelief:
        "Boxplots show the full shape of the distribution — what the histogram shows.",
      whyStudentsThinkIt:
        "A boxplot looks like a detailed chart, so students assume it contains full distributional information.",
      correctionExample:
        "Two datasets: [1,1,1,5,9,9,9] (bimodal) and [1,2,3,5,7,8,9] (approximately uniform) have the same min, Q1, median, Q3, max. Their boxplots are identical. Their histograms are completely different.",
      contrastCase:
        "Violin plots combine a boxplot with a kernel density estimate — they show both the summary statistics (from the boxplot) and the shape (from the density). For n ≥ 30 and when shape matters, prefer violin plots or histogram+boxplot combinations.",
    },
    {
      falseBelief:
        "An outlier on a boxplot should always be removed from analysis.",
      whyStudentsThinkIt:
        'Students hear "outlier" and think it means error or contamination that should be cleaned.',
      correctionExample:
      ...
      contrastCase:
        "A data entry error (typing 1450 instead of 145 for a salary) should be corrected or removed after verification. A real extreme value (the CEO salary) should be reported and kept, with the outlier flagging serving as a prompt to investigate, not a mandate to delete.",
    },
  ],
  ...
  transferPrompts: [
    {
      situation:
        "A hospital quality report shows the length of stay (days) for patients across four wards. You need to present this to hospital administrators in a single chart that shows which wards have the most variability and whether any wards have unusually long stays.",
      competingTechniques: [
        "Bar chart of average length of stay per ward",
        "Four histograms, one per ward",
        "Side-by-side boxplots, one per ward",
      ],
      whyThisTechniqueWins:
        "Side-by-side boxplots: administrators immediately see the median stay, IQR, and any outliers (extremely long stays) for all four wards at once. A bar chart of averages completely hides the distribution of stays and outliers — the primary concern (unusually long stays) is invisible. Four separate histograms require viewers to mentally compare across four charts. Boxplots enable instant comparison of all four wards on center, spread, skewness, and extremes.",
    },
    {
      situation:
        "A machine learning model produces prediction errors for 1,000 test cases. You want to assess whether errors are centered at zero, whether they are symmetric, and whether there are any large systematic errors.",
      competingTechniques: [
        "Histogram of prediction errors",
        "Boxplot of prediction errors",
        "Just compute mean and SD",
      ],
      whyThisTechniqueWins:
        "Both the boxplot and histogram are useful here, but for different reasons. The boxplot quickly shows the center (median ≈ 0 = unbiased?), the IQR (typical error magnitude), and individual extreme errors (critical failure cases). The histogram shows shape (normal? skewed? bimodal?). Mean and SD alone miss outlier structure. For this use case: boxplot for outlier detection and center/spread characterization; histogram as a supplement for distributional shape. Neither alone is as informative as both together.",
    },
  ],
  ...
  debugging: [
    {
      commonError:
        "Setting whisker tips to the full min/max instead of the outermost non-outlier values.",
      symptom:
        "The boxplot shows a point labeled as an outlier AND the whisker extends to that point — the whisker and outlier marker are at the same location.",
      whyItHappened:
        'The whisker endpoint formula was applied as "max(data)" instead of "max value ≤ upper fence." The whisker should stop at the farthest non-outlier, not at the true maximum.',
      repairStrategy:
        "Upper whisker tip = `max(x for x in data if x <= upper_fence)`. Lower whisker tip = `min(x for x in data if x >= lower_fence)`. Outliers are all values NOT in [lower_whisker_tip, upper_whisker_tip] that lie outside the fences.",
    },
    {
      commonError:
        "Including the median in both halves when computing Q1 and Q3 for an odd-n dataset.",
      symptom:
        "For [1,3,5,7,9] (n=5), you compute lower half as [1,3,5] (including median=5), giving Q1=3. Correct is lower half [1,3] → Q1=2.",
      whyItHappened:
        "For odd n, the median value itself should be excluded from both halves before computing Q1 and Q3. Including it inflates Q1 and deflates Q3.",
      repairStrategy:
        "For odd n, Q2 = value at position (n+1)/2. Lower half = all values strictly before Q2. Upper half = all values strictly after Q2. For n=5: Q2=x[3]=5, lower=[1,3], Q1=(1+3)/2=2; upper=[7,9], Q3=(7+9)/2=8.",
    },
  ],

  mastery: {
    targetLevel:
      "Apply (Level 3) — construct a boxplot from a dataset (compute all components), interpret boxplot features (skewness, outliers, center/spread), and compare distributions using side-by-side boxplots.",
    solveIndependently:
      "Given a dataset of 10–20 values, compute the five-number summary, Tukey fences, whisker endpoints, and identify outliers; produce a labeled boxplot sketch.",
    explainVerbally:
      "Explain the difference between a regular and modified boxplot, why whiskers do not always reach the min/max, and what the median line position tells you about skewness.",
    detectIncorrectApplication:
      "Identify errors when: (1) whiskers extend to the actual min/max in the presence of outliers; (2) a bimodal distribution is described as symmetric based on its boxplot; (3) an outlier is removed without investigation.",
    transferToUnfamiliar:
      "Given a novel comparison task (drug dosages, customer wait times, machine part dimensions across factories), construct side-by-side boxplots using fig.boxplot(), interpret each group's distribution, and write a one-paragraph comparison.",
  },
};
