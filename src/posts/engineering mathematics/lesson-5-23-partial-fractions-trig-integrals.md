# Stage 5, Lesson 5.23 — Partial Fractions and Trigonometric Integrals
...
Lesson 14's table or Lesson 15's substitution can already handle.
...
Lesson 14's $\int\frac1x\,dx=\ln|x|+C$ table entry, via a trivial
substitution (Lesson 15):
...
steps that reduce a hard-looking integral to Lesson 14's basic
table.
...
3. **Integrate term by term**: each piece is Lesson 14's
   $\int\frac1x\,dx$ table entry, via Lesson 15's substitution.
...
identity — both reusing Lesson 2.5 and Lesson 15, not introducing
new machinery.
