# Stage 5, Lesson 5.11 — Curve Sketching: Concavity, Inflection, and the Full Picture
...
Lesson 5.10's Extension problem used "concave up" without a formal
...
switches), and extends Lesson 5.8's linear approximation one step
...
build a quadratic approximation more accurate than Lesson 5.8's
...
- **Second derivatives** — Lesson 5.7.
- **The second derivative test, used informally** — Lesson 5.10.
...
— equivalently (by Lesson 5.9's Consequence 3, applied to $f'$
...
**Justifying the second derivative test, rigorously.** Lesson 5.10
...
points in Lesson 5.10 — the concavity must actually **change sign**
...
### Quadratic Approximation: One Step Beyond Lesson 5.8

Lesson 5.8's linear approximation, $L(x)=f(a)+f'(a)(x-a)$, matches
...
L = f_a + f_prime_a*(x - a)                                    # linear (Lesson 5.8)
Q = f_a + f_prime_a*(x-a) + sp.Rational(1,2)*f_double_prime_a*(x-a)**2  # quadratic

x_target = 4.5   # farther from a=4 than Lesson 5.8's example, to show the difference more clearly
...
3. **Asymptotes** — vertical (Lesson 5.1's infinite-limit case),
   horizontal (Lesson 5.1's limits at infinity, Lesson 1.5).
4. **Critical points and extrema** — Lesson 5.10.
...
critical points (Lesson 5.10), the inflection-point sign-change check
(this lesson), and `sp.limit(..., sp.oo)` for asymptotic behavior
(Lesson 5.1/5.2) — genuinely nothing new syntactically, only new
...
3. **Concavity test, justified**: at $x=1$, $f''(1)>0$ (concave up)
   confirms a genuine local minimum — the same reasoning Lesson 5.10
...
concave down (below tangents) — a direct consequence of Lesson 5.9's
...
than Lesson 5.8's linear version.
