# Stage 5, Lesson 5.11 — Inverse Function Derivatives and Higher-Order Derivatives
...
function, built directly from implicit differentiation (Lesson 5).
...
(Lesson 11), Newton's method (5.12), and Taylor series (5.11). The
...
- **Implicit differentiation, chain rule** — Lesson 5.
...
a finite-difference estimate" habit from Lesson 3:
...
has used side by side since Lesson 1. The **quintic smoothstep**
...
for the circle/ellipse tangent lines in Lesson 5. $\blacksquare$
</details>
