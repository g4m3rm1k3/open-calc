# Stage 5, Lesson 5.13 — Linear Approximation, Differentials, and Error Propagation
...
The tangent line (Lesson 3) isn't just a picture — near the point
...
shaky back in Lesson 1), and applies both directly to one of the
...
- **Tangent lines, the derivative** — Lesson 3.
