# Stage 5, Lesson 5.6 — Derivatives of Trigonometric, Exponential, and Logarithmic Functions
...
Lesson 5.5 used $\frac{d}{dx}\sin x=\cos x$ as a "known building
block, properly derived in Lesson 5.6." This is that lesson. The
proof uses **exactly** the two trigonometric limits established in
Lesson 5.2 — $\lim_{h\to0}\frac{\sin h}{h}=1$ (proved via the
...
- **The two trig limits**, $\lim\sin h/h=1$ and
  $\lim(1-\cos h)/h=0$ — Lesson 5.2, including its Extension problem.
- **The chain rule, implicit differentiation** — Lesson 5.5.
...
Split via the sum limit law (Lesson 5.2), treating $\sin x$ and
...
using **exactly** the two limits Lesson 5.2 proved geometrically
...
via the quotient rule (Lesson 5.4), since $\tan x=\sin x/\cos x$,
etc.:
...
using implicit differentiation (Lesson 5.5) — the left side needs the
...
1. **The two trig limits** (Lesson 5.2) directly proved
...
**$\frac{d}{dx}\sin x=\cos x$**, proved fully using Lesson 5.2's two
