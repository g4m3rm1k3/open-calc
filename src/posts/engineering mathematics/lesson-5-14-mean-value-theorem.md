# Stage 5, Lesson 5.14 — The Mean Value Theorem and Its Consequences
...
Lesson 8's error-propagation formula, $\Delta f\approx
...
decreasing (Lesson 10), the guarantee that two functions with the
same derivative differ only by a constant (the fact Lesson 14's
Fundamental Theorem of Calculus is built on), and a rigorous bound on
linear approximation's error, replacing Lesson 8's "trust the
...
- **Continuity, IVT** — Lesson 2.
- **The derivative, differentiability** — Lesson 3.
- **Linear approximation, informally justified** — Lesson 8, whose
...
result to IVT from Lesson 2, both consequences of continuity on a
...
**This is precisely the fact Lesson 14's Fundamental Theorem of
...
### Consequence 3: The Increasing/Decreasing Test (Preview of Lesson 10)
...
$f(x_2)-f(x_1)>0$ — $f$ genuinely increased. Lesson 10 builds a full
...
Lesson 8's linear approximation $L(x)=f(a)+f'(a)(x-a)$ had its
...
known bound on the second derivative — Lesson 7's higher-order
...
**Taylor remainder** Lesson 11 develops in full generality, and
...
The actual error (0.000154, matching Lesson 8's opening example
...
properly jerk-limited profile, Lesson 7, provides). This matters
...
3. **Verification**: the actual Lesson 8 error (0.000154) sits
   safely within the computed bound (0.000156) — the approximation's
   quality is now provable, not just observed.
4. **Forward to Lesson 14**: Consequence 2 (same derivative implies
...
Lesson 14); positive/negative derivative $\Rightarrow$
increasing/decreasing (needed for Lesson 10).

**Rigorous error bound**: MVT applied to $f'$ gives
$|f(x)-L(x)|\le\frac{M}{2}(x-a)^2$ — replaces Lesson 8's informal
...
<details><summary>Answer</summary>
$f$ isn't differentiable at $x=0$ (Lesson 3's corner-point
