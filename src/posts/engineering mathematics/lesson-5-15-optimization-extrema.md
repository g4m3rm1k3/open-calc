# Stage 5, Lesson 5.15 — Optimization: Local and Global Extrema
...
the tangent line is exactly horizontal. Combined with Lesson 9's
...
historical seeds calculus grew from — Lesson 9's proof of Rolle's
...
- **Increasing/decreasing test, MVT** — Lesson 9 (Consequence 3
  directly powers the first derivative test).
- **Second derivatives** — Lesson 7, for the second derivative
  test.
- **Extreme Value Theorem** — mentioned in Lesson 9, guarantees
...
essence, within Lesson 9's argument for Rolle's theorem — a local
...
This is a direct application of Lesson 9's Consequence 3: $f'>0$
...
The **Extreme Value Theorem** (Lesson 9) guarantees a continuous
...
Lesson 9's monotonicity result.
...
just at the critical point — meaning $A$ is concave up (Lesson 11)
